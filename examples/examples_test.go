...
func TestExamples(t *testing.T) {
	...
	for _, ex := range tests {
		example := ex.With(integration.ProgramTestOptions{
			// TODO[kulado/kulado#1900]: This should be the default value, every test we have causes some sort of
			// change during a `kulado refresh` for reasons outside our control.
