...
func (r *Job) ActionStorageQueue() *kulado.Output {
...
func (r *Job) ActionWeb() *kulado.Output {
...
func (r *Job) ErrorActionStorageQueue() *kulado.Output {
...
func (r *Job) ErrorActionWeb() *kulado.Output {
...
func (r *Job) JobCollectionName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["jobCollectionName"])
}
...
func (r *Job) Recurrence() *kulado.Output {
...
func (r *Job) State() *kulado.StringOutput {
