...
func (r *Namespace) MetricId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["metricId"])
}
...
func (r *Namespace) PrimaryConnectionString() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryConnectionString"])
}

// The primary access key for the authorization rule `RootManageSharedAccessKey`.
func (r *Namespace) PrimaryKey() *kulado.StringOutput {
...
func (r *Namespace) SecondaryConnectionString() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryConnectionString"])
}

// The secondary access key for the authorization rule `RootManageSharedAccessKey`.
func (r *Namespace) SecondaryKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryKey"])
}

// ) A `sku` block as described below.
func (r *Namespace) Sku() *kulado.Output {
	return r.s.State["sku"]
}

// The name of the SKU to use. At this time the only supported value is `Standard`.
func (r *Namespace) SkuName() *kulado.StringOutput {
