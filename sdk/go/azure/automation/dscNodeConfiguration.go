...
func NewDscNodeConfiguration(ctx *kulado.Context,
	name string, args *DscNodeConfigurationArgs, opts ...kulado.ResourceOpt) (*DscNodeConfiguration, error) {
...
func GetDscNodeConfiguration(ctx *kulado.Context,
	name string, id kulado.ID, state *DscNodeConfigurationState, opts ...kulado.ResourceOpt) (*DscNodeConfiguration, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *DscNodeConfiguration) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *DscNodeConfiguration) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the automation account in which the DSC Node Configuration is created. Changing this forces a new resource to be created.
func (r *DscNodeConfiguration) AutomationAccountName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["automationAccountName"])
}

func (r *DscNodeConfiguration) ConfigurationName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["configurationName"])
}

// The PowerShell DSC Node Configuration (mof content).
func (r *DscNodeConfiguration) ContentEmbedded() *kulado.StringOutput {
...
func (r *DscNodeConfiguration) Name() *kulado.StringOutput {
...
func (r *DscNodeConfiguration) ResourceGroupName() *kulado.StringOutput {
