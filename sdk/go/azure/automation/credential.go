...
func NewCredential(ctx *kulado.Context,
	name string, args *CredentialArgs, opts ...kulado.ResourceOpt) (*Credential, error) {
...
func GetCredential(ctx *kulado.Context,
	name string, id kulado.ID, state *CredentialState, opts ...kulado.ResourceOpt) (*Credential, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Credential) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Credential) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the automation account in which the Credential is created. Changing this forces a new resource to be created.
func (r *Credential) AccountName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["accountName"])
}

// The description associated with this Automation Credential.
func (r *Credential) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// Specifies the name of the Credential. Changing this forces a new resource to be created.
func (r *Credential) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The password associated with this Automation Credential.
func (r *Credential) Password() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["password"])
}

// The name of the resource group in which the Credential is created. Changing this forces a new resource to be created.
func (r *Credential) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The username associated with this Automation Credential.
func (r *Credential) Username() *kulado.StringOutput {
