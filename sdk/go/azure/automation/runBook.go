...
func NewRunBook(ctx *kulado.Context,
	name string, args *RunBookArgs, opts ...kulado.ResourceOpt) (*RunBook, error) {
...
func GetRunBook(ctx *kulado.Context,
	name string, id kulado.ID, state *RunBookState, opts ...kulado.ResourceOpt) (*RunBook, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *RunBook) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *RunBook) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the automation account in which the Runbook is created. Changing this forces a new resource to be created.
func (r *RunBook) AccountName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["accountName"])
}

// The desired content of the runbook.
func (r *RunBook) Content() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["content"])
}

// A description for this credential.
func (r *RunBook) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *RunBook) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Progress log option.
func (r *RunBook) LogProgress() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["logProgress"])
}

// Verbose log option.
func (r *RunBook) LogVerbose() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["logVerbose"])
}

// Specifies the name of the Runbook. Changing this forces a new resource to be created.
func (r *RunBook) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The published runbook content link.
func (r *RunBook) PublishContentLink() *kulado.Output {
	return r.s.State["publishContentLink"]
}

// The name of the resource group in which the Runbook is created. Changing this forces a new resource to be created.
func (r *RunBook) ResourceGroupName() *kulado.StringOutput {
...
func (r *RunBook) RunbookType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["runbookType"])
}

// A mapping of tags to assign to the resource.
func (r *RunBook) Tags() *kulado.MapOutput {
