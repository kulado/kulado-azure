...
func NewFactory(ctx *kulado.Context,
	name string, args *FactoryArgs, opts ...kulado.ResourceOpt) (*Factory, error) {
...
func GetFactory(ctx *kulado.Context,
	name string, id kulado.ID, state *FactoryState, opts ...kulado.ResourceOpt) (*Factory, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Factory) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Factory) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A `github_configuration` block as defined below.
func (r *Factory) GithubConfiguration() *kulado.Output {
	return r.s.State["githubConfiguration"]
}

// An `identity` block as defined below.
func (r *Factory) Identity() *kulado.Output {
	return r.s.State["identity"]
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *Factory) Location() *kulado.StringOutput {
...
func (r *Factory) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the resource group in which to create the Data Factory.
func (r *Factory) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A mapping of tags to assign to the resource.
func (r *Factory) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// A `vsts_configuration` block as defined below.
func (r *Factory) VstsConfiguration() *kulado.Output {
