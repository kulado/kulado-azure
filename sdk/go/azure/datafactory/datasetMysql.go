...
func NewDatasetMysql(ctx *kulado.Context,
	name string, args *DatasetMysqlArgs, opts ...kulado.ResourceOpt) (*DatasetMysql, error) {
...
func GetDatasetMysql(ctx *kulado.Context,
	name string, id kulado.ID, state *DatasetMysqlState, opts ...kulado.ResourceOpt) (*DatasetMysql, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *DatasetMysql) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *DatasetMysql) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A map of additional properties to associate with the Data Factory Dataset MySQL.
func (r *DatasetMysql) AdditionalProperties() *kulado.MapOutput {
...
func (r *DatasetMysql) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A map of parameters to associate with the Data Factory Dataset MySQL.
func (r *DatasetMysql) Parameters() *kulado.MapOutput {
...
func (r *DatasetMysql) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `schema_column` block as defined below.
func (r *DatasetMysql) SchemaColumns() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["schemaColumns"])
}

// The table name of the Data Factory Dataset MySQL.
func (r *DatasetMysql) TableName() *kulado.StringOutput {
