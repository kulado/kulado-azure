...
func NewDatasetSqlServerTable(ctx *kulado.Context,
	name string, args *DatasetSqlServerTableArgs, opts ...kulado.ResourceOpt) (*DatasetSqlServerTable, error) {
...
func GetDatasetSqlServerTable(ctx *kulado.Context,
	name string, id kulado.ID, state *DatasetSqlServerTableState, opts ...kulado.ResourceOpt) (*DatasetSqlServerTable, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *DatasetSqlServerTable) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *DatasetSqlServerTable) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A map of additional properties to associate with the Data Factory Dataset SQL Server Table.
func (r *DatasetSqlServerTable) AdditionalProperties() *kulado.MapOutput {
...
func (r *DatasetSqlServerTable) Annotations() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["annotations"])
}

// The Data Factory name in which to associate the Dataset with. Changing this forces a new resource.
func (r *DatasetSqlServerTable) DataFactoryName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["dataFactoryName"])
}

// The description for the Data Factory Dataset SQL Server Table.
func (r *DatasetSqlServerTable) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// The folder that this Dataset is in. If not specified, the Dataset will appear at the root level.
func (r *DatasetSqlServerTable) Folder() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["folder"])
}

// The Data Factory Linked Service name in which to associate the Dataset with.
func (r *DatasetSqlServerTable) LinkedServiceName() *kulado.StringOutput {
...
func (r *DatasetSqlServerTable) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A map of parameters to associate with the Data Factory Dataset SQL Server Table.
func (r *DatasetSqlServerTable) Parameters() *kulado.MapOutput {
...
func (r *DatasetSqlServerTable) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `schema_column` block as defined below.
func (r *DatasetSqlServerTable) SchemaColumns() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["schemaColumns"])
}

// The table name of the Data Factory Dataset SQL Server Table.
func (r *DatasetSqlServerTable) TableName() *kulado.StringOutput {
