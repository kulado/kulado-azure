...
func NewLinkedServiceMysql(ctx *kulado.Context,
	name string, args *LinkedServiceMysqlArgs, opts ...kulado.ResourceOpt) (*LinkedServiceMysql, error) {
...
func GetLinkedServiceMysql(ctx *kulado.Context,
	name string, id kulado.ID, state *LinkedServiceMysqlState, opts ...kulado.ResourceOpt) (*LinkedServiceMysql, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *LinkedServiceMysql) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *LinkedServiceMysql) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A map of additional properties to associate with the Data Factory Linked Service MySQL.
func (r *LinkedServiceMysql) AdditionalProperties() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["additionalProperties"])
}

// List of tags that can be used for describing the Data Factory Linked Service MySQL.
func (r *LinkedServiceMysql) Annotations() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["annotations"])
}

// The connection string in which to authenticate with MySQL.
func (r *LinkedServiceMysql) ConnectionString() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["connectionString"])
}

// The Data Factory name in which to associate the Linked Service with. Changing this forces a new resource.
func (r *LinkedServiceMysql) DataFactoryName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["dataFactoryName"])
}

// The description for the Data Factory Linked Service MySQL.
func (r *LinkedServiceMysql) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// The integration runtime reference to associate with the Data Factory Linked Service MySQL.
func (r *LinkedServiceMysql) IntegrationRuntimeName() *kulado.StringOutput {
...
func (r *LinkedServiceMysql) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A map of parameters to associate with the Data Factory Linked Service MySQL.
func (r *LinkedServiceMysql) Parameters() *kulado.MapOutput {
...
func (r *LinkedServiceMysql) ResourceGroupName() *kulado.StringOutput {
