...
func NewLinkedServiceSqlServer(ctx *kulado.Context,
	name string, args *LinkedServiceSqlServerArgs, opts ...kulado.ResourceOpt) (*LinkedServiceSqlServer, error) {
...
func GetLinkedServiceSqlServer(ctx *kulado.Context,
	name string, id kulado.ID, state *LinkedServiceSqlServerState, opts ...kulado.ResourceOpt) (*LinkedServiceSqlServer, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *LinkedServiceSqlServer) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *LinkedServiceSqlServer) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A map of additional properties to associate with the Data Factory Linked Service SQL Server.
func (r *LinkedServiceSqlServer) AdditionalProperties() *kulado.MapOutput {
...
func (r *LinkedServiceSqlServer) IntegrationRuntimeName() *kulado.StringOutput {
...
func (r *LinkedServiceSqlServer) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A map of parameters to associate with the Data Factory Linked Service SQL Server.
func (r *LinkedServiceSqlServer) Parameters() *kulado.MapOutput {
...
func (r *LinkedServiceSqlServer) ResourceGroupName() *kulado.StringOutput {
