...
func NewApplicationGateway(ctx *kulado.Context,
	name string, args *ApplicationGatewayArgs, opts ...kulado.ResourceOpt) (*ApplicationGateway, error) {
...
func GetApplicationGateway(ctx *kulado.Context,
	name string, id kulado.ID, state *ApplicationGatewayState, opts ...kulado.ResourceOpt) (*ApplicationGateway, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ApplicationGateway) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ApplicationGateway) ID() *kulado.IDOutput {
	return r.s.ID()
}

// One or more `authentication_certificate` blocks as defined below.
func (r *ApplicationGateway) AuthenticationCertificates() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["authenticationCertificates"])
}

// A `autoscale_configuration` block as defined below.
func (r *ApplicationGateway) AutoscaleConfiguration() *kulado.Output {
	return r.s.State["autoscaleConfiguration"]
}

// One or more `backend_address_pool` blocks as defined below.
func (r *ApplicationGateway) BackendAddressPools() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["backendAddressPools"])
}

// One or more `backend_http_settings` blocks as defined below.
func (r *ApplicationGateway) BackendHttpSettings() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["backendHttpSettings"])
}

// One or more `custom_error_configuration` blocks as defined below.
func (r *ApplicationGateway) CustomErrorConfigurations() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["customErrorConfigurations"])
}
...
func (r *ApplicationGateway) DisabledSslProtocols() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["disabledSslProtocols"])
}

// Is HTTP2 enabled on the application gateway resource? Defaults to `false`.
func (r *ApplicationGateway) EnableHttp2() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableHttp2"])
}

// One or more `frontend_ip_configuration` blocks as defined below.
func (r *ApplicationGateway) FrontendIpConfigurations() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["frontendIpConfigurations"])
}

// One or more `frontend_port` blocks as defined below.
func (r *ApplicationGateway) FrontendPorts() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["frontendPorts"])
}

// One or more `gateway_ip_configuration` blocks as defined below.
func (r *ApplicationGateway) GatewayIpConfigurations() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["gatewayIpConfigurations"])
}

// One or more `http_listener` blocks as defined below.
func (r *ApplicationGateway) HttpListeners() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["httpListeners"])
}

// The Azure region where the Application Gateway should exist. Changing this forces a new resource to be created.
func (r *ApplicationGateway) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the Application Gateway. Changing this forces a new resource to be created.
func (r *ApplicationGateway) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// One or more `probe` blocks as defined below.
func (r *ApplicationGateway) Probes() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["probes"])
}

// A `redirect_configuration` block as defined below.
func (r *ApplicationGateway) RedirectConfigurations() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["redirectConfigurations"])
}

// One or more `request_routing_rule` blocks as defined below.
func (r *ApplicationGateway) RequestRoutingRules() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["requestRoutingRules"])
}

// The name of the resource group in which to the Application Gateway should exist. Changing this forces a new resource to be created.
func (r *ApplicationGateway) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// One or more `rewrite_rule_set` blocks as defined below. Only valid for v2 SKUs.
func (r *ApplicationGateway) RewriteRuleSets() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["rewriteRuleSets"])
}

// A `sku` block as defined below.
func (r *ApplicationGateway) Sku() *kulado.Output {
	return r.s.State["sku"]
}

// One or more `ssl_certificate` blocks as defined below.
func (r *ApplicationGateway) SslCertificates() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["sslCertificates"])
}

// a `ssl policy` block as defined below.
func (r *ApplicationGateway) SslPolicies() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["sslPolicies"])
}

// A mapping of tags to assign to the resource.
func (r *ApplicationGateway) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// One or more `url_path_map` blocks as defined below.
func (r *ApplicationGateway) UrlPathMaps() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["urlPathMaps"])
}

// A `waf_configuration` block as defined below.
func (r *ApplicationGateway) WafConfiguration() *kulado.Output {
	return r.s.State["wafConfiguration"]
}

// A collection of availability zones to spread the Application Gateway over.
func (r *ApplicationGateway) Zones() *kulado.ArrayOutput {
