...
func NewFirewall(ctx *kulado.Context,
	name string, args *FirewallArgs, opts ...kulado.ResourceOpt) (*Firewall, error) {
...
func GetFirewall(ctx *kulado.Context,
	name string, id kulado.ID, state *FirewallState, opts ...kulado.ResourceOpt) (*Firewall, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Firewall) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Firewall) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A `ip_configuration` block as documented below.
func (r *Firewall) IpConfiguration() *kulado.Output {
	return r.s.State["ipConfiguration"]
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *Firewall) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the Firewall. Changing this forces a new resource to be created.
func (r *Firewall) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the resource group in which to create the resource. Changing this forces a new resource to be created.
func (r *Firewall) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A mapping of tags to assign to the resource.
func (r *Firewall) Tags() *kulado.MapOutput {
