...
func NewExpressRouteCircuitPeering(ctx *kulado.Context,
	name string, args *ExpressRouteCircuitPeeringArgs, opts ...kulado.ResourceOpt) (*ExpressRouteCircuitPeering, error) {
...
func GetExpressRouteCircuitPeering(ctx *kulado.Context,
	name string, id kulado.ID, state *ExpressRouteCircuitPeeringState, opts ...kulado.ResourceOpt) (*ExpressRouteCircuitPeering, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ExpressRouteCircuitPeering) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ExpressRouteCircuitPeering) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The ASN used by Azure.
func (r *ExpressRouteCircuitPeering) AzureAsn() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["azureAsn"])
}

// The name of the ExpressRoute Circuit in which to create the Peering.
func (r *ExpressRouteCircuitPeering) ExpressRouteCircuitName() *kulado.StringOutput {
...
func (r *ExpressRouteCircuitPeering) MicrosoftPeeringConfig() *kulado.Output {
	return r.s.State["microsoftPeeringConfig"]
}

// The Either a 16-bit or a 32-bit ASN. Can either be public or private..
func (r *ExpressRouteCircuitPeering) PeerAsn() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["peerAsn"])
}

// The type of the ExpressRoute Circuit Peering. Acceptable values include `AzurePrivatePeering`, `AzurePublicPeering` and `MicrosoftPeering`. Changing this forces a new resource to be created.
func (r *ExpressRouteCircuitPeering) PeeringType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["peeringType"])
}

// The Primary Port used by Azure for this Peering.
func (r *ExpressRouteCircuitPeering) PrimaryAzurePort() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryAzurePort"])
}

// A `/30` subnet for the primary link.
func (r *ExpressRouteCircuitPeering) PrimaryPeerAddressPrefix() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryPeerAddressPrefix"])
}

// The name of the resource group in which to
// create the Express Route Circuit Peering. Changing this forces a new resource to be created.
func (r *ExpressRouteCircuitPeering) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The Secondary Port used by Azure for this Peering.
func (r *ExpressRouteCircuitPeering) SecondaryAzurePort() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryAzurePort"])
}

// A `/30` subnet for the secondary link.
func (r *ExpressRouteCircuitPeering) SecondaryPeerAddressPrefix() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryPeerAddressPrefix"])
}

// The shared key. Can be a maximum of 25 characters.
func (r *ExpressRouteCircuitPeering) SharedKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sharedKey"])
}

// A valid VLAN ID to establish this peering on.
func (r *ExpressRouteCircuitPeering) VlanId() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["vlanId"])
}
