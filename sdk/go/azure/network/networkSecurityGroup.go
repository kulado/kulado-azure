...
func NewNetworkSecurityGroup(ctx *kulado.Context,
	name string, args *NetworkSecurityGroupArgs, opts ...kulado.ResourceOpt) (*NetworkSecurityGroup, error) {
...
func GetNetworkSecurityGroup(ctx *kulado.Context,
	name string, id kulado.ID, state *NetworkSecurityGroupState, opts ...kulado.ResourceOpt) (*NetworkSecurityGroup, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *NetworkSecurityGroup) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *NetworkSecurityGroup) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *NetworkSecurityGroup) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the security rule.
func (r *NetworkSecurityGroup) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the resource group in which to create the network security group. Changing this forces a new resource to be created.
func (r *NetworkSecurityGroup) ResourceGroupName() *kulado.StringOutput {
...
func (r *NetworkSecurityGroup) SecurityRules() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["securityRules"])
}

// A mapping of tags to assign to the resource.
func (r *NetworkSecurityGroup) Tags() *kulado.MapOutput {
