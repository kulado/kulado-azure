...
func NewSubnetRouteTableAssociation(ctx *kulado.Context,
	name string, args *SubnetRouteTableAssociationArgs, opts ...kulado.ResourceOpt) (*SubnetRouteTableAssociation, error) {
...
func GetSubnetRouteTableAssociation(ctx *kulado.Context,
	name string, id kulado.ID, state *SubnetRouteTableAssociationState, opts ...kulado.ResourceOpt) (*SubnetRouteTableAssociation, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *SubnetRouteTableAssociation) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *SubnetRouteTableAssociation) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The ID of the Route Table which should be associated with the Subnet. Changing this forces a new resource to be created.
func (r *SubnetRouteTableAssociation) RouteTableId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["routeTableId"])
}

// The ID of the Subnet. Changing this forces a new resource to be created.
func (r *SubnetRouteTableAssociation) SubnetId() *kulado.StringOutput {
