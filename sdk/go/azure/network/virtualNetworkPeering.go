...
func NewVirtualNetworkPeering(ctx *kulado.Context,
	name string, args *VirtualNetworkPeeringArgs, opts ...kulado.ResourceOpt) (*VirtualNetworkPeering, error) {
...
func GetVirtualNetworkPeering(ctx *kulado.Context,
	name string, id kulado.ID, state *VirtualNetworkPeeringState, opts ...kulado.ResourceOpt) (*VirtualNetworkPeering, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *VirtualNetworkPeering) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *VirtualNetworkPeering) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Controls if forwarded traffic from  VMs
// in the remote virtual network is allowed. Defaults to false.
func (r *VirtualNetworkPeering) AllowForwardedTraffic() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["allowForwardedTraffic"])
}

// Controls gatewayLinks can be used in the
// remote virtual network’s link to the local virtual network.
func (r *VirtualNetworkPeering) AllowGatewayTransit() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["allowGatewayTransit"])
}

// Controls if the VMs in the remote
// virtual network can access VMs in the local virtual network. Defaults to
// false.
func (r *VirtualNetworkPeering) AllowVirtualNetworkAccess() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["allowVirtualNetworkAccess"])
}

// The name of the virtual network peering. Changing this
// forces a new resource to be created.
func (r *VirtualNetworkPeering) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The full Azure resource ID of the
// remote virtual network.  Changing this forces a new resource to be created.
func (r *VirtualNetworkPeering) RemoteVirtualNetworkId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["remoteVirtualNetworkId"])
}

// The name of the resource group in which to
// create the virtual network. Changing this forces a new resource to be
// created.
func (r *VirtualNetworkPeering) ResourceGroupName() *kulado.StringOutput {
...
func (r *VirtualNetworkPeering) UseRemoteGateways() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["useRemoteGateways"])
}

// The name of the virtual network. Changing
// this forces a new resource to be created.
func (r *VirtualNetworkPeering) VirtualNetworkName() *kulado.StringOutput {
