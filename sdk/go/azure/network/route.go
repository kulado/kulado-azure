...
func NewRoute(ctx *kulado.Context,
	name string, args *RouteArgs, opts ...kulado.ResourceOpt) (*Route, error) {
...
func GetRoute(ctx *kulado.Context,
	name string, id kulado.ID, state *RouteState, opts ...kulado.ResourceOpt) (*Route, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Route) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Route) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The destination CIDR to which the route applies, such as `10.1.0.0/16`
func (r *Route) AddressPrefix() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["addressPrefix"])
}

// The name of the route. Changing this forces a new resource to be created.
func (r *Route) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Contains the IP address packets should be forwarded to. Next hop values are only allowed in routes where the next hop type is `VirtualAppliance`.
func (r *Route) NextHopInIpAddress() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["nextHopInIpAddress"])
}

// The type of Azure hop the packet should be sent to. Possible values are `VirtualNetworkGateway`, `VnetLocal`, `Internet`, `VirtualAppliance` and `None`
func (r *Route) NextHopType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["nextHopType"])
}

// The name of the resource group in which to create the route. Changing this forces a new resource to be created.
func (r *Route) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The name of the route table within which create the route. Changing this forces a new resource to be created.
func (r *Route) RouteTableName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["routeTableName"])
}
