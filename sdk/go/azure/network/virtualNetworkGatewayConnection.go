...
func NewVirtualNetworkGatewayConnection(ctx *kulado.Context,
	name string, args *VirtualNetworkGatewayConnectionArgs, opts ...kulado.ResourceOpt) (*VirtualNetworkGatewayConnection, error) {
...
func GetVirtualNetworkGatewayConnection(ctx *kulado.Context,
	name string, id kulado.ID, state *VirtualNetworkGatewayConnectionState, opts ...kulado.ResourceOpt) (*VirtualNetworkGatewayConnection, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *VirtualNetworkGatewayConnection) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *VirtualNetworkGatewayConnection) ID() *kulado.IDOutput {
	return r.s.ID()
}
...
func (r *VirtualNetworkGatewayConnection) AuthorizationKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["authorizationKey"])
}

// If `true`, BGP (Border Gateway Protocol) is enabled
// for this connection. Defaults to `false`.
func (r *VirtualNetworkGatewayConnection) EnableBgp() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableBgp"])
}

// The ID of the Express Route Circuit
// when creating an ExpressRoute connection (i.e. when `type` is `ExpressRoute`).
// The Express Route Circuit can be in the same or in a different subscription.
func (r *VirtualNetworkGatewayConnection) ExpressRouteCircuitId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["expressRouteCircuitId"])
}

// If `true`, data packets will bypass ExpressRoute Gateway for data forwarding This is only valid for ExpressRoute connections.
func (r *VirtualNetworkGatewayConnection) ExpressRouteGatewayBypass() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["expressRouteGatewayBypass"])
}

// A `ipsec_policy` block which is documented below.
// Only a single policy can be defined for a connection. For details on
// custom policies refer to [the relevant section in the Azure documentation](https://docs.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-ipsecikepolicy-rm-powershell).
func (r *VirtualNetworkGatewayConnection) IpsecPolicy() *kulado.Output {
	return r.s.State["ipsecPolicy"]
}

// The ID of the local network gateway
// when creating Site-to-Site connection (i.e. when `type` is `IPsec`).
func (r *VirtualNetworkGatewayConnection) LocalNetworkGatewayId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["localNetworkGatewayId"])
}

// The location/region where the connection is
// located. Changing this forces a new resource to be created.
func (r *VirtualNetworkGatewayConnection) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the connection. Changing the name forces a
// new resource to be created.
func (r *VirtualNetworkGatewayConnection) Name() *kulado.StringOutput {
...
func (r *VirtualNetworkGatewayConnection) PeerVirtualNetworkGatewayId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["peerVirtualNetworkGatewayId"])
}

// The name of the resource group in which to
// create the connection Changing the name forces a new resource to be created.
func (r *VirtualNetworkGatewayConnection) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The routing weight. Defaults to `10`.
func (r *VirtualNetworkGatewayConnection) RoutingWeight() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["routingWeight"])
}

// The shared IPSec key. A key must be provided if a
// Site-to-Site or VNet-to-VNet connection is created whereas ExpressRoute
// connections do not need a shared key.
func (r *VirtualNetworkGatewayConnection) SharedKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sharedKey"])
}

// A mapping of tags to assign to the resource.
func (r *VirtualNetworkGatewayConnection) Tags() *kulado.MapOutput {
...
// to be created.
func (r *VirtualNetworkGatewayConnection) Type() *kulado.StringOutput {
...
func (r *VirtualNetworkGatewayConnection) UsePolicyBasedTrafficSelectors() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["usePolicyBasedTrafficSelectors"])
}

// The ID of the Virtual Network Gateway
// in which the connection will be created. Changing the gateway forces a new
// resource to be created.
func (r *VirtualNetworkGatewayConnection) VirtualNetworkGatewayId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["virtualNetworkGatewayId"])
}
