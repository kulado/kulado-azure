...
func NewFirewallApplicationRuleCollection(ctx *kulado.Context,
	name string, args *FirewallApplicationRuleCollectionArgs, opts ...kulado.ResourceOpt) (*FirewallApplicationRuleCollection, error) {
...
func GetFirewallApplicationRuleCollection(ctx *kulado.Context,
	name string, id kulado.ID, state *FirewallApplicationRuleCollectionState, opts ...kulado.ResourceOpt) (*FirewallApplicationRuleCollection, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *FirewallApplicationRuleCollection) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *FirewallApplicationRuleCollection) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the action the rule will apply to matching traffic. Possible values are `Allow` and `Deny`.
func (r *FirewallApplicationRuleCollection) Action() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["action"])
}
...
func (r *FirewallApplicationRuleCollection) AzureFirewallName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["azureFirewallName"])
}
...
func (r *FirewallApplicationRuleCollection) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the priority of the rule collection. Possible values are between `100` - `65000`.
func (r *FirewallApplicationRuleCollection) Priority() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["priority"])
}

// Specifies the name of the Resource Group in which the Firewall exists. Changing this forces a new resource to be created.
func (r *FirewallApplicationRuleCollection) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// One or more `rule` blocks as defined below.
func (r *FirewallApplicationRuleCollection) Rules() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["rules"])
}
