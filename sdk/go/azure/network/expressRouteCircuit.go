...
func NewExpressRouteCircuit(ctx *kulado.Context,
	name string, args *ExpressRouteCircuitArgs, opts ...kulado.ResourceOpt) (*ExpressRouteCircuit, error) {
...
func GetExpressRouteCircuit(ctx *kulado.Context,
	name string, id kulado.ID, state *ExpressRouteCircuitState, opts ...kulado.ResourceOpt) (*ExpressRouteCircuit, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ExpressRouteCircuit) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ExpressRouteCircuit) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Allow the circuit to interact with classic (RDFE) resources. The default value is `false`.
func (r *ExpressRouteCircuit) AllowClassicOperations() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["allowClassicOperations"])
}

// The bandwidth in Mbps of the circuit being created.
func (r *ExpressRouteCircuit) BandwidthInMbps() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["bandwidthInMbps"])
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *ExpressRouteCircuit) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the ExpressRoute circuit. Changing this forces a new resource to be created.
func (r *ExpressRouteCircuit) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the peering location and **not** the Azure resource location.
func (r *ExpressRouteCircuit) PeeringLocation() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["peeringLocation"])
}

// The name of the resource group in which to create the ExpressRoute circuit. Changing this forces a new resource to be created.
func (r *ExpressRouteCircuit) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The string needed by the service provider to provision the ExpressRoute circuit.
func (r *ExpressRouteCircuit) ServiceKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["serviceKey"])
}

// The name of the ExpressRoute Service Provider.
func (r *ExpressRouteCircuit) ServiceProviderName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["serviceProviderName"])
}

// The ExpressRoute circuit provisioning state from your chosen service provider. Possible values are "NotProvisioned", "Provisioning", "Provisioned", and "Deprovisioning".
func (r *ExpressRouteCircuit) ServiceProviderProvisioningState() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["serviceProviderProvisioningState"])
}

// A `sku` block for the ExpressRoute circuit as documented below.
func (r *ExpressRouteCircuit) Sku() *kulado.Output {
	return r.s.State["sku"]
}

// A mapping of tags to assign to the resource.
func (r *ExpressRouteCircuit) Tags() *kulado.MapOutput {
