...
func NewFirewallNatRuleCollection(ctx *kulado.Context,
	name string, args *FirewallNatRuleCollectionArgs, opts ...kulado.ResourceOpt) (*FirewallNatRuleCollection, error) {
...
func GetFirewallNatRuleCollection(ctx *kulado.Context,
	name string, id kulado.ID, state *FirewallNatRuleCollectionState, opts ...kulado.ResourceOpt) (*FirewallNatRuleCollection, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *FirewallNatRuleCollection) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *FirewallNatRuleCollection) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the action the rule will apply to matching traffic. Possible values are `Dnat` and `Snat`.
func (r *FirewallNatRuleCollection) Action() *kulado.StringOutput {
...
func (r *FirewallNatRuleCollection) AzureFirewallName() *kulado.StringOutput {
...
func (r *FirewallNatRuleCollection) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the priority of the rule collection. Possible values are between `100` - `65000`.
func (r *FirewallNatRuleCollection) Priority() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["priority"])
}

// Specifies the name of the Resource Group in which the Firewall exists. Changing this forces a new resource to be created.
func (r *FirewallNatRuleCollection) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// One or more `rule` blocks as defined below.
func (r *FirewallNatRuleCollection) Rules() *kulado.ArrayOutput {
