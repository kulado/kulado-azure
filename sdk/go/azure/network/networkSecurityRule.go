...
func NewNetworkSecurityRule(ctx *kulado.Context,
	name string, args *NetworkSecurityRuleArgs, opts ...kulado.ResourceOpt) (*NetworkSecurityRule, error) {
...
func GetNetworkSecurityRule(ctx *kulado.Context,
	name string, id kulado.ID, state *NetworkSecurityRuleState, opts ...kulado.ResourceOpt) (*NetworkSecurityRule, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *NetworkSecurityRule) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *NetworkSecurityRule) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies whether network traffic is allowed or denied. Possible values are `Allow` and `Deny`.
func (r *NetworkSecurityRule) Access() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["access"])
}

// A description for this rule. Restricted to 140 characters.
func (r *NetworkSecurityRule) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// CIDR or destination IP range or * to match any IP. Tags such as ‘VirtualNetwork’, ‘AzureLoadBalancer’ and ‘Internet’ can also be used. This is required if `destination_address_prefixes` is not specified.
func (r *NetworkSecurityRule) DestinationAddressPrefix() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["destinationAddressPrefix"])
}

// List of destination address prefixes. Tags may not be used. This is required if `destination_address_prefix` is not specified.
func (r *NetworkSecurityRule) DestinationAddressPrefixes() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["destinationAddressPrefixes"])
}

// A List of destination Application Security Group ID's
func (r *NetworkSecurityRule) DestinationApplicationSecurityGroupIds() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["destinationApplicationSecurityGroupIds"])
}

// Destination Port or Range. Integer or range between `0` and `65535` or `*` to match any. This is required if `destination_port_ranges` is not specified.
func (r *NetworkSecurityRule) DestinationPortRange() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["destinationPortRange"])
}

// List of destination ports or port ranges. This is required if `destination_port_range` is not specified.
func (r *NetworkSecurityRule) DestinationPortRanges() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["destinationPortRanges"])
}

// The direction specifies if rule will be evaluated on incoming or outgoing traffic. Possible values are `Inbound` and `Outbound`.
func (r *NetworkSecurityRule) Direction() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["direction"])
}

// The name of the security rule. This needs to be unique across all Rules in the Network Security Group. Changing this forces a new resource to be created.
func (r *NetworkSecurityRule) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the Network Security Group that we want to attach the rule to. Changing this forces a new resource to be created.
func (r *NetworkSecurityRule) NetworkSecurityGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["networkSecurityGroupName"])
}

// Specifies the priority of the rule. The value can be between 100 and 4096. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule.
func (r *NetworkSecurityRule) Priority() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["priority"])
}

// Network protocol this rule applies to. Possible values include `Tcp`, `Udp` or `*` (which matches both).
func (r *NetworkSecurityRule) Protocol() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["protocol"])
}

// The name of the resource group in which to create the Network Security Rule. Changing this forces a new resource to be created.
func (r *NetworkSecurityRule) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// CIDR or source IP range or * to match any IP. Tags such as ‘VirtualNetwork’, ‘AzureLoadBalancer’ and ‘Internet’ can also be used. This is required if `source_address_prefixes` is not specified.
func (r *NetworkSecurityRule) SourceAddressPrefix() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sourceAddressPrefix"])
}

// List of source address prefixes. Tags may not be used. This is required if `source_address_prefix` is not specified.
func (r *NetworkSecurityRule) SourceAddressPrefixes() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["sourceAddressPrefixes"])
}

// A List of source Application Security Group ID's
func (r *NetworkSecurityRule) SourceApplicationSecurityGroupIds() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sourceApplicationSecurityGroupIds"])
}

// Source Port or Range. Integer or range between `0` and `65535` or `*` to match any. This is required if `source_port_ranges` is not specified.
func (r *NetworkSecurityRule) SourcePortRange() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sourcePortRange"])
}

// List of source ports or port ranges. This is required if `source_port_range` is not specified.
func (r *NetworkSecurityRule) SourcePortRanges() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["sourcePortRanges"])
}
