...
func NewNetworkPacketCapture(ctx *kulado.Context,
	name string, args *NetworkPacketCaptureArgs, opts ...kulado.ResourceOpt) (*NetworkPacketCapture, error) {
...
func GetNetworkPacketCapture(ctx *kulado.Context,
	name string, id kulado.ID, state *NetworkPacketCaptureState, opts ...kulado.ResourceOpt) (*NetworkPacketCapture, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *NetworkPacketCapture) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *NetworkPacketCapture) ID() *kulado.IDOutput {
	return r.s.ID()
}

// One or more `filter` blocks as defined below. Changing this forces a new resource to be created.
func (r *NetworkPacketCapture) Filters() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["filters"])
}

// The number of bytes captured per packet. The remaining bytes are truncated. Defaults to `0` (Entire Packet Captured). Changing this forces a new resource to be created.
func (r *NetworkPacketCapture) MaximumBytesPerPacket() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["maximumBytesPerPacket"])
}

// Maximum size of the capture in Bytes. Defaults to `1073741824` (1GB). Changing this forces a new resource to be created.
func (r *NetworkPacketCapture) MaximumBytesPerSession() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["maximumBytesPerSession"])
}

// The maximum duration of the capture session in seconds. Defaults to `18000` (5 hours). Changing this forces a new resource to be created.
func (r *NetworkPacketCapture) MaximumCaptureDuration() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["maximumCaptureDuration"])
}

// The name to use for this Network Packet Capture. Changing this forces a new resource to be created.
func (r *NetworkPacketCapture) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the Network Watcher. Changing this forces a new resource to be created.
func (r *NetworkPacketCapture) NetworkWatcherName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["networkWatcherName"])
}

// The name of the resource group in which the Network Watcher exists. Changing this forces a new resource to be created.
func (r *NetworkPacketCapture) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `storage_location` block as defined below. Changing this forces a new resource to be created.
func (r *NetworkPacketCapture) StorageLocation() *kulado.Output {
	return r.s.State["storageLocation"]
}

// The ID of the Resource to capture packets from. Changing this forces a new resource to be created.
func (r *NetworkPacketCapture) TargetResourceId() *kulado.StringOutput {
