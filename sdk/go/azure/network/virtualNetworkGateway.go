...
func NewVirtualNetworkGateway(ctx *kulado.Context,
	name string, args *VirtualNetworkGatewayArgs, opts ...kulado.ResourceOpt) (*VirtualNetworkGateway, error) {
...
func GetVirtualNetworkGateway(ctx *kulado.Context,
	name string, id kulado.ID, state *VirtualNetworkGatewayState, opts ...kulado.ResourceOpt) (*VirtualNetworkGateway, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *VirtualNetworkGateway) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *VirtualNetworkGateway) ID() *kulado.IDOutput {
	return r.s.ID()
}
...
// Defaults to `false`.
func (r *VirtualNetworkGateway) ActiveActive() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["activeActive"])
}

func (r *VirtualNetworkGateway) BgpSettings() *kulado.Output {
...
func (r *VirtualNetworkGateway) DefaultLocalNetworkGatewayId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["defaultLocalNetworkGatewayId"])
}

// If `true`, BGP (Border Gateway Protocol) will be enabled
// for this Virtual Network Gateway. Defaults to `false`.
func (r *VirtualNetworkGateway) EnableBgp() *kulado.BoolOutput {
...
func (r *VirtualNetworkGateway) IpConfigurations() *kulado.ArrayOutput {
...
func (r *VirtualNetworkGateway) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the Virtual Network Gateway. Changing the name
// forces a new resource to be created.
func (r *VirtualNetworkGateway) Name() *kulado.StringOutput {
...
func (r *VirtualNetworkGateway) ResourceGroupName() *kulado.StringOutput {
...
func (r *VirtualNetworkGateway) VpnClientConfiguration() *kulado.Output {
	return r.s.State["vpnClientConfiguration"]
}

// The routing type of the Virtual Network Gateway. Valid
// options are `RouteBased` or `PolicyBased`. Defaults to `RouteBased`.
func (r *VirtualNetworkGateway) VpnType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["vpnType"])
}
