...
func NewPublicIp(ctx *kulado.Context,
	name string, args *PublicIpArgs, opts ...kulado.ResourceOpt) (*PublicIp, error) {
...
func GetPublicIp(ctx *kulado.Context,
	name string, id kulado.ID, state *PublicIpState, opts ...kulado.ResourceOpt) (*PublicIp, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *PublicIp) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *PublicIp) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Defines the allocation method for this IP address. Possible values are `Static` or `Dynamic`.
func (r *PublicIp) AllocationMethod() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["allocationMethod"])
}

// Label for the Domain Name. Will be used to make up the FQDN.  If a domain name label is specified, an A DNS record is created for the public IP in the Microsoft Azure DNS system.
func (r *PublicIp) DomainNameLabel() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["domainNameLabel"])
}
...
func (r *PublicIp) Fqdn() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["fqdn"])
}

// Specifies the timeout for the TCP idle connection. The value can be set between 4 and 30 minutes.
func (r *PublicIp) IdleTimeoutInMinutes() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["idleTimeoutInMinutes"])
}

// The IP address value that was allocated.
func (r *PublicIp) IpAddress() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["ipAddress"])
}

// The IP Version to use, IPv6 or IPv4.
func (r *PublicIp) IpVersion() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["ipVersion"])
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *PublicIp) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the Public IP resource . Changing this forces a
// new resource to be created.
func (r *PublicIp) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

func (r *PublicIp) PublicIpAddressAllocation() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["publicIpAddressAllocation"])
}

// If specified then public IP address allocated will be provided from the public IP prefix resource.
func (r *PublicIp) PublicIpPrefixId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["publicIpPrefixId"])
}

// The name of the resource group in which to
// create the public ip.
func (r *PublicIp) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A fully qualified domain name that resolves to this public IP address. If the reverseFqdn is specified, then a PTR DNS record is created pointing from the IP address in the in-addr.arpa domain to the reverse FQDN.
func (r *PublicIp) ReverseFqdn() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["reverseFqdn"])
}

// The SKU of the Public IP. Accepted values are `Basic` and `Standard`. Defaults to `Basic`.
func (r *PublicIp) Sku() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sku"])
}

// A mapping of tags to assign to the resource.
func (r *PublicIp) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// A collection containing the availability zone to allocate the Public IP in.
func (r *PublicIp) Zones() *kulado.StringOutput {
