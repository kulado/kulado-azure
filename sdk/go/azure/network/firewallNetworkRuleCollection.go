...
func NewFirewallNetworkRuleCollection(ctx *kulado.Context,
	name string, args *FirewallNetworkRuleCollectionArgs, opts ...kulado.ResourceOpt) (*FirewallNetworkRuleCollection, error) {
...
func GetFirewallNetworkRuleCollection(ctx *kulado.Context,
	name string, id kulado.ID, state *FirewallNetworkRuleCollectionState, opts ...kulado.ResourceOpt) (*FirewallNetworkRuleCollection, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *FirewallNetworkRuleCollection) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *FirewallNetworkRuleCollection) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the action the rule will apply to matching traffic. Possible values are `Allow` and `Deny`.
func (r *FirewallNetworkRuleCollection) Action() *kulado.StringOutput {
...
func (r *FirewallNetworkRuleCollection) AzureFirewallName() *kulado.StringOutput {
...
func (r *FirewallNetworkRuleCollection) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the priority of the rule collection. Possible values are between `100` - `65000`.
func (r *FirewallNetworkRuleCollection) Priority() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["priority"])
}

// Specifies the name of the Resource Group in which the Firewall exists. Changing this forces a new resource to be created.
func (r *FirewallNetworkRuleCollection) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// One or more `rule` blocks as defined below.
func (r *FirewallNetworkRuleCollection) Rules() *kulado.ArrayOutput {
