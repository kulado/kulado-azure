...
func (r *ElasticPool) ElasticPoolProperties() *kulado.Output {
...
func (r *ElasticPool) MaxSizeBytes() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["maxSizeBytes"])
}

// The max data size of the elastic pool in gigabytes. Conflicts with `max_size_bytes`. 
func (r *ElasticPool) MaxSizeGb() *kulado.Float64Output {
	return (*kulado.Float64Output)(r.s.State["maxSizeGb"])
}
...
func (r *ElasticPool) PerDatabaseSettings() *kulado.Output {
...
func (r *ElasticPool) Sku() *kulado.Output {
...
func (r *ElasticPool) ZoneRedundant() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["zoneRedundant"])
}
