...
func NewCertificate(ctx *kulado.Context,
	name string, args *CertificateArgs, opts ...kulado.ResourceOpt) (*Certificate, error) {
...
func GetCertificate(ctx *kulado.Context,
	name string, id kulado.ID, state *CertificateState, opts ...kulado.ResourceOpt) (*Certificate, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Certificate) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Certificate) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the name of the Batch account. Changing this forces a new resource to be created.
func (r *Certificate) AccountName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["accountName"])
}

// The base64-encoded contents of the certificate.
func (r *Certificate) Certificate() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["certificate"])
}

// The format of the certificate. Possible values are `Cer` or `Pfx`.
func (r *Certificate) Format() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["format"])
}

// The generated name of the certificate.
func (r *Certificate) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The password to access the certificate's private key. This must and can only be specified when `format` is `Pfx`.
func (r *Certificate) Password() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["password"])
}

// The public key of the certificate.
func (r *Certificate) PublicData() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["publicData"])
}

// The name of the resource group in which to create the Batch account. Changing this forces a new resource to be created.
func (r *Certificate) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The thumbprint of the certificate. At this time the only supported value is 'SHA1'.
func (r *Certificate) Thumbprint() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["thumbprint"])
}

func (r *Certificate) ThumbprintAlgorithm() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["thumbprintAlgorithm"])
}
