...
func NewPool(ctx *kulado.Context,
	name string, args *PoolArgs, opts ...kulado.ResourceOpt) (*Pool, error) {
...
func GetPool(ctx *kulado.Context,
	name string, id kulado.ID, state *PoolState, opts ...kulado.ResourceOpt) (*Pool, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Pool) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Pool) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the name of the Batch account in which the pool will be created. Changing this forces a new resource to be created.
func (r *Pool) AccountName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["accountName"])
}

// A `auto_scale` block that describes the scale settings when using auto scale.
func (r *Pool) AutoScale() *kulado.Output {
...
func (r *Pool) Certificates() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["certificates"])
}

// The container configuration used in the pool's VMs.
func (r *Pool) ContainerConfiguration() *kulado.Output {
	return r.s.State["containerConfiguration"]
}

// Specifies the display name of the Batch pool.
func (r *Pool) DisplayName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["displayName"])
}

// A `fixed_scale` block that describes the scale settings when using fixed scale.
func (r *Pool) FixedScale() *kulado.Output {
	return r.s.State["fixedScale"]
}

// Specifies the maximum number of tasks that can run concurrently on a single compute node in the pool. Defaults to `1`. Changing this forces a new resource to be created.
func (r *Pool) MaxTasksPerNode() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["maxTasksPerNode"])
}

// Specifies the name of the Batch pool. Changing this forces a new resource to be created.
func (r *Pool) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the Sku of the node agents that will be created in the Batch pool.
func (r *Pool) NodeAgentSkuId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["nodeAgentSkuId"])
}

// The name of the resource group in which to create the Batch pool. Changing this forces a new resource to be created.
func (r *Pool) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `start_task` block that describes the start task settings for the Batch pool.
func (r *Pool) StartTask() *kulado.Output {
	return r.s.State["startTask"]
}

func (r *Pool) StopPendingResizeOperation() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["stopPendingResizeOperation"])
}

// A `storage_image_reference` for the virtual machines that will compose the Batch pool.
func (r *Pool) StorageImageReference() *kulado.Output {
	return r.s.State["storageImageReference"]
}

// Specifies the size of the VM created in the Batch pool.
func (r *Pool) VmSize() *kulado.StringOutput {
