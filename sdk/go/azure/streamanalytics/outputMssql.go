...
func NewOutputMssql(ctx *kulado.Context,
	name string, args *OutputMssqlArgs, opts ...kulado.ResourceOpt) (*OutputMssql, error) {
...
func GetOutputMssql(ctx *kulado.Context,
	name string, id kulado.ID, state *OutputMssqlState, opts ...kulado.ResourceOpt) (*OutputMssql, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *OutputMssql) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *OutputMssql) ID() *kulado.IDOutput {
	return r.s.ID()
}

func (r *OutputMssql) Database() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["database"])
}

// The name of the Stream Output. Changing this forces a new resource to be created.
func (r *OutputMssql) Name() *kulado.StringOutput {
...
func (r *OutputMssql) Password() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["password"])
}

// The name of the Resource Group where the Stream Analytics Job exists. Changing this forces a new resource to be created.
func (r *OutputMssql) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The SQL server url. Changing this forces a new resource to be created.
func (r *OutputMssql) Server() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["server"])
}

// The name of the Stream Analytics Job. Changing this forces a new resource to be created.
func (r *OutputMssql) StreamAnalyticsJobName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["streamAnalyticsJobName"])
}

// Table in the database that the output points to. Changing this forces a new resource to be created.
func (r *OutputMssql) Table() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["table"])
}

// Username used to login to the Microsoft SQL Server. Changing this forces a new resource to be created.
func (r *OutputMssql) User() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["user"])
}
