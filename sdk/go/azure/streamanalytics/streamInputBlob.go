...
func NewStreamInputBlob(ctx *kulado.Context,
	name string, args *StreamInputBlobArgs, opts ...kulado.ResourceOpt) (*StreamInputBlob, error) {
...
func GetStreamInputBlob(ctx *kulado.Context,
	name string, id kulado.ID, state *StreamInputBlobState, opts ...kulado.ResourceOpt) (*StreamInputBlob, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *StreamInputBlob) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *StreamInputBlob) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The date format. Wherever `{date}` appears in `path_pattern`, the value of this property is used as the date format instead.
func (r *StreamInputBlob) DateFormat() *kulado.StringOutput {
...
func (r *StreamInputBlob) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The blob path pattern. Not a regular expression. It represents a pattern against which blob names will be matched to determine whether or not they should be included as input or output to the job.
func (r *StreamInputBlob) PathPattern() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["pathPattern"])
}

// The name of the Resource Group where the Stream Analytics Job exists. Changing this forces a new resource to be created.
func (r *StreamInputBlob) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `serialization` block as defined below.
func (r *StreamInputBlob) Serialization() *kulado.Output {
	return r.s.State["serialization"]
}

// The Access Key which should be used to connect to this Storage Account.
func (r *StreamInputBlob) StorageAccountKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["storageAccountKey"])
}

// The name of the Storage Account.
func (r *StreamInputBlob) StorageAccountName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["storageAccountName"])
}

// The name of the Container within the Storage Account.
func (r *StreamInputBlob) StorageContainerName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["storageContainerName"])
}

// The name of the Stream Analytics Job. Changing this forces a new resource to be created.
func (r *StreamInputBlob) StreamAnalyticsJobName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["streamAnalyticsJobName"])
}

// The time format. Wherever `{time}` appears in `path_pattern`, the value of this property is used as the time format instead.
func (r *StreamInputBlob) TimeFormat() *kulado.StringOutput {
