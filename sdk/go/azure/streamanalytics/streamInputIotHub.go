...
func NewStreamInputIotHub(ctx *kulado.Context,
	name string, args *StreamInputIotHubArgs, opts ...kulado.ResourceOpt) (*StreamInputIotHub, error) {
...
func GetStreamInputIotHub(ctx *kulado.Context,
	name string, id kulado.ID, state *StreamInputIotHubState, opts ...kulado.ResourceOpt) (*StreamInputIotHub, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *StreamInputIotHub) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *StreamInputIotHub) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The IoT Hub endpoint to connect to (ie. messages/events, messages/operationsMonitoringEvents, etc.).
func (r *StreamInputIotHub) Endpoint() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["endpoint"])
}

// The name of an Event Hub Consumer Group that should be used to read events from the Event Hub. Specifying distinct consumer group names for multiple inputs allows each of those inputs to receive the same events from the Event Hub.
func (r *StreamInputIotHub) EventhubConsumerGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["eventhubConsumerGroupName"])
}

// The name or the URI of the IoT Hub.
func (r *StreamInputIotHub) IothubNamespace() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["iothubNamespace"])
}

// The name of the Stream Input IoTHub. Changing this forces a new resource to be created.
func (r *StreamInputIotHub) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the Resource Group where the Stream Analytics Job exists. Changing this forces a new resource to be created.
func (r *StreamInputIotHub) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `serialization` block as defined below.
func (r *StreamInputIotHub) Serialization() *kulado.Output {
	return r.s.State["serialization"]
}

// The shared access policy key for the specified shared access policy.
func (r *StreamInputIotHub) SharedAccessPolicyKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sharedAccessPolicyKey"])
}

// The shared access policy name for the Event Hub, Service Bus Queue, Service Bus Topic, etc.
func (r *StreamInputIotHub) SharedAccessPolicyName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sharedAccessPolicyName"])
}

// The name of the Stream Analytics Job. Changing this forces a new resource to be created. 
func (r *StreamInputIotHub) StreamAnalyticsJobName() *kulado.StringOutput {
