...
func NewOutputEventHub(ctx *kulado.Context,
	name string, args *OutputEventHubArgs, opts ...kulado.ResourceOpt) (*OutputEventHub, error) {
...
func GetOutputEventHub(ctx *kulado.Context,
	name string, id kulado.ID, state *OutputEventHubState, opts ...kulado.ResourceOpt) (*OutputEventHub, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *OutputEventHub) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *OutputEventHub) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the Event Hub.
func (r *OutputEventHub) EventhubName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["eventhubName"])
}

// The name of the Stream Output. Changing this forces a new resource to be created.
func (r *OutputEventHub) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the Resource Group where the Stream Analytics Job exists. Changing this forces a new resource to be created.
func (r *OutputEventHub) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `serialization` block as defined below.
func (r *OutputEventHub) Serialization() *kulado.Output {
	return r.s.State["serialization"]
}

// The namespace that is associated with the desired Event Hub, Service Bus Queue, Service Bus Topic, etc.
func (r *OutputEventHub) ServicebusNamespace() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["servicebusNamespace"])
}

// The shared access policy key for the specified shared access policy.
func (r *OutputEventHub) SharedAccessPolicyKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sharedAccessPolicyKey"])
}

// The shared access policy name for the Event Hub, Service Bus Queue, Service Bus Topic, etc.
func (r *OutputEventHub) SharedAccessPolicyName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sharedAccessPolicyName"])
}

// The name of the Stream Analytics Job. Changing this forces a new resource to be created.
func (r *OutputEventHub) StreamAnalyticsJobName() *kulado.StringOutput {
