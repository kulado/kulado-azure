...
func NewJob(ctx *kulado.Context,
	name string, args *JobArgs, opts ...kulado.ResourceOpt) (*Job, error) {
...
func GetJob(ctx *kulado.Context,
	name string, id kulado.ID, state *JobState, opts ...kulado.ResourceOpt) (*Job, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Job) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Job) ID() *kulado.IDOutput {
	return r.s.ID()
}
...
func (r *Job) CompatibilityLevel() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["compatibilityLevel"])
}
...
func (r *Job) DataLocale() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["dataLocale"])
}
...
func (r *Job) EventsLateArrivalMaxDelayInSeconds() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["eventsLateArrivalMaxDelayInSeconds"])
}
...
func (r *Job) EventsOutOfOrderMaxDelayInSeconds() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["eventsOutOfOrderMaxDelayInSeconds"])
}
...
func (r *Job) EventsOutOfOrderPolicy() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["eventsOutOfOrderPolicy"])
}

// The Job ID assigned by the Stream Analytics Job.
func (r *Job) JobId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["jobId"])
}

// The Azure Region in which the Resource Group exists. Changing this forces a new resource to be created.
func (r *Job) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the Stream Analytics Job. Changing this forces a new resource to be created.
func (r *Job) Name() *kulado.StringOutput {
...
func (r *Job) OutputErrorPolicy() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["outputErrorPolicy"])
}

// The name of the Resource Group where the Stream Analytics Job should exist. Changing this forces a new resource to be created.
func (r *Job) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// Specifies the number of streaming units that the streaming job uses. Supported values are `1`, `3`, `6` and multiples of `6` up to `120`.
func (r *Job) StreamingUnits() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["streamingUnits"])
}

// A mapping of tags assigned to the resource.
func (r *Job) Tags() *kulado.MapOutput {
...
func (r *Job) TransformationQuery() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["transformationQuery"])
}
