...
func NewStormCluster(ctx *kulado.Context,
	name string, args *StormClusterArgs, opts ...kulado.ResourceOpt) (*StormCluster, error) {
...
func GetStormCluster(ctx *kulado.Context,
	name string, id kulado.ID, state *StormClusterState, opts ...kulado.ResourceOpt) (*StormCluster, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *StormCluster) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *StormCluster) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the Version of HDInsights which should be used for this Cluster. Changing this forces a new resource to be created.
func (r *StormCluster) ClusterVersion() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["clusterVersion"])
}

// A `component_version` block as defined below.
func (r *StormCluster) ComponentVersion() *kulado.Output {
	return r.s.State["componentVersion"]
}

// A `gateway` block as defined below.
func (r *StormCluster) Gateway() *kulado.Output {
	return r.s.State["gateway"]
}

// The HTTPS Connectivity Endpoint for this HDInsight Storm Cluster.
func (r *StormCluster) HttpsEndpoint() *kulado.StringOutput {
...
func (r *StormCluster) Location() *kulado.StringOutput {
...
func (r *StormCluster) Name() *kulado.StringOutput {
...
func (r *StormCluster) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `roles` block as defined below.
func (r *StormCluster) Roles() *kulado.Output {
	return r.s.State["roles"]
}

// The SSH Connectivity Endpoint for this HDInsight Storm Cluster.
func (r *StormCluster) SshEndpoint() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sshEndpoint"])
}

// One or more `storage_account` block as defined below.
func (r *StormCluster) StorageAccounts() *kulado.ArrayOutput {
...
func (r *StormCluster) Tags() *kulado.MapOutput {
...
func (r *StormCluster) Tier() *kulado.StringOutput {
