...
func NewMLServicesCluster(ctx *kulado.Context,
	name string, args *MLServicesClusterArgs, opts ...kulado.ResourceOpt) (*MLServicesCluster, error) {
...
func GetMLServicesCluster(ctx *kulado.Context,
	name string, id kulado.ID, state *MLServicesClusterState, opts ...kulado.ResourceOpt) (*MLServicesCluster, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *MLServicesCluster) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *MLServicesCluster) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the Version of HDInsights which should be used for this Cluster. Changing this forces a new resource to be created.
func (r *MLServicesCluster) ClusterVersion() *kulado.StringOutput {
...
func (r *MLServicesCluster) EdgeSshEndpoint() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["edgeSshEndpoint"])
}

// A `gateway` block as defined below.
func (r *MLServicesCluster) Gateway() *kulado.Output {
	return r.s.State["gateway"]
}

// The HTTPS Connectivity Endpoint for this HDInsight ML Services Cluster.
func (r *MLServicesCluster) HttpsEndpoint() *kulado.StringOutput {
...
func (r *MLServicesCluster) Location() *kulado.StringOutput {
...
func (r *MLServicesCluster) Name() *kulado.StringOutput {
...
func (r *MLServicesCluster) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `roles` block as defined below.
func (r *MLServicesCluster) Roles() *kulado.Output {
...
func (r *MLServicesCluster) Tags() *kulado.MapOutput {
...
func (r *MLServicesCluster) Tier() *kulado.StringOutput {
