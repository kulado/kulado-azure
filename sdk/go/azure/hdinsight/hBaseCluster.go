...
func NewHBaseCluster(ctx *kulado.Context,
	name string, args *HBaseClusterArgs, opts ...kulado.ResourceOpt) (*HBaseCluster, error) {
...
func GetHBaseCluster(ctx *kulado.Context,
	name string, id kulado.ID, state *HBaseClusterState, opts ...kulado.ResourceOpt) (*HBaseCluster, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *HBaseCluster) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *HBaseCluster) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the Version of HDInsights which should be used for this Cluster. Changing this forces a new resource to be created.
func (r *HBaseCluster) ClusterVersion() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["clusterVersion"])
}

// A `component_version` block as defined below.
func (r *HBaseCluster) ComponentVersion() *kulado.Output {
	return r.s.State["componentVersion"]
}

// A `gateway` block as defined below.
func (r *HBaseCluster) Gateway() *kulado.Output {
	return r.s.State["gateway"]
}

// The HTTPS Connectivity Endpoint for this HDInsight HBase Cluster.
func (r *HBaseCluster) HttpsEndpoint() *kulado.StringOutput {
...
func (r *HBaseCluster) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name for this HDInsight HBase Cluster. Changing this forces a new resource to be created.
func (r *HBaseCluster) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the name of the Resource Group in which this HDInsight HBase Cluster should exist. Changing this forces a new resource to be created.
func (r *HBaseCluster) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `roles` block as defined below.
func (r *HBaseCluster) Roles() *kulado.Output {
	return r.s.State["roles"]
}

// The SSH Connectivity Endpoint for this HDInsight HBase Cluster.
func (r *HBaseCluster) SshEndpoint() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sshEndpoint"])
}

// One or more `storage_account` block as defined below.
func (r *HBaseCluster) StorageAccounts() *kulado.ArrayOutput {
...
func (r *HBaseCluster) Tags() *kulado.MapOutput {
...
func (r *HBaseCluster) Tier() *kulado.StringOutput {
