...
func NewInteractiveQueryCluster(ctx *kulado.Context,
	name string, args *InteractiveQueryClusterArgs, opts ...kulado.ResourceOpt) (*InteractiveQueryCluster, error) {
...
func GetInteractiveQueryCluster(ctx *kulado.Context,
	name string, id kulado.ID, state *InteractiveQueryClusterState, opts ...kulado.ResourceOpt) (*InteractiveQueryCluster, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *InteractiveQueryCluster) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *InteractiveQueryCluster) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the Version of HDInsights which should be used for this Cluster. Changing this forces a new resource to be created.
func (r *InteractiveQueryCluster) ClusterVersion() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["clusterVersion"])
}

// A `component_version` block as defined below.
func (r *InteractiveQueryCluster) ComponentVersion() *kulado.Output {
	return r.s.State["componentVersion"]
}

// A `gateway` block as defined below.
func (r *InteractiveQueryCluster) Gateway() *kulado.Output {
	return r.s.State["gateway"]
}

// The HTTPS Connectivity Endpoint for this HDInsight Interactive Query Cluster.
func (r *InteractiveQueryCluster) HttpsEndpoint() *kulado.StringOutput {
...
func (r *InteractiveQueryCluster) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name for this HDInsight Interactive Query Cluster. Changing this forces a new resource to be created.
func (r *InteractiveQueryCluster) Name() *kulado.StringOutput {
...
func (r *InteractiveQueryCluster) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `roles` block as defined below.
func (r *InteractiveQueryCluster) Roles() *kulado.Output {
	return r.s.State["roles"]
}

// The SSH Connectivity Endpoint for this HDInsight Interactive Query Cluster.
func (r *InteractiveQueryCluster) SshEndpoint() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sshEndpoint"])
}

// One or more `storage_account` block as defined below.
func (r *InteractiveQueryCluster) StorageAccounts() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["storageAccounts"])
}

// A map of Tags which should be assigned to this HDInsight Interactive Query Cluster.
func (r *InteractiveQueryCluster) Tags() *kulado.MapOutput {
...
func (r *InteractiveQueryCluster) Tier() *kulado.StringOutput {
