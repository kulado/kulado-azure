...
func NewCassandraKeyspace(ctx *kulado.Context,
	name string, args *CassandraKeyspaceArgs, opts ...kulado.ResourceOpt) (*CassandraKeyspace, error) {
...
func GetCassandraKeyspace(ctx *kulado.Context,
	name string, id kulado.ID, state *CassandraKeyspaceState, opts ...kulado.ResourceOpt) (*CassandraKeyspace, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *CassandraKeyspace) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *CassandraKeyspace) ID() *kulado.IDOutput {
	return r.s.ID()
}
...
func (r *CassandraKeyspace) AccountName() *kulado.StringOutput {
...
func (r *CassandraKeyspace) Name() *kulado.StringOutput {
...
func (r *CassandraKeyspace) ResourceGroupName() *kulado.StringOutput {
