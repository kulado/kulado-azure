...
func (r *Account) Capabilities() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["capabilities"])
}

// A list of connection strings available for this CosmosDB account. If the kind is `GlobalDocumentDB`, this will be empty.
func (r *Account) ConnectionStrings() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["connectionStrings"])
}

// Specifies a `consistency_policy` resource, used to define the consistency policy for this CosmosDB account.
func (r *Account) ConsistencyPolicy() *kulado.Output {
	return r.s.State["consistencyPolicy"]
}

// Enable automatic fail over for this Cosmos DB account.
func (r *Account) EnableAutomaticFailover() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableAutomaticFailover"])
}

// Enable multi-master support for this Cosmos DB account.
func (r *Account) EnableMultipleWriteLocations() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableMultipleWriteLocations"])
}
...
func (r *Account) FailoverPolicies() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["failoverPolicies"])
}
...
func (r *Account) GeoLocations() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["geoLocations"])
}

// CosmosDB Firewall Support: This value specifies the set of IP addresses or IP address ranges in CIDR form to be included as the allowed list of client IP's for a given database account. IP addresses/ranges must be comma separated and must not contain any spaces.
func (r *Account) IpRangeFilter() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["ipRangeFilter"])
}

// Enables virtual network filtering for this Cosmos DB account.
func (r *Account) IsVirtualNetworkFilterEnabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["isVirtualNetworkFilterEnabled"])
}
...
func (r *Account) OfferType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["offerType"])
}

// The Primary master key for the CosmosDB Account.
func (r *Account) PrimaryMasterKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryMasterKey"])
}

// The Primary read-only master Key for the CosmosDB Account.
func (r *Account) PrimaryReadonlyMasterKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryReadonlyMasterKey"])
}

// A list of read endpoints available for this CosmosDB account.
func (r *Account) ReadEndpoints() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["readEndpoints"])
}
...
func (r *Account) SecondaryMasterKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryMasterKey"])
}

// The Secondary read-only master key for the CosmosDB Account.
func (r *Account) SecondaryReadonlyMasterKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryReadonlyMasterKey"])
}
...
func (r *Account) VirtualNetworkRules() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["virtualNetworkRules"])
}

// A list of write endpoints available for this CosmosDB account.
func (r *Account) WriteEndpoints() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["writeEndpoints"])
}
