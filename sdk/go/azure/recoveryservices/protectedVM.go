...
func NewProtectedVM(ctx *kulado.Context,
	name string, args *ProtectedVMArgs, opts ...kulado.ResourceOpt) (*ProtectedVM, error) {
...
func GetProtectedVM(ctx *kulado.Context,
	name string, id kulado.ID, state *ProtectedVMState, opts ...kulado.ResourceOpt) (*ProtectedVM, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ProtectedVM) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ProtectedVM) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the id of the backup policy to use. Changing this forces a new resource to be created.
func (r *ProtectedVM) BackupPolicyId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["backupPolicyId"])
}

// Specifies the name of the Recovery Services Vault to use. Changing this forces a new resource to be created.
func (r *ProtectedVM) RecoveryVaultName() *kulado.StringOutput {
...
func (r *ProtectedVM) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// Specifies the ID of the VM to backup. Changing this forces a new resource to be created.
func (r *ProtectedVM) SourceVmId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sourceVmId"])
}

// A mapping of tags to assign to the resource.
func (r *ProtectedVM) Tags() *kulado.MapOutput {
