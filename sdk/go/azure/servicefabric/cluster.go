...
func NewCluster(ctx *kulado.Context,
	name string, args *ClusterArgs, opts ...kulado.ResourceOpt) (*Cluster, error) {
...
func GetCluster(ctx *kulado.Context,
	name string, id kulado.ID, state *ClusterState, opts ...kulado.ResourceOpt) (*Cluster, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Cluster) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Cluster) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A List of one or more features which should be enabled, such as `DnsService`.
func (r *Cluster) AddOnFeatures() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["addOnFeatures"])
}

// An `azure_active_directory` block as defined below.
func (r *Cluster) AzureActiveDirectory() *kulado.Output {
	return r.s.State["azureActiveDirectory"]
}

// A `certificate` block as defined below. Conflicts with `certificate_common_names`.
func (r *Cluster) Certificate() *kulado.Output {
	return r.s.State["certificate"]
}

// A `certificate_common_names` block as defined below. Conflicts with `certificate`.
func (r *Cluster) CertificateCommonNames() *kulado.Output {
	return r.s.State["certificateCommonNames"]
}

// One or two `client_certificate_thumbprint` blocks as defined below.
func (r *Cluster) ClientCertificateThumbprints() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["clientCertificateThumbprints"])
}

// Required if Upgrade Mode set to `Manual`, Specifies the Version of the Cluster Code of the cluster.
func (r *Cluster) ClusterCodeVersion() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["clusterCodeVersion"])
}

// The Cluster Endpoint for this Service Fabric Cluster.
func (r *Cluster) ClusterEndpoint() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["clusterEndpoint"])
}

// A `diagnostics_config` block as defined below. Changing this forces a new resource to be created.
func (r *Cluster) DiagnosticsConfig() *kulado.Output {
	return r.s.State["diagnosticsConfig"]
}

// One or more `fabric_settings` blocks as defined below.
func (r *Cluster) FabricSettings() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["fabricSettings"])
}

// Specifies the Azure Region where the Service Fabric Cluster should exist. Changing this forces a new resource to be created.
func (r *Cluster) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the Management Endpoint of the cluster such as `http://example.com`. Changing this forces a new resource to be created.
func (r *Cluster) ManagementEndpoint() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["managementEndpoint"])
}

// The name of the Service Fabric Cluster. Changing this forces a new resource to be created.
func (r *Cluster) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// One or more `node_type` blocks as defined below.
func (r *Cluster) NodeTypes() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["nodeTypes"])
}

// Specifies the Reliability Level of the Cluster. Possible values include `None`, `Bronze`, `Silver`, `Gold` and `Platinum`.
func (r *Cluster) ReliabilityLevel() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["reliabilityLevel"])
}

// The name of the Resource Group in which the Service Fabric Cluster exists. Changing this forces a new resource to be created.
func (r *Cluster) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `reverse_proxy_certificate` block as defined below.
func (r *Cluster) ReverseProxyCertificate() *kulado.Output {
	return r.s.State["reverseProxyCertificate"]
}

// A mapping of tags to assign to the resource.
func (r *Cluster) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// Specifies the Upgrade Mode of the cluster. Possible values are `Automatic` or `Manual`.
func (r *Cluster) UpgradeMode() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["upgradeMode"])
}

// Specifies the Image expected for the Service Fabric Cluster, such as `Windows`. Changing this forces a new resource to be created.
func (r *Cluster) VmImage() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["vmImage"])
}
