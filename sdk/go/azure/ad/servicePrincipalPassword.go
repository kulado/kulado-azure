...
func NewServicePrincipalPassword(ctx *kulado.Context,
	name string, args *ServicePrincipalPasswordArgs, opts ...kulado.ResourceOpt) (*ServicePrincipalPassword, error) {
...
func GetServicePrincipalPassword(ctx *kulado.Context,
	name string, id kulado.ID, state *ServicePrincipalPasswordState, opts ...kulado.ResourceOpt) (*ServicePrincipalPassword, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ServicePrincipalPassword) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ServicePrincipalPassword) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The End Date which the Password is valid until, formatted as a RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). Changing this field forces a new resource to be created.
func (r *ServicePrincipalPassword) EndDate() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["endDate"])
}
...
func (r *ServicePrincipalPassword) KeyId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["keyId"])
}

// The ID of the Service Principal for which this password should be created. Changing this field forces a new resource to be created.
func (r *ServicePrincipalPassword) ServicePrincipalId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["servicePrincipalId"])
}

// The Start Date which the Password is valid from, formatted as a RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If this isn't specified, the current date is used.  Changing this field forces a new resource to be created.
func (r *ServicePrincipalPassword) StartDate() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["startDate"])
}

// The Password for this Service Principal.
func (r *ServicePrincipalPassword) Value() *kulado.StringOutput {
