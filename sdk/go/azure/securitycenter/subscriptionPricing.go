...
func NewSubscriptionPricing(ctx *kulado.Context,
	name string, args *SubscriptionPricingArgs, opts ...kulado.ResourceOpt) (*SubscriptionPricing, error) {
...
func GetSubscriptionPricing(ctx *kulado.Context,
	name string, id kulado.ID, state *SubscriptionPricingState, opts ...kulado.ResourceOpt) (*SubscriptionPricing, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *SubscriptionPricing) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *SubscriptionPricing) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The pricing tier to use. Possible values are `Free` and `Standard`.
func (r *SubscriptionPricing) Tier() *kulado.StringOutput {
