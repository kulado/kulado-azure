...
func NewContainer(ctx *kulado.Context,
	name string, args *ContainerArgs, opts ...kulado.ResourceOpt) (*Container, error) {
...
func GetContainer(ctx *kulado.Context,
	name string, id kulado.ID, state *ContainerState, opts ...kulado.ResourceOpt) (*Container, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Container) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Container) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The 'interface' for access the container provides. Can be either `blob`, `container` or `private`. Defaults to `private`.
func (r *Container) ContainerAccessType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["containerAccessType"])
}

// The name of the storage container. Must be unique within the storage service the container is located.
func (r *Container) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Key-value definition of additional properties associated to the storage container
func (r *Container) Properties() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["properties"])
}

// The name of the resource group in which to
// create the storage container. Changing this forces a new resource to be created.
func (r *Container) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// Specifies the storage account in which to create the storage container.
// Changing this forces a new resource to be created.
func (r *Container) StorageAccountName() *kulado.StringOutput {
