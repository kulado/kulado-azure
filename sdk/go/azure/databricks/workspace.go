...
func (r *Workspace) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The ID of the Managed Resource Group created by the Databricks Workspace.
func (r *Workspace) ManagedResourceGroupId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["managedResourceGroupId"])
}

// The name of the resource group where Azure should place the managed Databricks resources. Changing this forces a new resource to be created.
func (r *Workspace) ManagedResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["managedResourceGroupName"])
}

// Specifies the name of the Databricks Workspace resource. Changing this forces a new resource to be created.
func (r *Workspace) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the Resource Group in which the Databricks Workspace should exist. Changing this forces a new resource to be created.
func (r *Workspace) ResourceGroupName() *kulado.StringOutput {
...
func (r *Workspace) Sku() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sku"])
}

// A mapping of tags to assign to the resource.
func (r *Workspace) Tags() *kulado.MapOutput {
