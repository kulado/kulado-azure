...
func (r *Service) ReplicaCount() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["replicaCount"])
}
...
func (r *Service) SecondaryKey() *kulado.StringOutput {
...
func (r *Service) Sku() *kulado.StringOutput {
