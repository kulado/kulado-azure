...
func NewAnalyticsAccount(ctx *kulado.Context,
	name string, args *AnalyticsAccountArgs, opts ...kulado.ResourceOpt) (*AnalyticsAccount, error) {
...
func GetAnalyticsAccount(ctx *kulado.Context,
	name string, id kulado.ID, state *AnalyticsAccountState, opts ...kulado.ResourceOpt) (*AnalyticsAccount, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *AnalyticsAccount) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *AnalyticsAccount) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the data lake store to use by default. Changing this forces a new resource to be created.
func (r *AnalyticsAccount) DefaultStoreAccountName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["defaultStoreAccountName"])
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *AnalyticsAccount) Location() *kulado.StringOutput {
...
func (r *AnalyticsAccount) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the resource group in which to create the Data Lake Analytics Account.
func (r *AnalyticsAccount) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A mapping of tags to assign to the resource.
func (r *AnalyticsAccount) Tags() *kulado.MapOutput {
...
func (r *AnalyticsAccount) Tier() *kulado.StringOutput {
