...
func NewStoreFirewallRule(ctx *kulado.Context,
	name string, args *StoreFirewallRuleArgs, opts ...kulado.ResourceOpt) (*StoreFirewallRule, error) {
...
func GetStoreFirewallRule(ctx *kulado.Context,
	name string, id kulado.ID, state *StoreFirewallRuleState, opts ...kulado.ResourceOpt) (*StoreFirewallRule, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *StoreFirewallRule) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *StoreFirewallRule) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the name of the Data Lake Store for which the Firewall Rule should take effect.
func (r *StoreFirewallRule) AccountName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["accountName"])
}

// The End IP Address for the firewall rule.
func (r *StoreFirewallRule) EndIpAddress() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["endIpAddress"])
}

// Specifies the name of the Data Lake Store. Changing this forces a new resource to be created. Has to be between 3 to 24 characters.
func (r *StoreFirewallRule) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the resource group in which to create the Data Lake Store.
func (r *StoreFirewallRule) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The Start IP address for the firewall rule.
func (r *StoreFirewallRule) StartIpAddress() *kulado.StringOutput {
