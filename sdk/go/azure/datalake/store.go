...
func NewStore(ctx *kulado.Context,
	name string, args *StoreArgs, opts ...kulado.ResourceOpt) (*Store, error) {
...
func GetStore(ctx *kulado.Context,
	name string, id kulado.ID, state *StoreState, opts ...kulado.ResourceOpt) (*Store, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Store) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Store) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Is Encryption enabled on this Data Lake Store Account? Possible values are `Enabled` or `Disabled`. Defaults to `Enabled`.
func (r *Store) EncryptionState() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["encryptionState"])
}
...
func (r *Store) EncryptionType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["encryptionType"])
}

// The Endpoint for the Data Lake Store.
func (r *Store) Endpoint() *kulado.StringOutput {
...
func (r *Store) FirewallAllowAzureIps() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["firewallAllowAzureIps"])
}

// the state of the Firewall. Possible values are `Enabled` and `Disabled`. Defaults to `Enabled.`
func (r *Store) FirewallState() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["firewallState"])
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *Store) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the Data Lake Store. Changing this forces a new resource to be created. Has to be between 3 to 24 characters.
func (r *Store) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the resource group in which to create the Data Lake Store.
func (r *Store) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A mapping of tags to assign to the resource.
func (r *Store) Tags() *kulado.MapOutput {
...
func (r *Store) Tier() *kulado.StringOutput {
