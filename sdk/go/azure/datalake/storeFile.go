...
func NewStoreFile(ctx *kulado.Context,
	name string, args *StoreFileArgs, opts ...kulado.ResourceOpt) (*StoreFile, error) {
...
func GetStoreFile(ctx *kulado.Context,
	name string, id kulado.ID, state *StoreFileState, opts ...kulado.ResourceOpt) (*StoreFile, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *StoreFile) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *StoreFile) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the name of the Data Lake Store for which the File should created.
func (r *StoreFile) AccountName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["accountName"])
}

// The path to the local file to be added to the Data Lake Store.
func (r *StoreFile) LocalFilePath() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["localFilePath"])
}

// The path created for the file on the Data Lake Store.
func (r *StoreFile) RemoteFilePath() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["remoteFilePath"])
}
