...
func NewManagementGroup(ctx *kulado.Context,
	name string, args *ManagementGroupArgs, opts ...kulado.ResourceOpt) (*ManagementGroup, error) {
...
func GetManagementGroup(ctx *kulado.Context,
	name string, id kulado.ID, state *ManagementGroupState, opts ...kulado.ResourceOpt) (*ManagementGroup, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ManagementGroup) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ManagementGroup) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A friendly name for this Management Group. If not specified, this'll be the same as the `group_id`.
func (r *ManagementGroup) DisplayName() *kulado.StringOutput {
...
func (r *ManagementGroup) GroupId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["groupId"])
}

// The ID of the Parent Management Group. Changing this forces a new resource to be created.
func (r *ManagementGroup) ParentManagementGroupId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["parentManagementGroupId"])
}

// A list of Subscription GUIDs which should be assigned to the Management Group.
func (r *ManagementGroup) SubscriptionIds() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["subscriptionIds"])
}
