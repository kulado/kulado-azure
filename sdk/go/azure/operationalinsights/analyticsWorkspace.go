...
func NewAnalyticsWorkspace(ctx *kulado.Context,
	name string, args *AnalyticsWorkspaceArgs, opts ...kulado.ResourceOpt) (*AnalyticsWorkspace, error) {
...
func GetAnalyticsWorkspace(ctx *kulado.Context,
	name string, id kulado.ID, state *AnalyticsWorkspaceState, opts ...kulado.ResourceOpt) (*AnalyticsWorkspace, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *AnalyticsWorkspace) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *AnalyticsWorkspace) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *AnalyticsWorkspace) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the Log Analytics Workspace. Workspace name should include 4-63 letters, digits or '-'. The '-' shouldn't be the first or the last symbol. Changing this forces a new resource to be created.
func (r *AnalyticsWorkspace) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The Portal URL for the Log Analytics Workspace.
func (r *AnalyticsWorkspace) PortalUrl() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["portalUrl"])
}

// The Primary shared key for the Log Analytics Workspace.
func (r *AnalyticsWorkspace) PrimarySharedKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primarySharedKey"])
}

// The name of the resource group in which the Log Analytics workspace is created. Changing this forces a new resource to be created.
func (r *AnalyticsWorkspace) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The workspace data retention in days. Possible values range between 30 and 730.
func (r *AnalyticsWorkspace) RetentionInDays() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["retentionInDays"])
}

// The Secondary shared key for the Log Analytics Workspace.
func (r *AnalyticsWorkspace) SecondarySharedKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondarySharedKey"])
}
...
func (r *AnalyticsWorkspace) Sku() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sku"])
}

// A mapping of tags to assign to the resource.
func (r *AnalyticsWorkspace) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// The Workspace (or Customer) ID for the Log Analytics Workspace.
func (r *AnalyticsWorkspace) WorkspaceId() *kulado.StringOutput {
