...
func NewAnalyticsWorkspaceLinkedService(ctx *kulado.Context,
	name string, args *AnalyticsWorkspaceLinkedServiceArgs, opts ...kulado.ResourceOpt) (*AnalyticsWorkspaceLinkedService, error) {
...
func GetAnalyticsWorkspaceLinkedService(ctx *kulado.Context,
	name string, id kulado.ID, state *AnalyticsWorkspaceLinkedServiceState, opts ...kulado.ResourceOpt) (*AnalyticsWorkspaceLinkedService, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *AnalyticsWorkspaceLinkedService) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *AnalyticsWorkspaceLinkedService) ID() *kulado.IDOutput {
	return r.s.ID()
}
...
func (r *AnalyticsWorkspaceLinkedService) LinkedServiceName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["linkedServiceName"])
}

// A `linked_service_properties` block as defined below.
func (r *AnalyticsWorkspaceLinkedService) LinkedServiceProperties() *kulado.ArrayOutput {
...
func (r *AnalyticsWorkspaceLinkedService) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the resource group in which the Log Analytics Linked Service is created. Changing this forces a new resource to be created.
func (r *AnalyticsWorkspaceLinkedService) ResourceGroupName() *kulado.StringOutput {
...
func (r *AnalyticsWorkspaceLinkedService) ResourceId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceId"])
}

// A mapping of tags to assign to the resource.
func (r *AnalyticsWorkspaceLinkedService) Tags() *kulado.MapOutput {
...
func (r *AnalyticsWorkspaceLinkedService) WorkspaceName() *kulado.StringOutput {
