...
func NewAnalyticsSolution(ctx *kulado.Context,
	name string, args *AnalyticsSolutionArgs, opts ...kulado.ResourceOpt) (*AnalyticsSolution, error) {
...
func GetAnalyticsSolution(ctx *kulado.Context,
	name string, id kulado.ID, state *AnalyticsSolutionState, opts ...kulado.ResourceOpt) (*AnalyticsSolution, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *AnalyticsSolution) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *AnalyticsSolution) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *AnalyticsSolution) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// A `plan` block as documented below.
func (r *AnalyticsSolution) Plan() *kulado.Output {
...
func (r *AnalyticsSolution) ResourceGroupName() *kulado.StringOutput {
...
func (r *AnalyticsSolution) SolutionName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["solutionName"])
}

// The full name of the Log Analytics workspace with which the solution will be linked. Changing this forces a new resource to be created.
func (r *AnalyticsSolution) WorkspaceName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["workspaceName"])
}

// The full resource ID of the Log Analytics workspace with which the solution will be linked. Changing this forces a new resource to be created.
func (r *AnalyticsSolution) WorkspaceResourceId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["workspaceResourceId"])
}
