...
func NewLoadBalancer(ctx *kulado.Context,
	name string, args *LoadBalancerArgs, opts ...kulado.ResourceOpt) (*LoadBalancer, error) {
...
func GetLoadBalancer(ctx *kulado.Context,
	name string, id kulado.ID, state *LoadBalancerState, opts ...kulado.ResourceOpt) (*LoadBalancer, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *LoadBalancer) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *LoadBalancer) ID() *kulado.IDOutput {
	return r.s.ID()
}

// One or multiple `frontend_ip_configuration` blocks as documented below.
func (r *LoadBalancer) FrontendIpConfigurations() *kulado.ArrayOutput {
...
func (r *LoadBalancer) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the frontend ip configuration.
func (r *LoadBalancer) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Private IP Address to assign to the Load Balancer. The last one and first four IPs in any range are reserved and cannot be manually assigned.
func (r *LoadBalancer) PrivateIpAddress() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["privateIpAddress"])
}

// The list of private IP address assigned to the load balancer in `frontend_ip_configuration` blocks, if any.
func (r *LoadBalancer) PrivateIpAddresses() *kulado.ArrayOutput {
