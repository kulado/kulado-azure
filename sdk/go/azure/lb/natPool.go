...
func NewNatPool(ctx *kulado.Context,
	name string, args *NatPoolArgs, opts ...kulado.ResourceOpt) (*NatPool, error) {
...
func GetNatPool(ctx *kulado.Context,
	name string, id kulado.ID, state *NatPoolState, opts ...kulado.ResourceOpt) (*NatPool, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *NatPool) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *NatPool) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The port used for the internal endpoint. Possible values range between 1 and 65535, inclusive.
func (r *NatPool) BackendPort() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["backendPort"])
}

func (r *NatPool) FrontendIpConfigurationId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["frontendIpConfigurationId"])
}

// The name of the frontend IP configuration exposing this rule.
func (r *NatPool) FrontendIpConfigurationName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["frontendIpConfigurationName"])
}

// The last port number in the range of external ports that will be used to provide Inbound Nat to NICs associated with this Load Balancer. Possible values range between 1 and 65534, inclusive.
func (r *NatPool) FrontendPortEnd() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["frontendPortEnd"])
}

// The first port number in the range of external ports that will be used to provide Inbound Nat to NICs associated with this Load Balancer. Possible values range between 1 and 65534, inclusive.
func (r *NatPool) FrontendPortStart() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["frontendPortStart"])
}

// The ID of the Load Balancer in which to create the NAT pool.
func (r *NatPool) LoadbalancerId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["loadbalancerId"])
}

func (r *NatPool) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the NAT pool.
func (r *NatPool) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The transport protocol for the external endpoint. Possible values are `Udp` or `Tcp`.
func (r *NatPool) Protocol() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["protocol"])
}

// The name of the resource group in which to create the resource.
func (r *NatPool) ResourceGroupName() *kulado.StringOutput {
