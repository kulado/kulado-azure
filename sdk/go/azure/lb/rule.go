...
func NewRule(ctx *kulado.Context,
	name string, args *RuleArgs, opts ...kulado.ResourceOpt) (*Rule, error) {
...
func GetRule(ctx *kulado.Context,
	name string, id kulado.ID, state *RuleState, opts ...kulado.ResourceOpt) (*Rule, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Rule) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Rule) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A reference to a Backend Address Pool over which this Load Balancing Rule operates.
func (r *Rule) BackendAddressPoolId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["backendAddressPoolId"])
}

// The port used for internal connections on the endpoint. Possible values range between 0 and 65535, inclusive.
func (r *Rule) BackendPort() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["backendPort"])
}

// Indicates whether outbound snat is disabled or enabled. Default false.
func (r *Rule) DisableOutboundSnat() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["disableOutboundSnat"])
}
...
func (r *Rule) EnableFloatingIp() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableFloatingIp"])
}

func (r *Rule) FrontendIpConfigurationId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["frontendIpConfigurationId"])
}

// The name of the frontend IP configuration to which the rule is associated.
func (r *Rule) FrontendIpConfigurationName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["frontendIpConfigurationName"])
}

// The port for the external endpoint. Port numbers for each Rule must be unique within the Load Balancer. Possible values range between 0 and 65534, inclusive.
func (r *Rule) FrontendPort() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["frontendPort"])
}
...
func (r *Rule) IdleTimeoutInMinutes() *kulado.IntOutput {
...
func (r *Rule) LoadDistribution() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["loadDistribution"])
}

// The ID of the Load Balancer in which to create the Rule.
func (r *Rule) LoadbalancerId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["loadbalancerId"])
}

func (r *Rule) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the LB Rule.
func (r *Rule) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A reference to a Probe used by this Load Balancing Rule.
func (r *Rule) ProbeId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["probeId"])
}

// The transport protocol for the external endpoint. Possible values are `Tcp`, `Udp` or `All`.
func (r *Rule) Protocol() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["protocol"])
}

// The name of the resource group in which to create the resource.
func (r *Rule) ResourceGroupName() *kulado.StringOutput {
