...
func NewNatRule(ctx *kulado.Context,
	name string, args *NatRuleArgs, opts ...kulado.ResourceOpt) (*NatRule, error) {
...
func GetNatRule(ctx *kulado.Context,
	name string, id kulado.ID, state *NatRuleState, opts ...kulado.ResourceOpt) (*NatRule, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *NatRule) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *NatRule) ID() *kulado.IDOutput {
	return r.s.ID()
}

func (r *NatRule) BackendIpConfigurationId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["backendIpConfigurationId"])
}

// The port used for internal connections on the endpoint. Possible values range between 1 and 65535, inclusive.
func (r *NatRule) BackendPort() *kulado.IntOutput {
