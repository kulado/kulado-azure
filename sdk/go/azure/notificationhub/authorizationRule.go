...
func NewAuthorizationRule(ctx *kulado.Context,
	name string, args *AuthorizationRuleArgs, opts ...kulado.ResourceOpt) (*AuthorizationRule, error) {
...
func GetAuthorizationRule(ctx *kulado.Context,
	name string, id kulado.ID, state *AuthorizationRuleState, opts ...kulado.ResourceOpt) (*AuthorizationRule, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *AuthorizationRule) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *AuthorizationRule) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Does this Authorization Rule have Listen access to the Notification Hub? Defaults to `false`.
func (r *AuthorizationRule) Listen() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["listen"])
}

// Does this Authorization Rule have Manage access to the Notification Hub? Defaults to `false`.
func (r *AuthorizationRule) Manage() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["manage"])
}

// The name to use for this Authorization Rule. Changing this forces a new resource to be created.
func (r *AuthorizationRule) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the Notification Hub Namespace in which the Notification Hub exists. Changing this forces a new resource to be created.
func (r *AuthorizationRule) NamespaceName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["namespaceName"])
}

// The name of the Notification Hub for which the Authorization Rule should be created. Changing this forces a new resource to be created.
func (r *AuthorizationRule) NotificationHubName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["notificationHubName"])
}

// The Primary Access Key associated with this Authorization Rule.
func (r *AuthorizationRule) PrimaryAccessKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryAccessKey"])
}

// The name of the Resource Group in which the Notification Hub Namespace exists. Changing this forces a new resource to be created.
func (r *AuthorizationRule) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The Secondary Access Key associated with this Authorization Rule.
func (r *AuthorizationRule) SecondaryAccessKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryAccessKey"])
}

// Does this Authorization Rule have Send access to the Notification Hub? Defaults to `false`.
func (r *AuthorizationRule) Send() *kulado.BoolOutput {
