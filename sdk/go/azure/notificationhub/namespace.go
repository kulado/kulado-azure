...
func (r *Namespace) Enabled() *kulado.BoolOutput {
...
func (r *Namespace) NamespaceType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["namespaceType"])
}
...
func (r *Namespace) ServicebusEndpoint() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["servicebusEndpoint"])
}
