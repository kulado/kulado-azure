...
func NewEndpoint(ctx *kulado.Context,
	name string, args *EndpointArgs, opts ...kulado.ResourceOpt) (*Endpoint, error) {
...
func GetEndpoint(ctx *kulado.Context,
	name string, id kulado.ID, state *EndpointState, opts ...kulado.ResourceOpt) (*Endpoint, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Endpoint) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Endpoint) ID() *kulado.IDOutput {
	return r.s.ID()
}

// An array of strings that indicates a content types on which compression will be applied. The value for the elements should be MIME types.
func (r *Endpoint) ContentTypesToCompresses() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["contentTypesToCompresses"])
}

// A set of Geo Filters for this CDN Endpoint. Each `geo_filter` block supports fields documented below.
func (r *Endpoint) GeoFilters() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["geoFilters"])
}

func (r *Endpoint) HostName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["hostName"])
}

// Indicates whether compression is to be enabled. Defaults to false.
func (r *Endpoint) IsCompressionEnabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["isCompressionEnabled"])
}

// Defaults to `true`.
func (r *Endpoint) IsHttpAllowed() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["isHttpAllowed"])
}

// Defaults to `true`.
func (r *Endpoint) IsHttpsAllowed() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["isHttpsAllowed"])
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *Endpoint) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the CDN Endpoint. Changing this forces a new resource to be created.
func (r *Endpoint) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// What types of optimization should this CDN Endpoint optimize for? Possible values include `DynamicSiteAcceleration`, `GeneralMediaStreaming`, `GeneralWebDelivery`, `LargeFileDownload` and `VideoOnDemandMediaStreaming`.
func (r *Endpoint) OptimizationType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["optimizationType"])
}

// The set of origins of the CDN endpoint. When multiple origins exist, the first origin will be used as primary and rest will be used as failover options. Each `origin` block supports fields documented below.
func (r *Endpoint) Origins() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["origins"])
}

// The host header CDN provider will send along with content requests to origins. Defaults to the host name of the origin.
func (r *Endpoint) OriginHostHeader() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["originHostHeader"])
}

// The path used at for origin requests.
func (r *Endpoint) OriginPath() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["originPath"])
}

// the path to a file hosted on the origin which helps accelerate delivery of the dynamic content and calculate the most optimal routes for the CDN. This is relative to the `origin_path`.
func (r *Endpoint) ProbePath() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["probePath"])
}

// The CDN Profile to which to attach the CDN Endpoint.
func (r *Endpoint) ProfileName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["profileName"])
}
...
func (r *Endpoint) QuerystringCachingBehaviour() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["querystringCachingBehaviour"])
}

// The name of the resource group in which to create the CDN Endpoint.
func (r *Endpoint) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A mapping of tags to assign to the resource.
func (r *Endpoint) Tags() *kulado.MapOutput {
