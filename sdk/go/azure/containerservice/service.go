...
func (r *Service) MasterProfile() *kulado.Output {
...
func (r *Service) OrchestrationPlatform() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["orchestrationPlatform"])
}
...
func (r *Service) ServicePrincipal() *kulado.Output {
