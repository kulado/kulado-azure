...
func NewKubernetesCluster(ctx *kulado.Context,
	name string, args *KubernetesClusterArgs, opts ...kulado.ResourceOpt) (*KubernetesCluster, error) {
...
func GetKubernetesCluster(ctx *kulado.Context,
	name string, id kulado.ID, state *KubernetesClusterState, opts ...kulado.ResourceOpt) (*KubernetesCluster, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *KubernetesCluster) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *KubernetesCluster) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A `addon_profile` block.
func (r *KubernetesCluster) AddonProfile() *kulado.Output {
	return r.s.State["addonProfile"]
}

// One or more `agent_pool_profile` blocks as defined below.
func (r *KubernetesCluster) AgentPoolProfiles() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["agentPoolProfiles"])
}

// The IP ranges to whitelist for incoming traffic to the masters.
func (r *KubernetesCluster) ApiServerAuthorizedIpRanges() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["apiServerAuthorizedIpRanges"])
}

// DNS prefix specified when creating the managed cluster. Changing this forces a new resource to be created.
func (r *KubernetesCluster) DnsPrefix() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["dnsPrefix"])
}

// The FQDN of the Azure Kubernetes Managed Cluster.
func (r *KubernetesCluster) Fqdn() *kulado.StringOutput {
...
func (r *KubernetesCluster) KubeAdminConfig() *kulado.Output {
	return r.s.State["kubeAdminConfig"]
}

// Raw Kubernetes config for the admin account to be used by [kubectl](https://kubernetes.io/docs/reference/kubectl/overview/) and other compatible tools. This is only available when Role Based Access Control with Azure Active Directory is enabled.
func (r *KubernetesCluster) KubeAdminConfigRaw() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["kubeAdminConfigRaw"])
}

// A `kube_config` block as defined below.
func (r *KubernetesCluster) KubeConfig() *kulado.Output {
	return r.s.State["kubeConfig"]
}

// Raw Kubernetes config to be used by [kubectl](https://kubernetes.io/docs/reference/kubectl/overview/) and other compatible tools
func (r *KubernetesCluster) KubeConfigRaw() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["kubeConfigRaw"])
}

// Version of Kubernetes specified when creating the AKS managed cluster. If not specified, the latest recommended version will be used at provisioning time (but won't auto-upgrade).
func (r *KubernetesCluster) KubernetesVersion() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["kubernetesVersion"])
}

// A `linux_profile` block.
func (r *KubernetesCluster) LinuxProfile() *kulado.Output {
	return r.s.State["linuxProfile"]
}

// The location where the Managed Kubernetes Cluster should be created. Changing this forces a new resource to be created.
func (r *KubernetesCluster) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the Managed Kubernetes Cluster to create. Changing this forces a new resource to be created.
func (r *KubernetesCluster) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A `network_profile` block.
func (r *KubernetesCluster) NetworkProfile() *kulado.Output {
...
func (r *KubernetesCluster) NodeResourceGroup() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["nodeResourceGroup"])
}

// Specifies the Resource Group where the Managed Kubernetes Cluster should exist. Changing this forces a new resource to be created.
func (r *KubernetesCluster) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `role_based_access_control` block. Changing this forces a new resource to be created.
func (r *KubernetesCluster) RoleBasedAccessControl() *kulado.Output {
	return r.s.State["roleBasedAccessControl"]
}

// A `service_principal` block as documented below.
func (r *KubernetesCluster) ServicePrincipal() *kulado.Output {
	return r.s.State["servicePrincipal"]
}

// A mapping of tags to assign to the resource.
func (r *KubernetesCluster) Tags() *kulado.MapOutput {
