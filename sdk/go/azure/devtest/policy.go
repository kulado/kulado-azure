...
func NewPolicy(ctx *kulado.Context,
	name string, args *PolicyArgs, opts ...kulado.ResourceOpt) (*Policy, error) {
...
func GetPolicy(ctx *kulado.Context,
	name string, id kulado.ID, state *PolicyState, opts ...kulado.ResourceOpt) (*Policy, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Policy) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Policy) ID() *kulado.IDOutput {
	return r.s.ID()
}

// A description for the Policy.
func (r *Policy) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// The Evaluation Type used for this Policy. Possible values include: 'AllowedValuesPolicy', 'MaxValuePolicy'. Changing this forces a new resource to be created.
func (r *Policy) EvaluatorType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["evaluatorType"])
}

// The Fact Data for this Policy.
func (r *Policy) FactData() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["factData"])
}

// Specifies the name of the Dev Test Lab in which the Policy should be created. Changing this forces a new resource to be created.
func (r *Policy) LabName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["labName"])
}

// Specifies the name of the Dev Test Policy. Possible values are `GalleryImage`, `LabPremiumVmCount`, `LabTargetCost`, `LabVmCount`, `LabVmSize`, `UserOwnedLabPremiumVmCount`, `UserOwnedLabVmCount` and `UserOwnedLabVmCountInSubnet`. Changing this forces a new resource to be created.
func (r *Policy) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the name of the Policy Set within the Dev Test Lab where this policy should be created. Changing this forces a new resource to be created.
func (r *Policy) PolicySetName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["policySetName"])
}

// The name of the resource group in which the Dev Test Lab resource exists. Changing this forces a new resource to be created.
func (r *Policy) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A mapping of tags to assign to the resource.
func (r *Policy) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// The Threshold for this Policy.
func (r *Policy) Threshold() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["threshold"])
}
