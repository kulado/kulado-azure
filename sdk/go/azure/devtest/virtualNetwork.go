...
func (r *VirtualNetwork) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// Specifies the name of the Dev Test Lab in which the Virtual Network should be created. Changing this forces a new resource to be created.
func (r *VirtualNetwork) LabName() *kulado.StringOutput {
...
func (r *VirtualNetwork) Subnet() *kulado.Output {
...
func (r *VirtualNetwork) UniqueIdentifier() *kulado.StringOutput {
