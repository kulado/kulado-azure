...
func NewWindowsVirtualMachine(ctx *kulado.Context,
	name string, args *WindowsVirtualMachineArgs, opts ...kulado.ResourceOpt) (*WindowsVirtualMachine, error) {
...
func GetWindowsVirtualMachine(ctx *kulado.Context,
	name string, id kulado.ID, state *WindowsVirtualMachineState, opts ...kulado.ResourceOpt) (*WindowsVirtualMachine, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *WindowsVirtualMachine) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *WindowsVirtualMachine) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Can this Virtual Machine be claimed by users? Defaults to `true`.
func (r *WindowsVirtualMachine) AllowClaim() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["allowClaim"])
}

// Should the Virtual Machine be created without a Public IP Address? Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) DisallowPublicIpAddress() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["disallowPublicIpAddress"])
}

// The FQDN of the Virtual Machine.
func (r *WindowsVirtualMachine) Fqdn() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["fqdn"])
}

// A `gallery_image_reference` block as defined below.
func (r *WindowsVirtualMachine) GalleryImageReference() *kulado.Output {
	return r.s.State["galleryImageReference"]
}

// One or more `inbound_nat_rule` blocks as defined below. Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) InboundNatRules() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["inboundNatRules"])
}

// Specifies the name of the Dev Test Lab in which the Virtual Machine should be created. Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) LabName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["labName"])
}

// The name of a Subnet within the Dev Test Virtual Network where this machine should exist. Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) LabSubnetName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["labSubnetName"])
}

// The ID of the Dev Test Virtual Network where this Virtual Machine should be created. Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) LabVirtualNetworkId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["labVirtualNetworkId"])
}

// Specifies the supported Azure location where the Dev Test Lab exists. Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the Dev Test Machine. Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Any notes about the Virtual Machine.
func (r *WindowsVirtualMachine) Notes() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["notes"])
}

// The Password associated with the `username` used to login to this Virtual Machine. Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) Password() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["password"])
}

// The name of the resource group in which the Dev Test Lab resource exists. Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The Machine Size to use for this Virtual Machine, such as `Standard_F2`. Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) Size() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["size"])
}

// The type of Storage to use on this Virtual Machine. Possible values are `Standard` and `Premium`.
func (r *WindowsVirtualMachine) StorageType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["storageType"])
}

// A mapping of tags to assign to the resource.
func (r *WindowsVirtualMachine) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// The unique immutable identifier of the Virtual Machine.
func (r *WindowsVirtualMachine) UniqueIdentifier() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["uniqueIdentifier"])
}

// The Username associated with the local administrator on this Virtual Machine. Changing this forces a new resource to be created.
func (r *WindowsVirtualMachine) Username() *kulado.StringOutput {
