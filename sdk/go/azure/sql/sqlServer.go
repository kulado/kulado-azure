...
func NewSqlServer(ctx *kulado.Context,
	name string, args *SqlServerArgs, opts ...kulado.ResourceOpt) (*SqlServer, error) {
...
func GetSqlServer(ctx *kulado.Context,
	name string, id kulado.ID, state *SqlServerState, opts ...kulado.ResourceOpt) (*SqlServer, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *SqlServer) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *SqlServer) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The administrator login name for the new server. Changing this forces a new resource to be created.
func (r *SqlServer) AdministratorLogin() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["administratorLogin"])
}

// The password associated with the `administrator_login` user. Needs to comply with Azure's [Password Policy](https://msdn.microsoft.com/library/ms161959.aspx)
func (r *SqlServer) AdministratorLoginPassword() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["administratorLoginPassword"])
}

// The fully qualified domain name of the Azure SQL Server (e.g. myServerName.database.windows.net)
func (r *SqlServer) FullyQualifiedDomainName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["fullyQualifiedDomainName"])
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *SqlServer) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the SQL Server. This needs to be globally unique within Azure.
func (r *SqlServer) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the resource group in which to create the SQL Server.
func (r *SqlServer) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A mapping of tags to assign to the resource.
func (r *SqlServer) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// The version for the new server. Valid values are: 2.0 (for v11 server) and 12.0 (for v12 server).
func (r *SqlServer) Version() *kulado.StringOutput {
