...
func NewElasticPool(ctx *kulado.Context,
	name string, args *ElasticPoolArgs, opts ...kulado.ResourceOpt) (*ElasticPool, error) {
...
func GetElasticPool(ctx *kulado.Context,
	name string, id kulado.ID, state *ElasticPoolState, opts ...kulado.ResourceOpt) (*ElasticPool, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ElasticPool) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ElasticPool) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The creation date of the SQL Elastic Pool.
func (r *ElasticPool) CreationDate() *kulado.StringOutput {
...
func (r *ElasticPool) DbDtuMax() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["dbDtuMax"])
}

// The minimum DTU which will be guaranteed to all databases in the elastic pool to be created.
func (r *ElasticPool) DbDtuMin() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["dbDtuMin"])
}
...
func (r *ElasticPool) Dtu() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["dtu"])
}
...
func (r *ElasticPool) Edition() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["edition"])
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *ElasticPool) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the elastic pool. This needs to be globally unique. Changing this forces a new resource to be created.
func (r *ElasticPool) Name() *kulado.StringOutput {
...
func (r *ElasticPool) PoolSize() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["poolSize"])
}

// The name of the resource group in which to create the elastic pool. This must be the same as the resource group of the underlying SQL server.
func (r *ElasticPool) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The name of the SQL Server on which to create the elastic pool. Changing this forces a new resource to be created.
func (r *ElasticPool) ServerName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["serverName"])
}

// A mapping of tags to assign to the resource.
func (r *ElasticPool) Tags() *kulado.MapOutput {
