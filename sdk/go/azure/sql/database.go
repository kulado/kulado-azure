...
func (r *Database) CreateMode() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["createMode"])
}

// The creation date of the SQL Database.
func (r *Database) CreationDate() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["creationDate"])
}

// The default secondary location of the SQL Database.
func (r *Database) DefaultSecondaryLocation() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["defaultSecondaryLocation"])
}
...
func (r *Database) Edition() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["edition"])
}

// The name of the elastic database pool.
func (r *Database) ElasticPoolName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["elasticPoolName"])
}

func (r *Database) Encryption() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["encryption"])
}

// A Database Import block as documented below. `create_mode` must be set to `Default`.
func (r *Database) Import() *kulado.Output {
	return r.s.State["import"]
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *Database) Location() *kulado.StringOutput {
...
func (r *Database) MaxSizeBytes() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["maxSizeBytes"])
}
...
func (r *Database) ReadScale() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["readScale"])
}
...
func (r *Database) RequestedServiceObjectiveId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["requestedServiceObjectiveId"])
}
...
func (r *Database) RequestedServiceObjectiveName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["requestedServiceObjectiveName"])
}
...
func (r *Database) RestorePointInTime() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["restorePointInTime"])
}
...
func (r *Database) SourceDatabaseDeletionDate() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sourceDatabaseDeletionDate"])
}

// The URI of the source database if `create_mode` value is not `Default`.
func (r *Database) SourceDatabaseId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sourceDatabaseId"])
}

// A mapping of tags to assign to the resource.
func (r *Database) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// Threat detection policy configuration. The `threat_detection_policy` block supports fields documented below.
func (r *Database) ThreatDetectionPolicy() *kulado.Output {
