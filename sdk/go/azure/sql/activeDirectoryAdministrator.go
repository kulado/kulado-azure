...
func NewActiveDirectoryAdministrator(ctx *kulado.Context,
	name string, args *ActiveDirectoryAdministratorArgs, opts ...kulado.ResourceOpt) (*ActiveDirectoryAdministrator, error) {
...
func GetActiveDirectoryAdministrator(ctx *kulado.Context,
	name string, id kulado.ID, state *ActiveDirectoryAdministratorState, opts ...kulado.ResourceOpt) (*ActiveDirectoryAdministrator, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ActiveDirectoryAdministrator) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ActiveDirectoryAdministrator) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The login name of the principal to set as the server administrator
func (r *ActiveDirectoryAdministrator) Login() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["login"])
}

// The ID of the principal to set as the server administrator
func (r *ActiveDirectoryAdministrator) ObjectId() *kulado.StringOutput {
...
func (r *ActiveDirectoryAdministrator) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The name of the SQL Server on which to set the administrator. Changing this forces a new resource to be created.
func (r *ActiveDirectoryAdministrator) ServerName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["serverName"])
}

// The Azure Tenant ID
func (r *ActiveDirectoryAdministrator) TenantId() *kulado.StringOutput {
