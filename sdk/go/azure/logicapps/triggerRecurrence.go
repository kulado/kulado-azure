...
func NewTriggerRecurrence(ctx *kulado.Context,
	name string, args *TriggerRecurrenceArgs, opts ...kulado.ResourceOpt) (*TriggerRecurrence, error) {
...
func GetTriggerRecurrence(ctx *kulado.Context,
	name string, id kulado.ID, state *TriggerRecurrenceState, opts ...kulado.ResourceOpt) (*TriggerRecurrence, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *TriggerRecurrence) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *TriggerRecurrence) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the Frequency at which this Trigger should be run. Possible values include `Month`, `Week`, `Day`, `Hour`, `Minute` and `Second`.
func (r *TriggerRecurrence) Frequency() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["frequency"])
}

// Specifies interval used for the Frequency, for example a value of `4` for `interval` and `hour` for `frequency` would run the Trigger every 4 hours.
func (r *TriggerRecurrence) Interval() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["interval"])
}

// Specifies the ID of the Logic App Workflow. Changing this forces a new resource to be created.
func (r *TriggerRecurrence) LogicAppId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["logicAppId"])
}

// Specifies the name of the Recurrence Triggers to be created within the Logic App Workflow. Changing this forces a new resource to be created.
func (r *TriggerRecurrence) Name() *kulado.StringOutput {
