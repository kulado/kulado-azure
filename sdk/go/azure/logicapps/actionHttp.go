...
func NewActionHttp(ctx *kulado.Context,
	name string, args *ActionHttpArgs, opts ...kulado.ResourceOpt) (*ActionHttp, error) {
...
func GetActionHttp(ctx *kulado.Context,
	name string, id kulado.ID, state *ActionHttpState, opts ...kulado.ResourceOpt) (*ActionHttp, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ActionHttp) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ActionHttp) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the HTTP Body that should be sent to the `uri` when this HTTP Action is triggered.
func (r *ActionHttp) Body() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["body"])
}

// Specifies a Map of Key-Value Pairs that should be sent to the `uri` when this HTTP Action is triggered.
func (r *ActionHttp) Headers() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["headers"])
}

// Specifies the ID of the Logic App Workflow. Changing this forces a new resource to be created.
func (r *ActionHttp) LogicAppId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["logicAppId"])
}

// Specifies the HTTP Method which should be used for this HTTP Action. Possible values include `DELETE`, `GET`, `PATCH`, `POST` and `PUT`.
func (r *ActionHttp) Method() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["method"])
}

// Specifies the name of the HTTP Action to be created within the Logic App Workflow. Changing this forces a new resource to be created.
func (r *ActionHttp) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the URI which will be called when this HTTP Action is triggered.
func (r *ActionHttp) Uri() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["uri"])
}
