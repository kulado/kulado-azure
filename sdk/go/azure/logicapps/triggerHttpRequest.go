...
func NewTriggerHttpRequest(ctx *kulado.Context,
	name string, args *TriggerHttpRequestArgs, opts ...kulado.ResourceOpt) (*TriggerHttpRequest, error) {
...
func GetTriggerHttpRequest(ctx *kulado.Context,
	name string, id kulado.ID, state *TriggerHttpRequestState, opts ...kulado.ResourceOpt) (*TriggerHttpRequest, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *TriggerHttpRequest) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *TriggerHttpRequest) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the ID of the Logic App Workflow. Changing this forces a new resource to be created.
func (r *TriggerHttpRequest) LogicAppId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["logicAppId"])
}

// Specifies the HTTP Method which the request be using. Possible values include `DELETE`, `GET`, `PATCH`, `POST` or `PUT`.
func (r *TriggerHttpRequest) Method() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["method"])
}

// Specifies the name of the HTTP Request Trigger to be created within the Logic App Workflow. Changing this forces a new resource to be created.
func (r *TriggerHttpRequest) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the Relative Path used for this Request.
func (r *TriggerHttpRequest) RelativePath() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["relativePath"])
}

// A JSON Blob defining the Schema of the incoming request. This needs to be valid JSON.
func (r *TriggerHttpRequest) Schema() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["schema"])
}
