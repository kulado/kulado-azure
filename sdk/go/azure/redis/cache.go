...
func NewCache(ctx *kulado.Context,
	name string, args *CacheArgs, opts ...kulado.ResourceOpt) (*Cache, error) {
...
func GetCache(ctx *kulado.Context,
	name string, id kulado.ID, state *CacheState, opts ...kulado.ResourceOpt) (*Cache, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Cache) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Cache) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The size of the Redis cache to deploy. Valid values for a SKU `family` of C (Basic/Standard) are `0, 1, 2, 3, 4, 5, 6`, and for P (Premium) `family` are `1, 2, 3, 4`.
func (r *Cache) Capacity() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["capacity"])
}

// Enable the non-SSL port (6789) - disabled by default.
func (r *Cache) EnableNonSslPort() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableNonSslPort"])
}

// The SKU family/pricing group to use. Valid values are `C` (for Basic/Standard SKU family) and `P` (for `Premium`)
func (r *Cache) Family() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["family"])
}

// The Hostname of the Redis Instance
func (r *Cache) Hostname() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["hostname"])
}

// The location of the resource group.
func (r *Cache) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The minimum TLS version.  Defaults to `1.0`.
func (r *Cache) MinimumTlsVersion() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["minimumTlsVersion"])
}

// The name of the Redis instance. Changing this forces a
// new resource to be created.
func (r *Cache) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A list of `patch_schedule` blocks as defined below - only available for Premium SKU's.
func (r *Cache) PatchSchedules() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["patchSchedules"])
}

// The non-SSL Port of the Redis Instance
func (r *Cache) Port() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["port"])
}

// The Primary Access Key for the Redis Instance
func (r *Cache) PrimaryAccessKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryAccessKey"])
}

// The Static IP Address to assign to the Redis Cache when hosted inside the Virtual Network. Changing this forces a new resource to be created.
func (r *Cache) PrivateStaticIpAddress() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["privateStaticIpAddress"])
}

// A `redis_configuration` as defined below - with some limitations by SKU - defaults/details are shown below.
func (r *Cache) RedisConfiguration() *kulado.Output {
	return r.s.State["redisConfiguration"]
}

// The name of the resource group in which to
// create the Redis instance.
func (r *Cache) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The Secondary Access Key for the Redis Instance
func (r *Cache) SecondaryAccessKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryAccessKey"])
}

// *Only available when using the Premium SKU* The number of Shards to create on the Redis Cluster.
func (r *Cache) ShardCount() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["shardCount"])
}

// The SKU of Redis to use. Possible values are `Basic`, `Standard` and `Premium`.
func (r *Cache) SkuName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["skuName"])
}

// The SSL Port of the Redis Instance
func (r *Cache) SslPort() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["sslPort"])
}

// The ID of the Subnet within which the Redis Cache should be deployed. Changing this forces a new resource to be created.
func (r *Cache) SubnetId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["subnetId"])
}

// A mapping of tags to assign to the resource.
func (r *Cache) Tags() *kulado.MapOutput {
...
func (r *Cache) Zones() *kulado.StringOutput {
