...
func NewARecord(ctx *kulado.Context,
	name string, args *ARecordArgs, opts ...kulado.ResourceOpt) (*ARecord, error) {
...
func GetARecord(ctx *kulado.Context,
	name string, id kulado.ID, state *ARecordState, opts ...kulado.ResourceOpt) (*ARecord, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ARecord) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ARecord) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the DNS A Record.
func (r *ARecord) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// List of IPv4 Addresses.
func (r *ARecord) Records() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["records"])
}

// Specifies the resource group where the resource exists. Changing this forces a new resource to be created.
func (r *ARecord) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A mapping of tags to assign to the resource.
func (r *ARecord) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

func (r *ARecord) Ttl() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["ttl"])
}

// Specifies the DNS Zone where the resource exists. Changing this forces a new resource to be created.
func (r *ARecord) ZoneName() *kulado.StringOutput {
