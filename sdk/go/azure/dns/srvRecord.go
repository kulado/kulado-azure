...
func NewSrvRecord(ctx *kulado.Context,
	name string, args *SrvRecordArgs, opts ...kulado.ResourceOpt) (*SrvRecord, error) {
...
func GetSrvRecord(ctx *kulado.Context,
	name string, id kulado.ID, state *SrvRecordState, opts ...kulado.ResourceOpt) (*SrvRecord, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *SrvRecord) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *SrvRecord) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the DNS SRV Record.
func (r *SrvRecord) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A list of values that make up the SRV record. Each `record` block supports fields documented below.
func (r *SrvRecord) Records() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["records"])
}

// Specifies the resource group where the resource exists. Changing this forces a new resource to be created.
func (r *SrvRecord) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A mapping of tags to assign to the resource.
func (r *SrvRecord) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// The Time To Live (TTL) of the DNS record in seconds.
func (r *SrvRecord) Ttl() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["ttl"])
}

// Specifies the DNS Zone where the resource exists. Changing this forces a new resource to be created.
func (r *SrvRecord) ZoneName() *kulado.StringOutput {
