...
func NewTemplateDeployment(ctx *kulado.Context,
	name string, args *TemplateDeploymentArgs, opts ...kulado.ResourceOpt) (*TemplateDeployment, error) {
...
func GetTemplateDeployment(ctx *kulado.Context,
	name string, id kulado.ID, state *TemplateDeploymentState, opts ...kulado.ResourceOpt) (*TemplateDeployment, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *TemplateDeployment) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *TemplateDeployment) ID() *kulado.IDOutput {
	return r.s.ID()
}

func (r *TemplateDeployment) DeploymentMode() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["deploymentMode"])
}

// Specifies the name of the template deployment. Changing this forces a
// new resource to be created.
func (r *TemplateDeployment) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A map of supported scalar output types returned from the deployment (currently, Azure Template Deployment outputs of type String, Int and Bool are supported, and are converted to strings - others will be ignored) and can be accessed using `.outputs["name"]`.
func (r *TemplateDeployment) Outputs() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["outputs"])
}

// Specifies the name and value pairs that define the deployment parameters for the template.
func (r *TemplateDeployment) Parameters() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["parameters"])
}

// Specifies a valid Azure JSON parameters file that define the deployment parameters. It can contain KeyVault references
func (r *TemplateDeployment) ParametersBody() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["parametersBody"])
}

// The name of the resource group in which to
// create the template deployment.
func (r *TemplateDeployment) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// Specifies the JSON definition for the template.
func (r *TemplateDeployment) TemplateBody() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["templateBody"])
}
