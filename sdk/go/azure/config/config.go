...
import (
	...
	"github.com/kulado/kulado/sdk/go/kulado/config"
)

func GetClientCertificatePassword(ctx *kulado.Context) string {
...
func GetClientCertificatePath(ctx *kulado.Context) string {
...
func GetClientId(ctx *kulado.Context) string {
...
func GetClientSecret(ctx *kulado.Context) string {
...
func GetEnvironment(ctx *kulado.Context) string {
...
func GetMsiEndpoint(ctx *kulado.Context) string {
...
func GetPartnerId(ctx *kulado.Context) string {
...
func GetSkipCredentialsValidation(ctx *kulado.Context) bool {
...
func GetSkipProviderRegistration(ctx *kulado.Context) bool {
...
func GetSubscriptionId(ctx *kulado.Context) string {
...
func GetTenantId(ctx *kulado.Context) string {
...
func GetUseMsi(ctx *kulado.Context) bool {
...
func GetLocation(ctx *kulado.Context) string {
