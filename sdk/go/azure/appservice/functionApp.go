...
func NewFunctionApp(ctx *kulado.Context,
	name string, args *FunctionAppArgs, opts ...kulado.ResourceOpt) (*FunctionApp, error) {
...
func GetFunctionApp(ctx *kulado.Context,
	name string, id kulado.ID, state *FunctionAppState, opts ...kulado.ResourceOpt) (*FunctionApp, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *FunctionApp) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *FunctionApp) ID() *kulado.IDOutput {
	return r.s.ID()
}
...
func (r *FunctionApp) AppServicePlanId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["appServicePlanId"])
}

// A key-value pair of App Settings.
func (r *FunctionApp) AppSettings() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["appSettings"])
}

// Should the Function App send session affinity cookies, which route client requests in the same session to the same instance?
func (r *FunctionApp) ClientAffinityEnabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["clientAffinityEnabled"])
}

// An `connection_string` block as defined below.
func (r *FunctionApp) ConnectionStrings() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["connectionStrings"])
}

// The default hostname associated with the Function App - such as `mysite.azurewebsites.net`
func (r *FunctionApp) DefaultHostname() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["defaultHostname"])
}

// Should the built-in logging of this Function App be enabled? Defaults to `true`.
func (r *FunctionApp) EnableBuiltinLogging() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableBuiltinLogging"])
}

// Is the Function App enabled?
func (r *FunctionApp) Enabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enabled"])
}

// Can the Function App only be accessed via HTTPS? Defaults to `false`.
func (r *FunctionApp) HttpsOnly() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["httpsOnly"])
}

// An `identity` block as defined below.
func (r *FunctionApp) Identity() *kulado.Output {
	return r.s.State["identity"]
}

// The Function App kind - such as `functionapp,linux,container`
func (r *FunctionApp) Kind() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["kind"])
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *FunctionApp) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the Connection String.
func (r *FunctionApp) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A comma separated list of outbound IP addresses - such as `52.23.25.3,52.143.43.12`
func (r *FunctionApp) OutboundIpAddresses() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["outboundIpAddresses"])
}

// A comma separated list of outbound IP addresses - such as `52.23.25.3,52.143.43.12,52.143.43.17` - not all of which are necessarily in use. Superset of `outbound_ip_addresses`.
func (r *FunctionApp) PossibleOutboundIpAddresses() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["possibleOutboundIpAddresses"])
}

// The name of the resource group in which to create the Function App.
func (r *FunctionApp) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `site_config` object as defined below.
func (r *FunctionApp) SiteConfig() *kulado.Output {
	return r.s.State["siteConfig"]
}

// A `site_credential` block as defined below, which contains the site-level credentials used to publish to this App Service.
func (r *FunctionApp) SiteCredential() *kulado.Output {
...
func (r *FunctionApp) StorageConnectionString() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["storageConnectionString"])
}

// A mapping of tags to assign to the resource.
func (r *FunctionApp) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// The runtime version associated with the Function App. Defaults to `~1`.
func (r *FunctionApp) Version() *kulado.StringOutput {
