...
func NewAppService(ctx *kulado.Context,
	name string, args *AppServiceArgs, opts ...kulado.ResourceOpt) (*AppService, error) {
...
func GetAppService(ctx *kulado.Context,
	name string, id kulado.ID, state *AppServiceState, opts ...kulado.ResourceOpt) (*AppService, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *AppService) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *AppService) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The ID of the App Service Plan within which to create this App Service.
func (r *AppService) AppServicePlanId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["appServicePlanId"])
}

// A key-value pair of App Settings.
func (r *AppService) AppSettings() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["appSettings"])
}

// A `auth_settings` block as defined below.
func (r *AppService) AuthSettings() *kulado.Output {
	return r.s.State["authSettings"]
}

// Should the App Service send session affinity cookies, which route client requests in the same session to the same instance?
func (r *AppService) ClientAffinityEnabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["clientAffinityEnabled"])
}

// Does the App Service require client certificates for incoming requests? Defaults to `false`.
func (r *AppService) ClientCertEnabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["clientCertEnabled"])
}

// One or more `connection_string` blocks as defined below.
func (r *AppService) ConnectionStrings() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["connectionStrings"])
}

// The Default Hostname associated with the App Service - such as `mysite.azurewebsites.net`
func (r *AppService) DefaultSiteHostname() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["defaultSiteHostname"])
}

// Is the App Service Enabled?
func (r *AppService) Enabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enabled"])
}

// Can the App Service only be accessed via HTTPS? Defaults to `false`.
func (r *AppService) HttpsOnly() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["httpsOnly"])
}

// A Managed Service Identity block as defined below.
func (r *AppService) Identity() *kulado.Output {
	return r.s.State["identity"]
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *AppService) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// A `logs` block as defined below.
func (r *AppService) Logs() *kulado.Output {
	return r.s.State["logs"]
}

// Specifies the name of the App Service. Changing this forces a new resource to be created.
func (r *AppService) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A comma separated list of outbound IP addresses - such as `52.23.25.3,52.143.43.12`
func (r *AppService) OutboundIpAddresses() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["outboundIpAddresses"])
}

// A comma separated list of outbound IP addresses - such as `52.23.25.3,52.143.43.12,52.143.43.17` - not all of which are necessarily in use. Superset of `outbound_ip_addresses`.
func (r *AppService) PossibleOutboundIpAddresses() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["possibleOutboundIpAddresses"])
}

// The name of the resource group in which to create the App Service.
func (r *AppService) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `site_config` block as defined below.
func (r *AppService) SiteConfig() *kulado.Output {
	return r.s.State["siteConfig"]
}

// A `site_credential` block as defined below, which contains the site-level credentials used to publish to this App Service.
func (r *AppService) SiteCredential() *kulado.Output {
...
func (r *AppService) SourceControl() *kulado.Output {
	return r.s.State["sourceControl"]
}

// A mapping of tags to assign to the resource.
func (r *AppService) Tags() *kulado.MapOutput {
