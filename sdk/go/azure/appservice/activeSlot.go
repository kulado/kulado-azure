...
func NewActiveSlot(ctx *kulado.Context,
	name string, args *ActiveSlotArgs, opts ...kulado.ResourceOpt) (*ActiveSlot, error) {
...
func GetActiveSlot(ctx *kulado.Context,
	name string, id kulado.ID, state *ActiveSlotState, opts ...kulado.ResourceOpt) (*ActiveSlot, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ActiveSlot) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ActiveSlot) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the App Service within which the Slot exists.  Changing this forces a new resource to be created.
func (r *ActiveSlot) AppServiceName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["appServiceName"])
}

// The name of the App Service Slot which should be promoted to the Production Slot within the App Service.
func (r *ActiveSlot) AppServiceSlotName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["appServiceSlotName"])
}

// The name of the resource group in which the App Service exists. Changing this forces a new resource to be created.
func (r *ActiveSlot) ResourceGroupName() *kulado.StringOutput {
