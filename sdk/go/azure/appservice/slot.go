...
func NewSlot(ctx *kulado.Context,
	name string, args *SlotArgs, opts ...kulado.ResourceOpt) (*Slot, error) {
...
func GetSlot(ctx *kulado.Context,
	name string, id kulado.ID, state *SlotState, opts ...kulado.ResourceOpt) (*Slot, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Slot) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Slot) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the App Service within which to create the App Service Slot.  Changing this forces a new resource to be created.
func (r *Slot) AppServiceName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["appServiceName"])
}

// The ID of the App Service Plan within which to create this App Service Slot. Changing this forces a new resource to be created.
func (r *Slot) AppServicePlanId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["appServicePlanId"])
}

// A key-value pair of App Settings.
func (r *Slot) AppSettings() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["appSettings"])
}

// Should the App Service Slot send session affinity cookies, which route client requests in the same session to the same instance?
func (r *Slot) ClientAffinityEnabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["clientAffinityEnabled"])
}

// An `connection_string` block as defined below.
func (r *Slot) ConnectionStrings() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["connectionStrings"])
}

// The Default Hostname associated with the App Service Slot - such as `mysite.azurewebsites.net`
func (r *Slot) DefaultSiteHostname() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["defaultSiteHostname"])
}

// Is the App Service Slot Enabled?
func (r *Slot) Enabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enabled"])
}

// Can the App Service Slot only be accessed via HTTPS? Defaults to `false`.
func (r *Slot) HttpsOnly() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["httpsOnly"])
}

// A Managed Service Identity block as defined below.
func (r *Slot) Identity() *kulado.Output {
	return r.s.State["identity"]
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *Slot) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The name of the Connection String.
func (r *Slot) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the resource group in which to create the App Service Slot component.
func (r *Slot) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A `site_config` object as defined below.
func (r *Slot) SiteConfig() *kulado.Output {
	return r.s.State["siteConfig"]
}

// A `site_credential` block as defined below, which contains the site-level credentials used to publish to this App Service.
func (r *Slot) SiteCredential() *kulado.Output {
	return r.s.State["siteCredential"]
}

// A mapping of tags to assign to the resource.
func (r *Slot) Tags() *kulado.MapOutput {
