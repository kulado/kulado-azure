...
func NewCustomHostnameBinding(ctx *kulado.Context,
	name string, args *CustomHostnameBindingArgs, opts ...kulado.ResourceOpt) (*CustomHostnameBinding, error) {
...
func GetCustomHostnameBinding(ctx *kulado.Context,
	name string, id kulado.ID, state *CustomHostnameBindingState, opts ...kulado.ResourceOpt) (*CustomHostnameBinding, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *CustomHostnameBinding) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *CustomHostnameBinding) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the App Service in which to add the Custom Hostname Binding. Changing this forces a new resource to be created.
func (r *CustomHostnameBinding) AppServiceName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["appServiceName"])
}

// Specifies the Custom Hostname to use for the App Service, example `www.example.com`. Changing this forces a new resource to be created.
func (r *CustomHostnameBinding) Hostname() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["hostname"])
}

// The name of the resource group in which the App Service exists. Changing this forces a new resource to be created.
func (r *CustomHostnameBinding) ResourceGroupName() *kulado.StringOutput {
