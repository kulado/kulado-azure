...
func NewAlertRule(ctx *kulado.Context,
	name string, args *AlertRuleArgs, opts ...kulado.ResourceOpt) (*AlertRule, error) {
...
func GetAlertRule(ctx *kulado.Context,
	name string, id kulado.ID, state *AlertRuleState, opts ...kulado.ResourceOpt) (*AlertRule, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *AlertRule) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *AlertRule) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Defines how the metric data is combined over time. Possible values are `Average`, `Minimum`, `Maximum`, `Total`, and `Last`.
func (r *AlertRule) Aggregation() *kulado.StringOutput {
...
func (r *AlertRule) Name() *kulado.StringOutput {
...
func (r *AlertRule) Operator() *kulado.StringOutput {
...
func (r *AlertRule) Period() *kulado.StringOutput {
