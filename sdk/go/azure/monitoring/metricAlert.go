...
func NewMetricAlert(ctx *kulado.Context,
	name string, args *MetricAlertArgs, opts ...kulado.ResourceOpt) (*MetricAlert, error) {
...
func GetMetricAlert(ctx *kulado.Context,
	name string, id kulado.ID, state *MetricAlertState, opts ...kulado.ResourceOpt) (*MetricAlert, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *MetricAlert) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *MetricAlert) ID() *kulado.IDOutput {
	return r.s.ID()
}

// One or more `action` blocks as defined below.
func (r *MetricAlert) Actions() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["actions"])
}

// Should the alerts in this Metric Alert be auto resolved? Defaults to `false`.
func (r *MetricAlert) AutoMitigate() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["autoMitigate"])
}

// One or more `criteria` blocks as defined below.
func (r *MetricAlert) Criterias() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["criterias"])
}

// The description of this Metric Alert.
func (r *MetricAlert) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// Should this Metric Alert be enabled? Defaults to `true`.
func (r *MetricAlert) Enabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enabled"])
}

// The evaluation frequency of this Metric Alert, represented in ISO 8601 duration format. Possible values are `PT1M`, `PT5M`, `PT15M`, `PT30M` and `PT1H`. Defaults to `PT1M`.
func (r *MetricAlert) Frequency() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["frequency"])
}

// The name of the Metric Alert. Changing this forces a new resource to be created.
func (r *MetricAlert) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the resource group in which to create the Metric Alert instance.
func (r *MetricAlert) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The resource ID at which the metric criteria should be applied.
func (r *MetricAlert) Scopes() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["scopes"])
}

// The severity of this Metric Alert. Possible values are `0`, `1`, `2`, `3` and `4`. Defaults to `3`.
func (r *MetricAlert) Severity() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["severity"])
}

// A mapping of tags to assign to the resource.
func (r *MetricAlert) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// The period of time that is used to monitor alert activity, represented in ISO 8601 duration format. This value must be greater than `frequency`. Possible values are `PT1M`, `PT5M`, `PT15M`, `PT30M`, `PT1H`, `PT6H`, `PT12H` and `P1D`. Defaults to `PT5M`.
func (r *MetricAlert) WindowSize() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["windowSize"])
}
