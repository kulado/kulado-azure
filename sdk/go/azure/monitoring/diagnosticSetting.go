...
func NewDiagnosticSetting(ctx *kulado.Context,
	name string, args *DiagnosticSettingArgs, opts ...kulado.ResourceOpt) (*DiagnosticSetting, error) {
...
func GetDiagnosticSetting(ctx *kulado.Context,
	name string, id kulado.ID, state *DiagnosticSettingState, opts ...kulado.ResourceOpt) (*DiagnosticSetting, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *DiagnosticSetting) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *DiagnosticSetting) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the ID of an Event Hub Namespace Authorization Rule used to send Diagnostics Data. Changing this forces a new resource to be created.
func (r *DiagnosticSetting) EventhubAuthorizationRuleId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["eventhubAuthorizationRuleId"])
}
...
func (r *DiagnosticSetting) EventhubName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["eventhubName"])
}

// One or more `log` blocks as defined below.
func (r *DiagnosticSetting) Logs() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["logs"])
}
...
func (r *DiagnosticSetting) LogAnalyticsWorkspaceId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["logAnalyticsWorkspaceId"])
}

// One or more `metric` blocks as defined below.
func (r *DiagnosticSetting) Metrics() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["metrics"])
}

// Specifies the name of the Diagnostic Setting. Changing this forces a new resource to be created.
func (r *DiagnosticSetting) Name() *kulado.StringOutput {
...
func (r *DiagnosticSetting) StorageAccountId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["storageAccountId"])
}

// The ID of an existing Resource on which to configure Diagnostic Settings. Changing this forces a new resource to be created.
func (r *DiagnosticSetting) TargetResourceId() *kulado.StringOutput {
