...
func NewSnapshot(ctx *kulado.Context,
	name string, args *SnapshotArgs, opts ...kulado.ResourceOpt) (*Snapshot, error) {
...
func GetSnapshot(ctx *kulado.Context,
	name string, id kulado.ID, state *SnapshotState, opts ...kulado.ResourceOpt) (*Snapshot, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Snapshot) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Snapshot) ID() *kulado.IDOutput {
	return r.s.ID()
}
