...
func NewManagedDisk(ctx *kulado.Context,
	name string, args *ManagedDiskArgs, opts ...kulado.ResourceOpt) (*ManagedDisk, error) {
...
func GetManagedDisk(ctx *kulado.Context,
	name string, id kulado.ID, state *ManagedDiskState, opts ...kulado.ResourceOpt) (*ManagedDisk, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ManagedDisk) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ManagedDisk) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The method to use when creating the managed disk. Possible values include:
func (r *ManagedDisk) CreateOption() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["createOption"])
}
...
func (r *ManagedDisk) DiskSizeGb() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["diskSizeGb"])
}

// an `encryption_settings` block as defined below.
func (r *ManagedDisk) EncryptionSettings() *kulado.Output {
...
func (r *ManagedDisk) ImageReferenceId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["imageReferenceId"])
}

// Specified the supported Azure location where the resource exists.
// Changing this forces a new resource to be created.
func (r *ManagedDisk) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the managed disk. Changing this forces a
// new resource to be created.
func (r *ManagedDisk) Name() *kulado.StringOutput {
...
func (r *ManagedDisk) OsType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["osType"])
}

// The name of the resource group in which to create
// the managed disk.
func (r *ManagedDisk) ResourceGroupName() *kulado.StringOutput {
...
func (r *ManagedDisk) SourceResourceId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sourceResourceId"])
}

// URI to a valid VHD file to be used when `create_option` is `Import`.
func (r *ManagedDisk) SourceUri() *kulado.StringOutput {
...
func (r *ManagedDisk) StorageAccountType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["storageAccountType"])
}

// A mapping of tags to assign to the resource.
func (r *ManagedDisk) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// A collection containing the availability zone to allocate the Managed Disk in.
func (r *ManagedDisk) Zones() *kulado.StringOutput {
