...
func NewDataDiskAttachment(ctx *kulado.Context,
	name string, args *DataDiskAttachmentArgs, opts ...kulado.ResourceOpt) (*DataDiskAttachment, error) {
...
func GetDataDiskAttachment(ctx *kulado.Context,
	name string, id kulado.ID, state *DataDiskAttachmentState, opts ...kulado.ResourceOpt) (*DataDiskAttachment, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *DataDiskAttachment) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *DataDiskAttachment) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the caching requirements for this Data Disk. Possible values include `None`, `ReadOnly` and `ReadWrite`.
func (r *DataDiskAttachment) Caching() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["caching"])
}

// The Create Option of the Data Disk, such as `Empty` or `Attach`. Defaults to `Attach`. Changing this forces a new resource to be created.
func (r *DataDiskAttachment) CreateOption() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["createOption"])
}

// The Logical Unit Number of the Data Disk, which needs to be unique within the Virtual Machine. Changing this forces a new resource to be created.
func (r *DataDiskAttachment) Lun() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["lun"])
}

// The ID of an existing Managed Disk which should be attached. Changing this forces a new resource to be created.
func (r *DataDiskAttachment) ManagedDiskId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["managedDiskId"])
}

// The ID of the Virtual Machine to which the Data Disk should be attached. Changing this forces a new resource to be created.
func (r *DataDiskAttachment) VirtualMachineId() *kulado.StringOutput {
...
func (r *DataDiskAttachment) WriteAcceleratorEnabled() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["writeAcceleratorEnabled"])
}
