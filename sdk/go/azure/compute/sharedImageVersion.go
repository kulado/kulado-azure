...
func NewSharedImageVersion(ctx *kulado.Context,
	name string, args *SharedImageVersionArgs, opts ...kulado.ResourceOpt) (*SharedImageVersion, error) {
...
func GetSharedImageVersion(ctx *kulado.Context,
	name string, id kulado.ID, state *SharedImageVersionState, opts ...kulado.ResourceOpt) (*SharedImageVersion, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *SharedImageVersion) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *SharedImageVersion) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Should this Image Version be excluded from the `latest` filter? If set to `true` this Image Version won't be returned for the `latest` version. Defaults to `false`.
func (r *SharedImageVersion) ExcludeFromLatest() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["excludeFromLatest"])
}

// The name of the Shared Image Gallery in which the Shared Image exists. Changing this forces a new resource to be created.
func (r *SharedImageVersion) GalleryName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["galleryName"])
}

// The name of the Shared Image within the Shared Image Gallery in which this Version should be created. Changing this forces a new resource to be created.
func (r *SharedImageVersion) ImageName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["imageName"])
}

// The Azure Region in which the Shared Image Gallery exists. Changing this forces a new resource to be created.
func (r *SharedImageVersion) Location() *kulado.StringOutput {
...
func (r *SharedImageVersion) ManagedImageId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["managedImageId"])
}

// The version number for this Image Version, such as `1.0.0`. Changing this forces a new resource to be created.
func (r *SharedImageVersion) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the Resource Group in which the Shared Image Gallery exists. Changing this forces a new resource to be created.
func (r *SharedImageVersion) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// A collection of tags which should be applied to this resource.
func (r *SharedImageVersion) Tags() *kulado.MapOutput {
	return (*kulado.MapOutput)(r.s.State["tags"])
}

// One or more `target_region` blocks as documented below.
func (r *SharedImageVersion) TargetRegions() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["targetRegions"])
}
