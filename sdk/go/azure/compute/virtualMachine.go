...
func NewVirtualMachine(ctx *kulado.Context,
	name string, args *VirtualMachineArgs, opts ...kulado.ResourceOpt) (*VirtualMachine, error) {
...
func GetVirtualMachine(ctx *kulado.Context,
	name string, id kulado.ID, state *VirtualMachineState, opts ...kulado.ResourceOpt) (*VirtualMachine, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *VirtualMachine) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *VirtualMachine) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The ID of the Availability Set in which the Virtual Machine should exist. Changing this forces a new resource to be created.
func (r *VirtualMachine) AvailabilitySetId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["availabilitySetId"])
}

// A `boot_diagnostics` block.
func (r *VirtualMachine) BootDiagnostics() *kulado.Output {
	return r.s.State["bootDiagnostics"]
}

// Should the Data Disks (either the Managed Disks / VHD Blobs) be deleted when the Virtual Machine is destroyed? Defaults to `false`.
func (r *VirtualMachine) DeleteDataDisksOnTermination() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["deleteDataDisksOnTermination"])
}

// Should the OS Disk (either the Managed Disk / VHD Blob) be deleted when the Virtual Machine is destroyed? Defaults to `false`.
func (r *VirtualMachine) DeleteOsDiskOnTermination() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["deleteOsDiskOnTermination"])
}

// A `identity` block.
func (r *VirtualMachine) Identity() *kulado.Output {
	return r.s.State["identity"]
}

// Specifies the BYOL Type for this Virtual Machine. This is only applicable to Windows Virtual Machines. Possible values are `Windows_Client` and `Windows_Server`.
func (r *VirtualMachine) LicenseType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["licenseType"])
}

// Specifies the Azure Region where the Virtual Machine exists. Changing this forces a new resource to be created.
func (r *VirtualMachine) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the Virtual Machine. Changing this forces a new resource to be created.
func (r *VirtualMachine) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A list of Network Interface ID's which should be associated with the Virtual Machine.
func (r *VirtualMachine) NetworkInterfaceIds() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["networkInterfaceIds"])
}

// An `os_profile` block. Required when `create_option` in the `storage_os_disk` block is set to `FromImage`.
func (r *VirtualMachine) OsProfile() *kulado.Output {
	return r.s.State["osProfile"]
}

// A `os_profile_linux_config` block.
func (r *VirtualMachine) OsProfileLinuxConfig() *kulado.Output {
	return r.s.State["osProfileLinuxConfig"]
}

// One or more `os_profile_secrets` blocks.
func (r *VirtualMachine) OsProfileSecrets() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["osProfileSecrets"])
}

// A `os_profile_windows_config` block.
func (r *VirtualMachine) OsProfileWindowsConfig() *kulado.Output {
	return r.s.State["osProfileWindowsConfig"]
}

// A `plan` block.
func (r *VirtualMachine) Plan() *kulado.Output {
	return r.s.State["plan"]
}

// The ID of the Network Interface (which must be attached to the Virtual Machine) which should be the Primary Network Interface for this Virtual Machine.
func (r *VirtualMachine) PrimaryNetworkInterfaceId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryNetworkInterfaceId"])
}

// Specifies the name of the Resource Group in which the Virtual Machine should exist. Changing this forces a new resource to be created.
func (r *VirtualMachine) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// One or more `storage_data_disk` blocks.
func (r *VirtualMachine) StorageDataDisks() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["storageDataDisks"])
}

// A `storage_image_reference` block.
func (r *VirtualMachine) StorageImageReference() *kulado.Output {
	return r.s.State["storageImageReference"]
}

// A `storage_os_disk` block.
func (r *VirtualMachine) StorageOsDisk() *kulado.Output {
	return r.s.State["storageOsDisk"]
}

// A mapping of tags to assign to the Virtual Machine.
func (r *VirtualMachine) Tags() *kulado.MapOutput {
...
func (r *VirtualMachine) VmSize() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["vmSize"])
}

// A list of a single item of the Availability Zone which the Virtual Machine should be allocated in.
func (r *VirtualMachine) Zones() *kulado.StringOutput {
