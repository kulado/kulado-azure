...
func NewEventHubConsumerGroup(ctx *kulado.Context,
	name string, args *EventHubConsumerGroupArgs, opts ...kulado.ResourceOpt) (*EventHubConsumerGroup, error) {
...
func GetEventHubConsumerGroup(ctx *kulado.Context,
	name string, id kulado.ID, state *EventHubConsumerGroupState, opts ...kulado.ResourceOpt) (*EventHubConsumerGroup, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *EventHubConsumerGroup) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *EventHubConsumerGroup) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the name of the EventHub. Changing this forces a new resource to be created.
func (r *EventHubConsumerGroup) EventhubName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["eventhubName"])
}

func (r *EventHubConsumerGroup) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the EventHub Consumer Group resource. Changing this forces a new resource to be created.
func (r *EventHubConsumerGroup) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the name of the grandparent EventHub Namespace. Changing this forces a new resource to be created.
func (r *EventHubConsumerGroup) NamespaceName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["namespaceName"])
}

// The name of the resource group in which the EventHub Consumer Group's grandparent Namespace exists. Changing this forces a new resource to be created.
func (r *EventHubConsumerGroup) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// Specifies the user metadata.
func (r *EventHubConsumerGroup) UserMetadata() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["userMetadata"])
}
