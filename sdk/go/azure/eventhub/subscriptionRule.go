...
func NewSubscriptionRule(ctx *kulado.Context,
	name string, args *SubscriptionRuleArgs, opts ...kulado.ResourceOpt) (*SubscriptionRule, error) {
...
func GetSubscriptionRule(ctx *kulado.Context,
	name string, id kulado.ID, state *SubscriptionRuleState, opts ...kulado.ResourceOpt) (*SubscriptionRule, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *SubscriptionRule) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *SubscriptionRule) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Represents set of actions written in SQL language-based syntax that is performed against a BrokeredMessage.
func (r *SubscriptionRule) Action() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["action"])
}

// A `correlation_filter` block as documented below to be evaluated against a BrokeredMessage. Required when `filter_type` is set to `CorrelationFilter`.
func (r *SubscriptionRule) CorrelationFilter() *kulado.Output {
	return r.s.State["correlationFilter"]
}

// Type of filter to be applied to a BrokeredMessage. Possible values are `SqlFilter` and `CorrelationFilter`.
func (r *SubscriptionRule) FilterType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["filterType"])
}

// Specifies the name of the ServiceBus Subscription Rule. Changing this forces a new resource to be created.
func (r *SubscriptionRule) Name() *kulado.StringOutput {
...
func (r *SubscriptionRule) NamespaceName() *kulado.StringOutput {
...
func (r *SubscriptionRule) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// Represents a filter written in SQL language-based syntax that to be evaluated against a BrokeredMessage. Required when `filter_type` is set to `SqlFilter`.
func (r *SubscriptionRule) SqlFilter() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["sqlFilter"])
}
...
func (r *SubscriptionRule) SubscriptionName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["subscriptionName"])
}
...
func (r *SubscriptionRule) TopicName() *kulado.StringOutput {
