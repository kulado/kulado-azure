...
func NewQueueAuthorizationRule(ctx *kulado.Context,
	name string, args *QueueAuthorizationRuleArgs, opts ...kulado.ResourceOpt) (*QueueAuthorizationRule, error) {
...
func GetQueueAuthorizationRule(ctx *kulado.Context,
	name string, id kulado.ID, state *QueueAuthorizationRuleState, opts ...kulado.ResourceOpt) (*QueueAuthorizationRule, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *QueueAuthorizationRule) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *QueueAuthorizationRule) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Does this Authorization Rule have Listen permissions to the ServiceBus Queue? Defaults to `false`.
func (r *QueueAuthorizationRule) Listen() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["listen"])
}

// Does this Authorization Rule have Manage permissions to the ServiceBus Queue? When this property is `true` - both `listen` and `send` must be too. Defaults to `false`.
func (r *QueueAuthorizationRule) Manage() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["manage"])
}

// Specifies the name of the Authorization Rule. Changing this forces a new resource to be created.
func (r *QueueAuthorizationRule) Name() *kulado.StringOutput {
...
func (r *QueueAuthorizationRule) NamespaceName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["namespaceName"])
}

// The Primary Connection String for the Authorization Rule.
func (r *QueueAuthorizationRule) PrimaryConnectionString() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryConnectionString"])
}

// The Primary Key for the Authorization Rule.
func (r *QueueAuthorizationRule) PrimaryKey() *kulado.StringOutput {
...
func (r *QueueAuthorizationRule) QueueName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["queueName"])
}

// The name of the Resource Group in which the ServiceBus Namespace exists. Changing this forces a new resource to be created.
func (r *QueueAuthorizationRule) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The Secondary Connection String for the Authorization Rule.
func (r *QueueAuthorizationRule) SecondaryConnectionString() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryConnectionString"])
}

// The Secondary Key for the Authorization Rule.
func (r *QueueAuthorizationRule) SecondaryKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryKey"])
}

// Does this Authorization Rule have Send permissions to the ServiceBus Queue? Defaults to `false`.
func (r *QueueAuthorizationRule) Send() *kulado.BoolOutput {
