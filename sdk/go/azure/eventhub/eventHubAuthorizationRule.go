...
func NewEventHubAuthorizationRule(ctx *kulado.Context,
	name string, args *EventHubAuthorizationRuleArgs, opts ...kulado.ResourceOpt) (*EventHubAuthorizationRule, error) {
...
func GetEventHubAuthorizationRule(ctx *kulado.Context,
	name string, id kulado.ID, state *EventHubAuthorizationRuleState, opts ...kulado.ResourceOpt) (*EventHubAuthorizationRule, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *EventHubAuthorizationRule) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *EventHubAuthorizationRule) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Specifies the name of the EventHub. Changing this forces a new resource to be created.
func (r *EventHubAuthorizationRule) EventhubName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["eventhubName"])
}

// Does this Authorization Rule have permissions to Listen to the Event Hub? Defaults to `false`.
func (r *EventHubAuthorizationRule) Listen() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["listen"])
}

func (r *EventHubAuthorizationRule) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Does this Authorization Rule have permissions to Manage to the Event Hub? When this property is `true` - both `listen` and `send` must be too. Defaults to `false`.
func (r *EventHubAuthorizationRule) Manage() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["manage"])
}

// Specifies the name of the EventHub Authorization Rule resource. Changing this forces a new resource to be created.
func (r *EventHubAuthorizationRule) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the name of the grandparent EventHub Namespace. Changing this forces a new resource to be created.
func (r *EventHubAuthorizationRule) NamespaceName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["namespaceName"])
}

// The Primary Connection String for the Event Hubs authorization Rule.
func (r *EventHubAuthorizationRule) PrimaryConnectionString() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryConnectionString"])
}

// The Primary Key for the Event Hubs authorization Rule.
func (r *EventHubAuthorizationRule) PrimaryKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryKey"])
}

// The name of the resource group in which the EventHub Namespace exists. Changing this forces a new resource to be created.
func (r *EventHubAuthorizationRule) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The Secondary Connection String for the Event Hubs authorization Rule.
func (r *EventHubAuthorizationRule) SecondaryConnectionString() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryConnectionString"])
}

// The Secondary Key for the Event Hubs authorization Rule.
func (r *EventHubAuthorizationRule) SecondaryKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryKey"])
}

// Does this Authorization Rule have permissions to Send to the Event Hub? Defaults to `false`.
func (r *EventHubAuthorizationRule) Send() *kulado.BoolOutput {
