...
func NewTopicAuthorizationRule(ctx *kulado.Context,
	name string, args *TopicAuthorizationRuleArgs, opts ...kulado.ResourceOpt) (*TopicAuthorizationRule, error) {
...
func GetTopicAuthorizationRule(ctx *kulado.Context,
	name string, id kulado.ID, state *TopicAuthorizationRuleState, opts ...kulado.ResourceOpt) (*TopicAuthorizationRule, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *TopicAuthorizationRule) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *TopicAuthorizationRule) ID() *kulado.IDOutput {
	return r.s.ID()
}

// Grants listen access to this this Authorization Rule. Defaults to `false`.
func (r *TopicAuthorizationRule) Listen() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["listen"])
}

// Grants manage access to this this Authorization Rule. When this property is `true` - both `listen` and `send` must be too. Defaults to `false`.
func (r *TopicAuthorizationRule) Manage() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["manage"])
}

// Specifies the name of the ServiceBus Topic Authorization Rule resource. Changing this forces a new resource to be created.
func (r *TopicAuthorizationRule) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Specifies the name of the ServiceBus Namespace. Changing this forces a new resource to be created.
func (r *TopicAuthorizationRule) NamespaceName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["namespaceName"])
}

// The Primary Connection String for the ServiceBus Topic authorization Rule.
func (r *TopicAuthorizationRule) PrimaryConnectionString() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryConnectionString"])
}

// The Primary Key for the ServiceBus Topic authorization Rule.
func (r *TopicAuthorizationRule) PrimaryKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryKey"])
}

// The name of the resource group in which the ServiceBus Namespace exists. Changing this forces a new resource to be created.
func (r *TopicAuthorizationRule) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The Secondary Connection String for the ServiceBus Topic authorization Rule.
func (r *TopicAuthorizationRule) SecondaryConnectionString() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryConnectionString"])
}

// The Secondary Key for the ServiceBus Topic authorization Rule.
func (r *TopicAuthorizationRule) SecondaryKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryKey"])
}

// Grants send access to this this Authorization Rule. Defaults to `false`.
func (r *TopicAuthorizationRule) Send() *kulado.BoolOutput {
...
func (r *TopicAuthorizationRule) TopicName() *kulado.StringOutput {
