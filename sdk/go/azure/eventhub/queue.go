...
func NewQueue(ctx *kulado.Context,
	name string, args *QueueArgs, opts ...kulado.ResourceOpt) (*Queue, error) {
...
func GetQueue(ctx *kulado.Context,
	name string, id kulado.ID, state *QueueState, opts ...kulado.ResourceOpt) (*Queue, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Queue) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Queue) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The ISO 8601 timespan duration of the idle interval after which the
// Queue is automatically deleted, minimum of 5 minutes.
func (r *Queue) AutoDeleteOnIdle() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["autoDeleteOnIdle"])
}

// Boolean flag which controls whether the Queue has dead letter support when a message expires. Defaults to `false`.
func (r *Queue) DeadLetteringOnMessageExpiration() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["deadLetteringOnMessageExpiration"])
}
...
func (r *Queue) DefaultMessageTtl() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["defaultMessageTtl"])
}

// The ISO 8601 timespan duration during which
// duplicates can be detected. Default value is 10 minutes. (`PT10M`)
func (r *Queue) DuplicateDetectionHistoryTimeWindow() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["duplicateDetectionHistoryTimeWindow"])
}

func (r *Queue) EnableBatchedOperations() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableBatchedOperations"])
}
...
// be set to `false`.
func (r *Queue) EnableExpress() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableExpress"])
}
...
// be set to `true`.
func (r *Queue) EnablePartitioning() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enablePartitioning"])
}

// Specifies the supported Azure location where the resource exists.
// Changing this forces a new resource to be created.
func (r *Queue) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// The ISO 8601 timespan duration of a peek-lock; that is, the amount of time that the message is locked for other receivers. Maximum value is 5 minutes. Defaults to 1 minute. (`PT1M`)
func (r *Queue) LockDuration() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["lockDuration"])
}

// Integer value which controls when a message is automatically deadlettered. Defaults to `10`.
func (r *Queue) MaxDeliveryCount() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["maxDeliveryCount"])
}

// Integer value which controls the size of
// memory allocated for the queue. For supported values see the "Queue/topic size"
// section of [this document](https://docs.microsoft.com/en-us/azure/service-bus-messaging/service-bus-quotas).
func (r *Queue) MaxSizeInMegabytes() *kulado.IntOutput {
	return (*kulado.IntOutput)(r.s.State["maxSizeInMegabytes"])
}

// Specifies the name of the ServiceBus Queue resource. Changing this forces a
// new resource to be created.
func (r *Queue) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the ServiceBus Namespace to create
// this queue in. Changing this forces a new resource to be created.
func (r *Queue) NamespaceName() *kulado.StringOutput {
...
func (r *Queue) RequiresDuplicateDetection() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["requiresDuplicateDetection"])
}
...
func (r *Queue) RequiresSession() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["requiresSession"])
}

// The name of the resource group in which to
// create the namespace. Changing this forces a new resource to be created.
func (r *Queue) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

func (r *Queue) SupportOrdering() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["supportOrdering"])
}
