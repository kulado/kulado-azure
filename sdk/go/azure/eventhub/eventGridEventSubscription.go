...
func NewEventGridEventSubscription(ctx *kulado.Context,
	name string, args *EventGridEventSubscriptionArgs, opts ...kulado.ResourceOpt) (*EventGridEventSubscription, error) {
...
func GetEventGridEventSubscription(ctx *kulado.Context,
	name string, id kulado.ID, state *EventGridEventSubscriptionState, opts ...kulado.ResourceOpt) (*EventGridEventSubscription, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *EventGridEventSubscription) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *EventGridEventSubscription) ID() *kulado.IDOutput {
	return r.s.ID()
}
...
func (r *EventGridEventSubscription) EventDeliverySchema() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["eventDeliverySchema"])
}

// A `eventhub_endpoint` block as defined below.
func (r *EventGridEventSubscription) EventhubEndpoint() *kulado.Output {
	return r.s.State["eventhubEndpoint"]
}

// A `hybrid_connection_endpoint` block as defined below.
func (r *EventGridEventSubscription) HybridConnectionEndpoint() *kulado.Output {
	return r.s.State["hybridConnectionEndpoint"]
}

// A list of applicable event types that need to be part of the event subscription.
func (r *EventGridEventSubscription) IncludedEventTypes() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["includedEventTypes"])
}

// A list of labels to assign to the event subscription.
func (r *EventGridEventSubscription) Labels() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["labels"])
}

// Specifies the name of the EventGrid Event Subscription resource. Changing this forces a new resource to be created.
func (r *EventGridEventSubscription) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// A `retry_policy` block as defined below.
func (r *EventGridEventSubscription) RetryPolicy() *kulado.Output {
	return r.s.State["retryPolicy"]
}

// Specifies the scope at which the EventGrid Event Subscription should be created. Changing this forces a new resource to be created.
func (r *EventGridEventSubscription) Scope() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["scope"])
}

// A `storage_blob_dead_letter_destination` block as defined below.
func (r *EventGridEventSubscription) StorageBlobDeadLetterDestination() *kulado.Output {
	return r.s.State["storageBlobDeadLetterDestination"]
}

// A `storage_queue_endpoint` block as defined below.
func (r *EventGridEventSubscription) StorageQueueEndpoint() *kulado.Output {
	return r.s.State["storageQueueEndpoint"]
}

// A `subject_filter` block as defined below.
func (r *EventGridEventSubscription) SubjectFilter() *kulado.Output {
	return r.s.State["subjectFilter"]
}

// Specifies the name of the topic to associate with the event subscription.
func (r *EventGridEventSubscription) TopicName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["topicName"])
}

// A `webhook_endpoint` block as defined below.
func (r *EventGridEventSubscription) WebhookEndpoint() *kulado.Output {
