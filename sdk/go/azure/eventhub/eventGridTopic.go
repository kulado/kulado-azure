...
func NewEventGridTopic(ctx *kulado.Context,
	name string, args *EventGridTopicArgs, opts ...kulado.ResourceOpt) (*EventGridTopic, error) {
...
func GetEventGridTopic(ctx *kulado.Context,
	name string, id kulado.ID, state *EventGridTopicState, opts ...kulado.ResourceOpt) (*EventGridTopic, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *EventGridTopic) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *EventGridTopic) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The Endpoint associated with the EventGrid Topic.
func (r *EventGridTopic) Endpoint() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["endpoint"])
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (r *EventGridTopic) Location() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["location"])
}

// Specifies the name of the EventGrid Topic resource. Changing this forces a new resource to be created.
func (r *EventGridTopic) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The Primary Shared Access Key associated with the EventGrid Topic.
func (r *EventGridTopic) PrimaryAccessKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["primaryAccessKey"])
}

// The name of the resource group in which the EventGrid Topic exists. Changing this forces a new resource to be created.
func (r *EventGridTopic) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The Secondary Shared Access Key associated with the EventGrid Topic.
func (r *EventGridTopic) SecondaryAccessKey() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["secondaryAccessKey"])
}

// A mapping of tags to assign to the resource.
func (r *EventGridTopic) Tags() *kulado.MapOutput {
