...
// TimeSpan format.
func (r *Subscription) AutoDeleteOnIdle() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["autoDeleteOnIdle"])
}

func (r *Subscription) DeadLetteringOnFilterEvaluationExceptions() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["deadLetteringOnFilterEvaluationExceptions"])
}

// Boolean flag which controls
// whether the Subscription has dead letter support when a message expires. Defaults
// to false.
func (r *Subscription) DeadLetteringOnMessageExpiration() *kulado.BoolOutput {
...
// format.
func (r *Subscription) DefaultMessageTtl() *kulado.StringOutput {
...
func (r *Subscription) EnableBatchedOperations() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableBatchedOperations"])
}

// The name of a Queue or Topic to automatically forward 
// messages to.
func (r *Subscription) ForwardTo() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["forwardTo"])
}

// Specifies the supported Azure location where the resource exists.
// Changing this forces a new resource to be created.
func (r *Subscription) Location() *kulado.StringOutput {
...
func (r *Subscription) RequiresSession() *kulado.BoolOutput {
...
// this Subscription in. Changing this forces a new resource to be created.
func (r *Subscription) TopicName() *kulado.StringOutput {
