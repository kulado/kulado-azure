...
func NewTopic(ctx *kulado.Context,
	name string, args *TopicArgs, opts ...kulado.ResourceOpt) (*Topic, error) {
...
func GetTopic(ctx *kulado.Context,
	name string, id kulado.ID, state *TopicState, opts ...kulado.ResourceOpt) (*Topic, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Topic) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Topic) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The ISO 8601 timespan duration of the idle interval after which the
// Topic is automatically deleted, minimum of 5 minutes.
func (r *Topic) AutoDeleteOnIdle() *kulado.StringOutput {
...
func (r *Topic) DefaultMessageTtl() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["defaultMessageTtl"])
}

// The ISO 8601 timespan duration during which
// duplicates can be detected. Defaults to 10 minutes. (`PT10M`)
func (r *Topic) DuplicateDetectionHistoryTimeWindow() *kulado.StringOutput {
...
func (r *Topic) EnableBatchedOperations() *kulado.BoolOutput {
...
func (r *Topic) EnableExpress() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableExpress"])
}

func (r *Topic) EnableFilteringMessagesBeforePublishing() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enableFilteringMessagesBeforePublishing"])
}

// Boolean flag which controls whether to enable
// the topic to be partitioned across multiple message brokers. Defaults to false.
// Changing this forces a new resource to be created.
func (r *Topic) EnablePartitioning() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["enablePartitioning"])
}

// Specifies the supported Azure location where the resource exists.
// Changing this forces a new resource to be created.
func (r *Topic) Location() *kulado.StringOutput {
...
func (r *Topic) MaxSizeInMegabytes() *kulado.IntOutput {
...
func (r *Topic) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the ServiceBus Namespace to create
// this topic in. Changing this forces a new resource to be created.
func (r *Topic) NamespaceName() *kulado.StringOutput {
...
func (r *Topic) RequiresDuplicateDetection() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["requiresDuplicateDetection"])
}

// The name of the resource group in which to
// create the namespace. Changing this forces a new resource to be created.
func (r *Topic) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The Status of the Service Bus Topic. Acceptable values are `Active` or `Disabled`. Defaults to `Active`.
func (r *Topic) Status() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["status"])
}

// Boolean flag which controls whether the Topic
// supports ordering. Defaults to false.
func (r *Topic) SupportOrdering() *kulado.BoolOutput {
