...
func (r *Definition) DisplayName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["displayName"])
}

// The ID of the Management Group where this policy should be defined. Changing this forces a new resource to be created.
func (r *Definition) ManagementGroupId() *kulado.StringOutput {
...
func (r *Definition) Metadata() *kulado.StringOutput {
...
// created.
func (r *Definition) Mode() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["mode"])
}
...
func (r *Definition) Parameters() *kulado.StringOutput {
...
// a then block.
func (r *Definition) PolicyRule() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["policyRule"])
}

// The policy type.  The value can be "BuiltIn", "Custom"
// or "NotSpecified". Changing this forces a new resource to be created.
func (r *Definition) PolicyType() *kulado.StringOutput {
