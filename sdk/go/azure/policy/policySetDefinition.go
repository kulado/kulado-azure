...
func NewPolicySetDefinition(ctx *kulado.Context,
	name string, args *PolicySetDefinitionArgs, opts ...kulado.ResourceOpt) (*PolicySetDefinition, error) {
...
func GetPolicySetDefinition(ctx *kulado.Context,
	name string, id kulado.ID, state *PolicySetDefinitionState, opts ...kulado.ResourceOpt) (*PolicySetDefinition, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *PolicySetDefinition) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *PolicySetDefinition) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The description of the policy set definition.
func (r *PolicySetDefinition) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// The display name of the policy set definition.
func (r *PolicySetDefinition) DisplayName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["displayName"])
}

// The ID of the Management Group where this policy should be defined. Changing this forces a new resource to be created.
func (r *PolicySetDefinition) ManagementGroupId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["managementGroupId"])
}

// The metadata for the policy set definition. This is a json object representing additional metadata that should be stored with the policy definition.
func (r *PolicySetDefinition) Metadata() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["metadata"])
}

// The name of the policy set definition. Changing this forces a new resource to be created.
func (r *PolicySetDefinition) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// Parameters for the policy set definition. This field is a json object that allows you to parameterize your policy definition.
func (r *PolicySetDefinition) Parameters() *kulado.StringOutput {
...
func (r *PolicySetDefinition) PolicyDefinitions() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["policyDefinitions"])
}

// The policy set type. Possible values are `BuiltIn` or `Custom`. Changing this forces a new resource to be created.
func (r *PolicySetDefinition) PolicyType() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["policyType"])
}
