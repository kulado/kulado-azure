...
func NewProductPolicy(ctx *kulado.Context,
	name string, args *ProductPolicyArgs, opts ...kulado.ResourceOpt) (*ProductPolicy, error) {
...
func GetProductPolicy(ctx *kulado.Context,
	name string, id kulado.ID, state *ProductPolicyState, opts ...kulado.ResourceOpt) (*ProductPolicy, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ProductPolicy) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ProductPolicy) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the API Management Service. Changing this forces a new resource to be created.
func (r *ProductPolicy) ApiManagementName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["apiManagementName"])
}

// The ID of the API Management Product within the API Management Service. Changing this forces a new resource to be created.
func (r *ProductPolicy) ProductId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["productId"])
}

// The name of the Resource Group in which the API Management Service exists. Changing this forces a new resource to be created.
func (r *ProductPolicy) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The XML Content for this Policy.
func (r *ProductPolicy) XmlContent() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["xmlContent"])
}

// A link to a Policy XML Document, which must be publicly available.
func (r *ProductPolicy) XmlLink() *kulado.StringOutput {
