...
func NewUser(ctx *kulado.Context,
	name string, args *UserArgs, opts ...kulado.ResourceOpt) (*User, error) {
...
func GetUser(ctx *kulado.Context,
	name string, id kulado.ID, state *UserState, opts ...kulado.ResourceOpt) (*User, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *User) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *User) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the API Management Service in which the User should be created. Changing this forces a new resource to be created.
func (r *User) ApiManagementName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["apiManagementName"])
}

// The kind of confirmation email which will be sent to this user. Possible values are `invite` and `signup`. Changing this forces a new resource to be created.
func (r *User) Confirmation() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["confirmation"])
}

// The email address associated with this user.
func (r *User) Email() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["email"])
}

// The first name for this user.
func (r *User) FirstName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["firstName"])
}

// The last name for this user.
func (r *User) LastName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["lastName"])
}

// A note about this user.
func (r *User) Note() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["note"])
}

// The password associated with this user.
func (r *User) Password() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["password"])
}

// The name of the Resource Group in which the API Management Service exists. Changing this forces a new resource to be created.
func (r *User) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The state of this user. Possible values are `active`, `blocked` and `pending`.
func (r *User) State() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["state"])
}

// The Identifier for this User, which must be unique within the API Management Service. Changing this forces a new resource to be created.
func (r *User) UserId() *kulado.StringOutput {
