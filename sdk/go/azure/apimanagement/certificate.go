...
func (r *Certificate) ApiManagementName() *kulado.StringOutput {
...
func (r *Certificate) Data() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["data"])
}

// The Expiration Date of this Certificate, formatted as an RFC3339 string.
func (r *Certificate) Expiration() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["expiration"])
}
...
func (r *Certificate) Subject() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["subject"])
}
