...
func NewApiVersionSet(ctx *kulado.Context,
	name string, args *ApiVersionSetArgs, opts ...kulado.ResourceOpt) (*ApiVersionSet, error) {
...
func GetApiVersionSet(ctx *kulado.Context,
	name string, id kulado.ID, state *ApiVersionSetState, opts ...kulado.ResourceOpt) (*ApiVersionSet, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ApiVersionSet) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ApiVersionSet) ID() *kulado.IDOutput {
	return r.s.ID()
}
...
func (r *ApiVersionSet) ApiManagementName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["apiManagementName"])
}

// The description of API Version Set.
func (r *ApiVersionSet) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// The display name of this API Version Set.
func (r *ApiVersionSet) DisplayName() *kulado.StringOutput {
...
func (r *ApiVersionSet) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the Resource Group in which the parent API Management Service exists. Changing this forces a new resource to be created.
func (r *ApiVersionSet) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// The name of the Header which should be read from Inbound Requests which defines the API Version.
func (r *ApiVersionSet) VersionHeaderName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["versionHeaderName"])
}

// The name of the Query String which should be read from Inbound Requests which defines the API Version.
func (r *ApiVersionSet) VersionQueryName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["versionQueryName"])
}

// Specifies where in an Inbound HTTP Request that the API Version should be read from. Possible values are `Header`, `Query` and `Segment`.
func (r *ApiVersionSet) VersioningScheme() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["versioningScheme"])
}
