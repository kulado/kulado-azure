...
func NewApiOperation(ctx *kulado.Context,
	name string, args *ApiOperationArgs, opts ...kulado.ResourceOpt) (*ApiOperation, error) {
...
func GetApiOperation(ctx *kulado.Context,
	name string, id kulado.ID, state *ApiOperationState, opts ...kulado.ResourceOpt) (*ApiOperation, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *ApiOperation) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *ApiOperation) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The Name of the API Management Service where the API exists. Changing this forces a new resource to be created.
func (r *ApiOperation) ApiManagementName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["apiManagementName"])
}

// The name of the API within the API Management Service where this API Operation should be created. Changing this forces a new resource to be created.
func (r *ApiOperation) ApiName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["apiName"])
}

// A description for this API Operation, which may include HTML formatting tags.
func (r *ApiOperation) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// The Display Name for this API Management Operation.
func (r *ApiOperation) DisplayName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["displayName"])
}

// The HTTP Method used for this API Management Operation, like `GET`, `DELETE`, `PUT` or `POST` - but not limited to these values.
func (r *ApiOperation) Method() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["method"])
}

// A unique identifier for this API Operation. Changing this forces a new resource to be created.
func (r *ApiOperation) OperationId() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["operationId"])
}

// A `request` block as defined below.
func (r *ApiOperation) Request() *kulado.Output {
	return r.s.State["request"]
}

// The Name of the Resource Group in which the API Management Service exists. Changing this forces a new resource to be created.
func (r *ApiOperation) ResourceGroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["resourceGroupName"])
}

// One or more `response` blocks as defined below.
func (r *ApiOperation) Responses() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["responses"])
}

// One or more `template_parameter` blocks as defined below.
func (r *ApiOperation) TemplateParameters() *kulado.ArrayOutput {
	return (*kulado.ArrayOutput)(r.s.State["templateParameters"])
}

// The relative URL Template identifying the target resource for this operation, which may include parameters.
func (r *ApiOperation) UrlTemplate() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["urlTemplate"])
}
