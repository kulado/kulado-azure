...
func NewGroupUser(ctx *kulado.Context,
	name string, args *GroupUserArgs, opts ...kulado.ResourceOpt) (*GroupUser, error) {
...
func GetGroupUser(ctx *kulado.Context,
	name string, id kulado.ID, state *GroupUserState, opts ...kulado.ResourceOpt) (*GroupUser, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *GroupUser) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *GroupUser) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the API Management Service. Changing this forces a new resource to be created.
func (r *GroupUser) ApiManagementName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["apiManagementName"])
}

// The Name of the API Management Group within the API Management Service. Changing this forces a new resource to be created.
func (r *GroupUser) GroupName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["groupName"])
}

// The name of the Resource Group in which the API Management Service exists. Changing this forces a new resource to be created.
func (r *GroupUser) ResourceGroupName() *kulado.StringOutput {
...
func (r *GroupUser) UserId() *kulado.StringOutput {
