...
func NewLogger(ctx *kulado.Context,
	name string, args *LoggerArgs, opts ...kulado.ResourceOpt) (*Logger, error) {
...
func GetLogger(ctx *kulado.Context,
	name string, id kulado.ID, state *LoggerState, opts ...kulado.ResourceOpt) (*Logger, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *Logger) URN() *kulado.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *Logger) ID() *kulado.IDOutput {
	return r.s.ID()
}

// The name of the API Management Service. Changing this forces a new resource to be created.
func (r *Logger) ApiManagementName() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["apiManagementName"])
}

// An `application_insights` block as documented below.
func (r *Logger) ApplicationInsights() *kulado.Output {
	return r.s.State["applicationInsights"]
}

// Specifies whether records should be buffered in the Logger prior to publishing. Defaults to `true`.
func (r *Logger) Buffered() *kulado.BoolOutput {
	return (*kulado.BoolOutput)(r.s.State["buffered"])
}

// A description of this Logger.
func (r *Logger) Description() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["description"])
}

// An `eventhub` block as documented below.
func (r *Logger) Eventhub() *kulado.Output {
	return r.s.State["eventhub"]
}

// The name of this Logger, which must be unique within the API Management Service. Changing this forces a new resource to be created.
func (r *Logger) Name() *kulado.StringOutput {
	return (*kulado.StringOutput)(r.s.State["name"])
}

// The name of the Resource Group in which the API Management Service exists. Changing this forces a new resource to be created.
func (r *Logger) ResourceGroupName() *kulado.StringOutput {
