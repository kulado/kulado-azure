 ...
 */
export class LinkedService extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: LinkedServiceState, opts?: kulado.CustomResourceOptions): LinkedService {
        return new LinkedService(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:loganalytics/linkedService:LinkedService';
    ...
    public static isInstance(obj: any): obj is LinkedService {
        ...
        return obj['__kuladoType'] === LinkedService.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: LinkedServiceArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: LinkedServiceArgs | LinkedServiceState, opts?: kulado.CustomResourceOptions) {
        ...
        super(LinkedService.__kuladoType, name, inputs, opts);
    }
}
