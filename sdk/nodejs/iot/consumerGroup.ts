 ...
 */
export class ConsumerGroup extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ConsumerGroupState, opts?: kulado.CustomResourceOptions): ConsumerGroup {
        return new ConsumerGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:iot/consumerGroup:ConsumerGroup';
    ...
    public static isInstance(obj: any): obj is ConsumerGroup {
        ...
        return obj['__kuladoType'] === ConsumerGroup.__kuladoType;
    }

    /**
     * The name of the Event Hub-compatible endpoint in the IoT hub. Changing this forces a new resource to be created.
     */
    public readonly eventhubEndpointName!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: ConsumerGroupArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ConsumerGroupArgs | ConsumerGroupState, opts?: kulado.CustomResourceOptions) {
        ...
        super(ConsumerGroup.__kuladoType, name, inputs, opts);
    }
}
...
export interface ConsumerGroupState {
     ...
     * The name of the Event Hub-compatible endpoint in the IoT hub. Changing this forces a new resource to be created.
     */
    readonly eventhubEndpointName?: kulado.Input<string>;
    /**
     * The name of the IoT Hub. Changing this forces a new resource to be created.
     */
