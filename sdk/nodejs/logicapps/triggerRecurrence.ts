 ...
 */
export class TriggerRecurrence extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: TriggerRecurrenceState, opts?: kulado.CustomResourceOptions): TriggerRecurrence {
        return new TriggerRecurrence(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:logicapps/triggerRecurrence:TriggerRecurrence';
    ...
    public static isInstance(obj: any): obj is TriggerRecurrence {
        ...
        return obj['__kuladoType'] === TriggerRecurrence.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: TriggerRecurrenceArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: TriggerRecurrenceArgs | TriggerRecurrenceState, opts?: kulado.CustomResourceOptions) {
        ...
        super(TriggerRecurrence.__kuladoType, name, inputs, opts);
    }
}
