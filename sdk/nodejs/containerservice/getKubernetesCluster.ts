 ...
 * 
 * const test = kulado.output(azure.containerservice.getKubernetesCluster({
 *     name: "myakscluster",
 ...
 */
export function getKubernetesCluster(args: GetKubernetesClusterArgs, opts?: kulado.InvokeOptions): Promise<GetKubernetesClusterResult> & GetKubernetesClusterResult {
    const promise: Promise<GetKubernetesClusterResult> = kulado.runtime.invoke("azure:containerservice/getKubernetesCluster:getKubernetesCluster", {
        "name": args.name,
