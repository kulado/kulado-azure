 ...
 * 
 * const test = kulado.output(azure.cosmosdb.getAccount({
 ...
 */
export function getAccount(args: GetAccountArgs, opts?: kulado.InvokeOptions): Promise<GetAccountResult> & GetAccountResult {
    const promise: Promise<GetAccountResult> = kulado.runtime.invoke("azure:cosmosdb/getAccount:getAccount", {
        "name": args.name,
