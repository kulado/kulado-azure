 ...
 */
export class SqlDatabase extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: SqlDatabaseState, opts?: kulado.CustomResourceOptions): SqlDatabase {
        return new SqlDatabase(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:cosmosdb/sqlDatabase:SqlDatabase';
    ...
    public static isInstance(obj: any): obj is SqlDatabase {
        ...
        return obj['__kuladoType'] === SqlDatabase.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: SqlDatabaseArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: SqlDatabaseArgs | SqlDatabaseState, opts?: kulado.CustomResourceOptions) {
        ...
        super(SqlDatabase.__kuladoType, name, inputs, opts);
    }
}
