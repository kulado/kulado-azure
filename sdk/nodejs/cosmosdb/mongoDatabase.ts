 ...
 */
export class MongoDatabase extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: MongoDatabaseState, opts?: kulado.CustomResourceOptions): MongoDatabase {
        return new MongoDatabase(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:cosmosdb/mongoDatabase:MongoDatabase';
    ...
    public static isInstance(obj: any): obj is MongoDatabase {
        ...
        return obj['__kuladoType'] === MongoDatabase.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: MongoDatabaseArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: MongoDatabaseArgs | MongoDatabaseState, opts?: kulado.CustomResourceOptions) {
        ...
        super(MongoDatabase.__kuladoType, name, inputs, opts);
    }
}
