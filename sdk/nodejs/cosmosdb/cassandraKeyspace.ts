 ...
 */
export class CassandraKeyspace extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: CassandraKeyspaceState, opts?: kulado.CustomResourceOptions): CassandraKeyspace {
        return new CassandraKeyspace(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:cosmosdb/cassandraKeyspace:CassandraKeyspace';
    ...
    public static isInstance(obj: any): obj is CassandraKeyspace {
        ...
        return obj['__kuladoType'] === CassandraKeyspace.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: CassandraKeyspaceArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: CassandraKeyspaceArgs | CassandraKeyspaceState, opts?: kulado.CustomResourceOptions) {
        ...
        super(CassandraKeyspace.__kuladoType, name, inputs, opts);
    }
}
