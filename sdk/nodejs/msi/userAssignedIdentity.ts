 ...
 */
export class UserAssignedIdentity extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: UserAssignedIdentityState, opts?: kulado.CustomResourceOptions): UserAssignedIdentity {
        return new UserAssignedIdentity(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:msi/userAssignedIdentity:UserAssignedIdentity';
    ...
    public static isInstance(obj: any): obj is UserAssignedIdentity {
        ...
        return obj['__kuladoType'] === UserAssignedIdentity.__kuladoType;
    }

    /**
     * Client ID associated with the user assigned identity.
     */
    public /*out*/ readonly clientId!: kulado.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly principalId!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: UserAssignedIdentityArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: UserAssignedIdentityArgs | UserAssignedIdentityState, opts?: kulado.CustomResourceOptions) {
        ...
        super(UserAssignedIdentity.__kuladoType, name, inputs, opts);
    }
}
...
export interface UserAssignedIdentityState {
     ...
     * Service Principal ID associated with the user assigned identity.
     */
    readonly principalId?: kulado.Input<string>;
    /**
     * The name of the resource group in which to
     * create the user assigned identity.
     */
