 ...
 */
export class ServicePrincipalPassword extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ServicePrincipalPasswordState, opts?: kulado.CustomResourceOptions): ServicePrincipalPassword {
        return new ServicePrincipalPassword(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:ad/servicePrincipalPassword:ServicePrincipalPassword';
    ...
    public static isInstance(obj: any): obj is ServicePrincipalPassword {
        ...
        return obj['__kuladoType'] === ServicePrincipalPassword.__kuladoType;
    }

    /**
     * The End Date which the Password is valid until, formatted as a RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). Changing this field forces a new resource to be created.
     */
    public readonly endDate!: kulado.Output<string>;
    /**
     ...
     */
    public readonly keyId!: kulado.Output<string>;
    /**
     ...
     */
    public readonly startDate!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: ServicePrincipalPasswordArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ServicePrincipalPasswordArgs | ServicePrincipalPasswordState, opts?: kulado.CustomResourceOptions) {
        ...
        super(ServicePrincipalPassword.__kuladoType, name, inputs, opts);
    }
}
...
export interface ServicePrincipalPasswordState {
     ...
     * The End Date which the Password is valid until, formatted as a RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). Changing this field forces a new resource to be created.
     */
    readonly endDate?: kulado.Input<string>;
    /**
     * A GUID used to uniquely identify this Key. If not specified a GUID will be created. Changing this field forces a new resource to be created.
     */
    readonly keyId?: kulado.Input<string>;
    /**
     * The ID of the Service Principal for which this password should be created. Changing this field forces a new resource to be created.
     */
     ...
     * The Start Date which the Password is valid from, formatted as a RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If this isn't specified, the current date is used.  Changing this field forces a new resource to be created.
     */
    readonly startDate?: kulado.Input<string>;
    /**
     * The Password for this Service Principal.
     */
