 ...
 */
export function getServicePrincipal(args?: GetServicePrincipalArgs, opts?: kulado.InvokeOptions): Promise<GetServicePrincipalResult> & GetServicePrincipalResult {
    args = args || {};
    const promise: Promise<GetServicePrincipalResult> = kulado.runtime.invoke("azure:ad/getServicePrincipal:getServicePrincipal", {
