 ...
 */
export function getApplication(args?: GetApplicationArgs, opts?: kulado.InvokeOptions): Promise<GetApplicationResult> & GetApplicationResult {
    args = args || {};
    const promise: Promise<GetApplicationResult> = kulado.runtime.invoke("azure:ad/getApplication:getApplication", {
        "name": args.name,
