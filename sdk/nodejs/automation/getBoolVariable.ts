 ...
 * 
 * const example = kulado.output(azure.automation.getBoolVariable({
 ...
 */
export function getBoolVariable(args: GetBoolVariableArgs, opts?: kulado.InvokeOptions): Promise<GetBoolVariableResult> & GetBoolVariableResult {
    const promise: Promise<GetBoolVariableResult> = kulado.runtime.invoke("azure:automation/getBoolVariable:getBoolVariable", {
