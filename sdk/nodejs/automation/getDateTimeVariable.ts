 ...
 * 
 * const example = kulado.output(azure.automation.getDateTimeVariable({
 ...
 */
export function getDateTimeVariable(args: GetDateTimeVariableArgs, opts?: kulado.InvokeOptions): Promise<GetDateTimeVariableResult> & GetDateTimeVariableResult {
    const promise: Promise<GetDateTimeVariableResult> = kulado.runtime.invoke("azure:automation/getDateTimeVariable:getDateTimeVariable", {
