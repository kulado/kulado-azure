 ...
 */
export class Credential extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: CredentialState, opts?: kulado.CustomResourceOptions): Credential {
        return new Credential(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:automation/credential:Credential';
    ...
    public static isInstance(obj: any): obj is Credential {
        ...
        return obj['__kuladoType'] === Credential.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: CredentialArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: CredentialArgs | CredentialState, opts?: kulado.CustomResourceOptions) {
        ...
        super(Credential.__kuladoType, name, inputs, opts);
    }
}
