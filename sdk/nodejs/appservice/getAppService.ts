 ...
 * 
 * const test = kulado.output(azure.appservice.getAppService({
 ...
 */
export function getAppService(args: GetAppServiceArgs, opts?: kulado.InvokeOptions): Promise<GetAppServiceResult> & GetAppServiceResult {
    const promise: Promise<GetAppServiceResult> = kulado.runtime.invoke("azure:appservice/getAppService:getAppService", {
        "name": args.name,
