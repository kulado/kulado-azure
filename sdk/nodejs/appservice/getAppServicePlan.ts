 ...
 * 
 * const test = kulado.output(azure.appservice.getAppServicePlan({
 ...
 */
export function getAppServicePlan(args: GetAppServicePlanArgs, opts?: kulado.InvokeOptions): Promise<GetAppServicePlanResult> & GetAppServicePlanResult {
    const promise: Promise<GetAppServicePlanResult> = kulado.runtime.invoke("azure:appservice/getAppServicePlan:getAppServicePlan", {
        "name": args.name,
