...
interface TimerBindingDefinition extends mod.BindingDefinition {
     ...
     */
    schedule: kulado.Input<string>;

    /**
     * If true, the function is invoked when the runtime starts.
     */
    runOnStartup?: kulado.Input<boolean>;
     ...
     */
    useMonitor?: kulado.Input<boolean>;
}
...
export interface TimerFunctionArgs extends mod.CallbackFunctionArgs<TimerContext, TimerInfo, mod.FunctionDefaultResponse> {
     ...
     */
    schedule: kulado.Input<string | ScheduleArgs>;
...
export class TimerFunction extends mod.Function<TimerContext, TimerInfo, mod.FunctionDefaultResponse> {
    constructor(name: string, args: TimerFunctionArgs) {
        const schedule = kulado.output(args.schedule).apply(s => typeof s === "string" ? s : cronExpression(s));
