 ...
 */
export class ActiveSlot extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ActiveSlotState, opts?: kulado.CustomResourceOptions): ActiveSlot {
        return new ActiveSlot(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:appservice/activeSlot:ActiveSlot';
    ...
    public static isInstance(obj: any): obj is ActiveSlot {
        ...
        return obj['__kuladoType'] === ActiveSlot.__kuladoType;
    }
     ...
     */
    public readonly appServiceSlotName!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: ActiveSlotArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ActiveSlotArgs | ActiveSlotState, opts?: kulado.CustomResourceOptions) {
        ...
        super(ActiveSlot.__kuladoType, name, inputs, opts);
    }
}
...
export interface ActiveSlotState {
     ...
     * The name of the App Service Slot which should be promoted to the Production Slot within the App Service.
     */
    readonly appServiceSlotName?: kulado.Input<string>;
    /**
     * The name of the resource group in which the App Service exists. Changing this forces a new resource to be created.
     */
