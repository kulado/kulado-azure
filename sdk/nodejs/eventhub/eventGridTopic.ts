 ...
 */
export class EventGridTopic extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: EventGridTopicState, opts?: kulado.CustomResourceOptions): EventGridTopic {
        return new EventGridTopic(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:eventhub/eventGridTopic:EventGridTopic';
    ...
    public static isInstance(obj: any): obj is EventGridTopic {
        ...
        return obj['__kuladoType'] === EventGridTopic.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: EventGridTopicArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: EventGridTopicArgs | EventGridTopicState, opts?: kulado.CustomResourceOptions) {
        ...
        super(EventGridTopic.__kuladoType, name, inputs, opts);
    }
}
