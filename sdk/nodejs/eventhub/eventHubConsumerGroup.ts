 ...
 */
export class EventHubConsumerGroup extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: EventHubConsumerGroupState, opts?: kulado.CustomResourceOptions): EventHubConsumerGroup {
        return new EventHubConsumerGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:eventhub/eventHubConsumerGroup:EventHubConsumerGroup';
    ...
    public static isInstance(obj: any): obj is EventHubConsumerGroup {
        ...
        return obj['__kuladoType'] === EventHubConsumerGroup.__kuladoType;
    }
     ...
     */
    public readonly userMetadata!: kulado.Output<string | undefined>;
     ...
     */
    constructor(name: string, args: EventHubConsumerGroupArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: EventHubConsumerGroupArgs | EventHubConsumerGroupState, opts?: kulado.CustomResourceOptions) {
        ...
        super(EventHubConsumerGroup.__kuladoType, name, inputs, opts);
    }
}
...
export interface EventHubConsumerGroupState {
     ...
     * Specifies the user metadata.
     */
    readonly userMetadata?: kulado.Input<string>;
}
