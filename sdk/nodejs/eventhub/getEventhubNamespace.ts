 ...
 * 
 * const test = kulado.output(azure.eventhub.getEventhubNamespace({
 ...
 */
export function getEventhubNamespace(args: GetEventhubNamespaceArgs, opts?: kulado.InvokeOptions): Promise<GetEventhubNamespaceResult> & GetEventhubNamespaceResult {
    const promise: Promise<GetEventhubNamespaceResult> = kulado.runtime.invoke("azure:eventhub/getEventhubNamespace:getEventhubNamespace", {
        "name": args.name,
