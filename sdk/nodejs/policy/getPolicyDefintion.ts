 ...
 * 
 * const test = kulado.output(azure.policy.getPolicyDefintion({
 ...
 */
export function getPolicyDefintion(args: GetPolicyDefintionArgs, opts?: kulado.InvokeOptions): Promise<GetPolicyDefintionResult> & GetPolicyDefintionResult {
    const promise: Promise<GetPolicyDefintionResult> = kulado.runtime.invoke("azure:policy/getPolicyDefintion:getPolicyDefintion", {
