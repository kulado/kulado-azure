 ...
 * 
 * const example = kulado.output(azure.redis.getCache({
 *     name: "myrediscache",
 ...
 */
export function getCache(args: GetCacheArgs, opts?: kulado.InvokeOptions): Promise<GetCacheResult> & GetCacheResult {
    const promise: Promise<GetCacheResult> = kulado.runtime.invoke("azure:redis/getCache:getCache", {
        "name": args.name,
