 ...
 *     name: kulado.interpolate`redis${server.hex}`,
 *     redisConfiguration: {
 *         maxclients: 256,
 *         maxmemoryDelta: 2,
...
export class FirewallRule extends kulado.CustomResource {
    ...
    /** @internal */
    public static readonly __kuladoType = 'azure:redis/firewallRule:FirewallRule';
     ...
     */
    public readonly endIp!: kulado.Output<string>;
    /**
     ...
     */
    public readonly redisCacheName!: kulado.Output<string>;
    /**
     ...
     */
    public readonly startIp!: kulado.Output<string>;
...
export interface FirewallRuleState {
     ...
     * The highest IP address included in the range.
     */
    readonly endIp?: kulado.Input<string>;
    /**
     * The name of the Firewall Rule. Changing this forces a new resource to be created.
     */
     ...
     * The name of the Redis Cache. Changing this forces a new resource to be created.
     */
    readonly redisCacheName?: kulado.Input<string>;
    /**
     * The name of the resource group in which this Redis Cache exists.
     */
     ...
     * The lowest IP address included in the range
     */
    readonly startIp?: kulado.Input<string>;
}
