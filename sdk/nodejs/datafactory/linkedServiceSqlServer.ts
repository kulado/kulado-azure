 ...
 */
export class LinkedServiceSqlServer extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: LinkedServiceSqlServerState, opts?: kulado.CustomResourceOptions): LinkedServiceSqlServer {
        return new LinkedServiceSqlServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:datafactory/linkedServiceSqlServer:LinkedServiceSqlServer';
    ...
    public static isInstance(obj: any): obj is LinkedServiceSqlServer {
        ...
        return obj['__kuladoType'] === LinkedServiceSqlServer.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: LinkedServiceSqlServerArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: LinkedServiceSqlServerArgs | LinkedServiceSqlServerState, opts?: kulado.CustomResourceOptions) {
        ...
        super(LinkedServiceSqlServer.__kuladoType, name, inputs, opts);
    }
}
