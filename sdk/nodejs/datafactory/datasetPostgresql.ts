 ...
 */
export class DatasetPostgresql extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: DatasetPostgresqlState, opts?: kulado.CustomResourceOptions): DatasetPostgresql {
        return new DatasetPostgresql(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:datafactory/datasetPostgresql:DatasetPostgresql';
    ...
    public static isInstance(obj: any): obj is DatasetPostgresql {
        ...
        return obj['__kuladoType'] === DatasetPostgresql.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: DatasetPostgresqlArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: DatasetPostgresqlArgs | DatasetPostgresqlState, opts?: kulado.CustomResourceOptions) {
        ...
        super(DatasetPostgresql.__kuladoType, name, inputs, opts);
    }
}
