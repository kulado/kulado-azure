 ...
 */
export class DatasetMysql extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: DatasetMysqlState, opts?: kulado.CustomResourceOptions): DatasetMysql {
        return new DatasetMysql(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:datafactory/datasetMysql:DatasetMysql';
    ...
    public static isInstance(obj: any): obj is DatasetMysql {
        ...
        return obj['__kuladoType'] === DatasetMysql.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: DatasetMysqlArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: DatasetMysqlArgs | DatasetMysqlState, opts?: kulado.CustomResourceOptions) {
        ...
        super(DatasetMysql.__kuladoType, name, inputs, opts);
    }
}
