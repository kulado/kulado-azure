 ...
 */
export class LinkedServiceDataLakeStorageGen2 extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: LinkedServiceDataLakeStorageGen2State, opts?: kulado.CustomResourceOptions): LinkedServiceDataLakeStorageGen2 {
        return new LinkedServiceDataLakeStorageGen2(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:datafactory/linkedServiceDataLakeStorageGen2:LinkedServiceDataLakeStorageGen2';
    ...
    public static isInstance(obj: any): obj is LinkedServiceDataLakeStorageGen2 {
        ...
        return obj['__kuladoType'] === LinkedServiceDataLakeStorageGen2.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: LinkedServiceDataLakeStorageGen2Args, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: LinkedServiceDataLakeStorageGen2Args | LinkedServiceDataLakeStorageGen2State, opts?: kulado.CustomResourceOptions) {
        ...
        super(LinkedServiceDataLakeStorageGen2.__kuladoType, name, inputs, opts);
    }
}
...
export interface LinkedServiceDataLakeStorageGen2State {
     ...
     * The service principal id in which to authenticate against the Azure Data Lake Storage Gen2 account.
     */
    readonly servicePrincipalId?: kulado.Input<string>;
    /**
     * The service principal key in which to authenticate against the Azure Data Lake Storage Gen2 account.
     */
    readonly servicePrincipalKey?: kulado.Input<string>;
    /**
     * The tenant id or name in which to authenticate against the Azure Data Lake Storage Gen2 account.
     */
    readonly tenant?: kulado.Input<string>;
    /**
     * The endpoint for the Azure Data Lake Storage Gen2 service.
     */
