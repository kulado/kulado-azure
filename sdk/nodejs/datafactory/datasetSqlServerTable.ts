 ...
 */
export class DatasetSqlServerTable extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: DatasetSqlServerTableState, opts?: kulado.CustomResourceOptions): DatasetSqlServerTable {
        return new DatasetSqlServerTable(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:datafactory/datasetSqlServerTable:DatasetSqlServerTable';
    ...
    public static isInstance(obj: any): obj is DatasetSqlServerTable {
        ...
        return obj['__kuladoType'] === DatasetSqlServerTable.__kuladoType;
    }
     ...
     */
    public readonly folder!: kulado.Output<string | undefined>;
    /**
     * The Data Factory Linked Service name in which to associate the Dataset with.
     */
    public readonly linkedServiceName!: kulado.Output<string>;
    /**
     ...
     */
    public readonly schemaColumns!: kulado.Output<{ description?: string, name: string, type?: string }[] | undefined>;
    /**
     * The table name of the Data Factory Dataset SQL Server Table.
     */
    public readonly tableName!: kulado.Output<string | undefined>;
     ...
     */
    constructor(name: string, args: DatasetSqlServerTableArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: DatasetSqlServerTableArgs | DatasetSqlServerTableState, opts?: kulado.CustomResourceOptions) {
        ...
        super(DatasetSqlServerTable.__kuladoType, name, inputs, opts);
    }
}
...
export interface DatasetSqlServerTableState {
     ...
     * The folder that this Dataset is in. If not specified, the Dataset will appear at the root level.
     */
    readonly folder?: kulado.Input<string>;
    /**
     * The Data Factory Linked Service name in which to associate the Dataset with.
     */
     ...
     * A `schema_column` block as defined below.
     */
    readonly schemaColumns?: kulado.Input<kulado.Input<{ description?: kulado.Input<string>, name: kulado.Input<string>, type?: kulado.Input<string> }>[]>;
    /**
     * The table name of the Data Factory Dataset SQL Server Table.
     */
    readonly tableName?: kulado.Input<string>;
}
