 ...
 */
export class OutputEventHub extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: OutputEventHubState, opts?: kulado.CustomResourceOptions): OutputEventHub {
        return new OutputEventHub(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:streamanalytics/outputEventHub:OutputEventHub';
    ...
    public static isInstance(obj: any): obj is OutputEventHub {
        ...
        return obj['__kuladoType'] === OutputEventHub.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: OutputEventHubArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: OutputEventHubArgs | OutputEventHubState, opts?: kulado.CustomResourceOptions) {
        ...
        super(OutputEventHub.__kuladoType, name, inputs, opts);
    }
}
