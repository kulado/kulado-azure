 ...
 */
export class OutputMssql extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: OutputMssqlState, opts?: kulado.CustomResourceOptions): OutputMssql {
        return new OutputMssql(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:streamanalytics/outputMssql:OutputMssql';
    ...
    public static isInstance(obj: any): obj is OutputMssql {
        ...
        return obj['__kuladoType'] === OutputMssql.__kuladoType;
    }

    public readonly database!: kulado.Output<string>;
    /**
     ...
     */
    public readonly password!: kulado.Output<string>;
    /**
     ...
     */
    public readonly server!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: OutputMssqlArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: OutputMssqlArgs | OutputMssqlState, opts?: kulado.CustomResourceOptions) {
        ...
        super(OutputMssql.__kuladoType, name, inputs, opts);
    }
}
...
export interface OutputMssqlState {
    readonly database?: kulado.Input<string>;
    /**
     * The name of the Stream Output. Changing this forces a new resource to be created.
     */
     ...
     * The SQL server url. Changing this forces a new resource to be created.
     */
    readonly server?: kulado.Input<string>;
    /**
     * The name of the Stream Analytics Job. Changing this forces a new resource to be created.
     */
     ...
     * Table in the database that the output points to. Changing this forces a new resource to be created.
     */
    readonly table?: kulado.Input<string>;
    /**
     * Username used to login to the Microsoft SQL Server. Changing this forces a new resource to be created.
     */
    readonly user?: kulado.Input<string>;
}
