 ...
 */
export class StreamInputIotHub extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: StreamInputIotHubState, opts?: kulado.CustomResourceOptions): StreamInputIotHub {
        return new StreamInputIotHub(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:streamanalytics/streamInputIotHub:StreamInputIotHub';
    ...
    public static isInstance(obj: any): obj is StreamInputIotHub {
        ...
        return obj['__kuladoType'] === StreamInputIotHub.__kuladoType;
    }
     ...
     */
    public readonly iothubNamespace!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: StreamInputIotHubArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: StreamInputIotHubArgs | StreamInputIotHubState, opts?: kulado.CustomResourceOptions) {
        ...
        super(StreamInputIotHub.__kuladoType, name, inputs, opts);
    }
}
...
export interface StreamInputIotHubState {
     ...
     * The name or the URI of the IoT Hub.
     */
    readonly iothubNamespace?: kulado.Input<string>;
    /**
     * The name of the Stream Input IoTHub. Changing this forces a new resource to be created.
     */
