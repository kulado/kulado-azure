 ...
 */
export class OutputServiceBusQueue extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: OutputServiceBusQueueState, opts?: kulado.CustomResourceOptions): OutputServiceBusQueue {
        return new OutputServiceBusQueue(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:streamanalytics/outputServiceBusQueue:OutputServiceBusQueue';
    ...
    public static isInstance(obj: any): obj is OutputServiceBusQueue {
        ...
        return obj['__kuladoType'] === OutputServiceBusQueue.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: OutputServiceBusQueueArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: OutputServiceBusQueueArgs | OutputServiceBusQueueState, opts?: kulado.CustomResourceOptions) {
        ...
        super(OutputServiceBusQueue.__kuladoType, name, inputs, opts);
    }
}
