 ...
 */
export class AlertRule extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: AlertRuleState, opts?: kulado.CustomResourceOptions): AlertRule {
        return new AlertRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:monitoring/alertRule:AlertRule';
    ...
    public static isInstance(obj: any): obj is AlertRule {
        ...
        return obj['__kuladoType'] === AlertRule.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: AlertRuleArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: AlertRuleArgs | AlertRuleState, opts?: kulado.CustomResourceOptions) {
        ...
        super(AlertRule.__kuladoType, name, inputs, opts);
    }
}
