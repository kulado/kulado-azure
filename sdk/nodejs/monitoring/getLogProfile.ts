 ...
 * 
 * const test = kulado.output(azure.monitoring.getLogProfile({
 ...
 */
export function getLogProfile(args: GetLogProfileArgs, opts?: kulado.InvokeOptions): Promise<GetLogProfileResult> & GetLogProfileResult {
    const promise: Promise<GetLogProfileResult> = kulado.runtime.invoke("azure:monitoring/getLogProfile:getLogProfile", {
        "name": args.name,
    }, opts);
