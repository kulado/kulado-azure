 ...
 * 
 * const test = kulado.output(azure.operationalinsights.getAnalyticsWorkspace({
 *     name: "acctest-01",
 ...
 */
export function getAnalyticsWorkspace(args: GetAnalyticsWorkspaceArgs, opts?: kulado.InvokeOptions): Promise<GetAnalyticsWorkspaceResult> & GetAnalyticsWorkspaceResult {
    const promise: Promise<GetAnalyticsWorkspaceResult> = kulado.runtime.invoke("azure:operationalinsights/getAnalyticsWorkspace:getAnalyticsWorkspace", {
        "name": args.name,
