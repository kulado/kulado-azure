 ...
 *     name: kulado.interpolate`k8s-workspace-${workspace.hex}`,
 ...
 */
export class AnalyticsSolution extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: AnalyticsSolutionState, opts?: kulado.CustomResourceOptions): AnalyticsSolution {
        return new AnalyticsSolution(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:operationalinsights/analyticsSolution:AnalyticsSolution';
    ...
    public static isInstance(obj: any): obj is AnalyticsSolution {
        ...
        return obj['__kuladoType'] === AnalyticsSolution.__kuladoType;
    }
     ...
     */
    public readonly plan!: kulado.Output<{ name: string, product: string, promotionCode?: string, publisher: string }>;
    /**
     ...
     */
    public readonly solutionName!: kulado.Output<string>;
    /**
     ...
     */
    public readonly workspaceResourceId!: kulado.Output<string>;
     ...
     */
    constructor(name: string, args: AnalyticsSolutionArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: AnalyticsSolutionArgs | AnalyticsSolutionState, opts?: kulado.CustomResourceOptions) {
        ...
        super(AnalyticsSolution.__kuladoType, name, inputs, opts);
    }
}
...
export interface AnalyticsSolutionState {
     ...
     * A `plan` block as documented below.
     */
    readonly plan?: kulado.Input<{ name?: kulado.Input<string>, product: kulado.Input<string>, promotionCode?: kulado.Input<string>, publisher: kulado.Input<string> }>;
    /**
     * The name of the resource group in which the Log Analytics solution is created. Changing this forces a new resource to be created. Note: The solution and it's related workspace can only exist in the same resource group.
     */
     ...
     * Specifies the name of the solution to be deployed. See [here for options](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-add-solutions).Changing this forces a new resource to be created.
     */
    readonly solutionName?: kulado.Input<string>;
    /**
     * The full name of the Log Analytics workspace with which the solution will be linked. Changing this forces a new resource to be created.
     */
     ...
     * The full resource ID of the Log Analytics workspace with which the solution will be linked. Changing this forces a new resource to be created.
     */
    readonly workspaceResourceId?: kulado.Input<string>;
}
