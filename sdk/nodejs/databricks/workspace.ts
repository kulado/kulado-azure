 ...
 */
export class Workspace extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: WorkspaceState, opts?: kulado.CustomResourceOptions): Workspace {
        return new Workspace(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:databricks/workspace:Workspace';
    ...
    public static isInstance(obj: any): obj is Workspace {
        ...
        return obj['__kuladoType'] === Workspace.__kuladoType;
    }
     ...
     */
    public /*out*/ readonly managedResourceGroupId!: kulado.Output<string>;
    /**
     * The name of the resource group where Azure should place the managed Databricks resources. Changing this forces a new resource to be created.
     */
    public readonly managedResourceGroupName!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: WorkspaceArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: WorkspaceArgs | WorkspaceState, opts?: kulado.CustomResourceOptions) {
        ...
        super(Workspace.__kuladoType, name, inputs, opts);
    }
}
...
export interface WorkspaceState {
     ...
     * The ID of the Managed Resource Group created by the Databricks Workspace.
     */
    readonly managedResourceGroupId?: kulado.Input<string>;
    /**
     * The name of the resource group where Azure should place the managed Databricks resources. Changing this forces a new resource to be created.
     */
    readonly managedResourceGroupName?: kulado.Input<string>;
    /**
     * Specifies the name of the Databricks Workspace resource. Changing this forces a new resource to be created.
     */
