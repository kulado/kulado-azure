 ...
 */
export class OutboundRule extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: OutboundRuleState, opts?: kulado.CustomResourceOptions): OutboundRule {
        return new OutboundRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:lb/outboundRule:OutboundRule';
    ...
    public static isInstance(obj: any): obj is OutboundRule {
        ...
        return obj['__kuladoType'] === OutboundRule.__kuladoType;
    }

    /**
     * The number of outbound ports to be used for NAT.
     */
    public readonly allocatedOutboundPorts!: kulado.Output<number | undefined>;
    /**
     ...
     */
    public readonly enableTcpReset!: kulado.Output<boolean | undefined>;
    /**
     * One or more `frontend_ip_configuration` blocks as defined below.
     */
    public readonly frontendIpConfigurations!: kulado.Output<{ id: string, name: string }[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: OutboundRuleArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: OutboundRuleArgs | OutboundRuleState, opts?: kulado.CustomResourceOptions) {
        ...
        super(OutboundRule.__kuladoType, name, inputs, opts);
    }
}
...
export interface OutboundRuleState {
     ...
     * The number of outbound ports to be used for NAT.
     */
    readonly allocatedOutboundPorts?: kulado.Input<number>;
    /**
     * The ID of the Backend Address Pool. Outbound traffic is randomly load balanced across IPs in the backend IPs.
     */
     ...
     * Receive bidirectional TCP Reset on TCP flow idle timeout or unexpected connection termination. This element is only used when the protocol is set to TCP.
     */
    readonly enableTcpReset?: kulado.Input<boolean>;
    /**
     * One or more `frontend_ip_configuration` blocks as defined below.
     */
    readonly frontendIpConfigurations?: kulado.Input<kulado.Input<{ id?: kulado.Input<string>, name: kulado.Input<string> }>[]>;
    /**
     * The timeout for the TCP idle connection
     */
