 ...
 * 
 * const contributor = kulado.output(azure.role.getBuiltinRoleDefinition({
 *     name: "Contributor",
 * }));
 * 
 ...
 */
export function getBuiltinRoleDefinition(args: GetBuiltinRoleDefinitionArgs, opts?: kulado.InvokeOptions): Promise<GetBuiltinRoleDefinitionResult> & GetBuiltinRoleDefinitionResult {
    const promise: Promise<GetBuiltinRoleDefinitionResult> = kulado.runtime.invoke("azure:role/getBuiltinRoleDefinition:getBuiltinRoleDefinition", {
        "name": args.name,
    }, opts);
