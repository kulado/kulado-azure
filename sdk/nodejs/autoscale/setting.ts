 ...
 */
export class Setting extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: SettingState, opts?: kulado.CustomResourceOptions): Setting {
        return new Setting(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:autoscale/setting:Setting';
    ...
    public static isInstance(obj: any): obj is Setting {
        ...
        return obj['__kuladoType'] === Setting.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: SettingArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: SettingArgs | SettingState, opts?: kulado.CustomResourceOptions) {
        ...
        super(Setting.__kuladoType, name, inputs, opts);
    }
}
