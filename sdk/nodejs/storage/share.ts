 ...
 */
export class Share extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ShareState, opts?: kulado.CustomResourceOptions): Share {
        return new Share(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:storage/share:Share';
    ...
    public static isInstance(obj: any): obj is Share {
        ...
        return obj['__kuladoType'] === Share.__kuladoType;
    }
     ...
     */
    public readonly quota!: kulado.Output<number | undefined>;
    /**
     ...
     */
    constructor(name: string, args: ShareArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ShareArgs | ShareState, opts?: kulado.CustomResourceOptions) {
        ...
        super(Share.__kuladoType, name, inputs, opts);
    }
}
...
export interface ShareState {
     ...
     * The maximum size of the share, in gigabytes. Must be greater than 0, and less than or equal to 5 TB (5120 GB). Default is 5120.
     */
    readonly quota?: kulado.Input<number>;
    /**
     * The name of the resource group in which to
     * create the share. Changing this forces a new resource to be created.
     */
