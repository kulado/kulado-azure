 ...
 * 
 * const test = kulado.output(azure.compute.getAvailabilitySet({
 ...
 */
export function getAvailabilitySet(args: GetAvailabilitySetArgs, opts?: kulado.InvokeOptions): Promise<GetAvailabilitySetResult> & GetAvailabilitySetResult {
    const promise: Promise<GetAvailabilitySetResult> = kulado.runtime.invoke("azure:compute/getAvailabilitySet:getAvailabilitySet", {
        "name": args.name,
