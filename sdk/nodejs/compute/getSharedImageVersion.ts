 ...
 * 
 * const test = kulado.output(azure.compute.getSharedImageVersion({
 ...
 */
export function getSharedImageVersion(args: GetSharedImageVersionArgs, opts?: kulado.InvokeOptions): Promise<GetSharedImageVersionResult> & GetSharedImageVersionResult {
    const promise: Promise<GetSharedImageVersionResult> = kulado.runtime.invoke("azure:compute/getSharedImageVersion:getSharedImageVersion", {
