 ...
 * 
 * const test = kulado.output(azure.compute.getSharedImage({
 ...
 */
export function getSharedImage(args: GetSharedImageArgs, opts?: kulado.InvokeOptions): Promise<GetSharedImageResult> & GetSharedImageResult {
    const promise: Promise<GetSharedImageResult> = kulado.runtime.invoke("azure:compute/getSharedImage:getSharedImage", {
