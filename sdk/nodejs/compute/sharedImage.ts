 ...
 */
export class SharedImage extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: SharedImageState, opts?: kulado.CustomResourceOptions): SharedImage {
        return new SharedImage(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:compute/sharedImage:SharedImage';
    ...
    public static isInstance(obj: any): obj is SharedImage {
        ...
        return obj['__kuladoType'] === SharedImage.__kuladoType;
    }
     ...
     */
    public readonly eula!: kulado.Output<string | undefined>;
    /**
     ...
     */
    public readonly identifier!: kulado.Output<{ offer: string, publisher: string, sku: string }>;
    /**
     ...
     */
    public readonly privacyStatementUri!: kulado.Output<string | undefined>;
    /**
     * The URI containing the Release Notes associated with this Shared Image.
     */
    public readonly releaseNoteUri!: kulado.Output<string | undefined>;
    /**
     ...
     */
    constructor(name: string, args: SharedImageArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: SharedImageArgs | SharedImageState, opts?: kulado.CustomResourceOptions) {
        ...
        super(SharedImage.__kuladoType, name, inputs, opts);
    }
}
...
export interface SharedImageState {
     ...
     * The End User Licence Agreement for the Shared Image.
     */
    readonly eula?: kulado.Input<string>;
    /**
     * Specifies the name of the Shared Image Gallery in which this Shared Image should exist. Changing this forces a new resource to be created.
     */
     ...
     * An `identifier` block as defined below.
     */
    readonly identifier?: kulado.Input<{ offer: kulado.Input<string>, publisher: kulado.Input<string>, sku: kulado.Input<string> }>;
    /**
     * Specifies the supported Azure location where the Shared Image Gallery exists. Changing this forces a new resource to be created.
     */
     ...
     * The URI containing the Privacy Statement associated with this Shared Image.
     */
    readonly privacyStatementUri?: kulado.Input<string>;
    /**
     * The URI containing the Release Notes associated with this Shared Image.
     */
    readonly releaseNoteUri?: kulado.Input<string>;
    /**
     * The name of the resource group in which the Shared Image Gallery exists. Changing this forces a new resource to be created.
     */
