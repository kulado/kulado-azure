 ...
 * });
 * const datasourcemd = kulado.output(azure.compute.getManagedDisk({
 ...
 */
export function getManagedDisk(args: GetManagedDiskArgs, opts?: kulado.InvokeOptions): Promise<GetManagedDiskResult> & GetManagedDiskResult {
    const promise: Promise<GetManagedDiskResult> = kulado.runtime.invoke("azure:compute/getManagedDisk:getManagedDisk", {
        "name": args.name,
