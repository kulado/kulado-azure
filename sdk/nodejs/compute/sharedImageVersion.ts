 ...
 * 
 * const existingImage = kulado.output(azure.compute.getImage({
 *     name: "search-api",
 *     resourceGroupName: "packerimages",
 * }));
 * const existingSharedImage = kulado.output(azure.compute.getSharedImage({
 ...
 */
export class SharedImageVersion extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: SharedImageVersionState, opts?: kulado.CustomResourceOptions): SharedImageVersion {
        return new SharedImageVersion(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:compute/sharedImageVersion:SharedImageVersion';
    ...
    public static isInstance(obj: any): obj is SharedImageVersion {
        ...
        return obj['__kuladoType'] === SharedImageVersion.__kuladoType;
    }

    /**
     * Should this Image Version be excluded from the `latest` filter? If set to `true` this Image Version won't be returned for the `latest` version. Defaults to `false`.
     */
    public readonly excludeFromLatest!: kulado.Output<boolean | undefined>;
    /**
     * The name of the Shared Image Gallery in which the Shared Image exists. Changing this forces a new resource to be created.
     */
    public readonly galleryName!: kulado.Output<string>;
    /**
     * The name of the Shared Image within the Shared Image Gallery in which this Version should be created. Changing this forces a new resource to be created.
     */
    public readonly imageName!: kulado.Output<string>;
    /**
     ...
     */
    public readonly managedImageId!: kulado.Output<string>;
    /**
     ...
     */
    public readonly targetRegions!: kulado.Output<{ name: string, regionalReplicaCount: number }[]>;
     ...
     */
    constructor(name: string, args: SharedImageVersionArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: SharedImageVersionArgs | SharedImageVersionState, opts?: kulado.CustomResourceOptions) {
        ...
        super(SharedImageVersion.__kuladoType, name, inputs, opts);
    }
}
...
export interface SharedImageVersionState {
     ...
     * Should this Image Version be excluded from the `latest` filter? If set to `true` this Image Version won't be returned for the `latest` version. Defaults to `false`.
     */
    readonly excludeFromLatest?: kulado.Input<boolean>;
    /**
     * The name of the Shared Image Gallery in which the Shared Image exists. Changing this forces a new resource to be created.
     */
    readonly galleryName?: kulado.Input<string>;
    /**
     * The name of the Shared Image within the Shared Image Gallery in which this Version should be created. Changing this forces a new resource to be created.
     */
    readonly imageName?: kulado.Input<string>;
    /**
     * The Azure Region in which the Shared Image Gallery exists. Changing this forces a new resource to be created.
     */
     ...
     * The ID of the Managed Image which should be used for this Shared Image Version. Changing this forces a new resource to be created.
     */
    readonly managedImageId?: kulado.Input<string>;
    /**
     * The version number for this Image Version, such as `1.0.0`. Changing this forces a new resource to be created.
     */
     ...
     * One or more `target_region` blocks as documented below.
     */
    readonly targetRegions?: kulado.Input<kulado.Input<{ name: kulado.Input<string>, regionalReplicaCount: kulado.Input<number> }>[]>;
}
