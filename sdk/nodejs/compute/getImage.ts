 ...
 * 
 * const search = kulado.output(azure.compute.getImage({
 *     name: "search-api",
 ...
 */
export function getImage(args: GetImageArgs, opts?: kulado.InvokeOptions): Promise<GetImageResult> & GetImageResult {
    const promise: Promise<GetImageResult> = kulado.runtime.invoke("azure:compute/getImage:getImage", {
        "name": args.name,
