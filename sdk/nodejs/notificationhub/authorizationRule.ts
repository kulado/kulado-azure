 ...
 */
export class AuthorizationRule extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: AuthorizationRuleState, opts?: kulado.CustomResourceOptions): AuthorizationRule {
        return new AuthorizationRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:notificationhub/authorizationRule:AuthorizationRule';
    ...
    public static isInstance(obj: any): obj is AuthorizationRule {
        ...
        return obj['__kuladoType'] === AuthorizationRule.__kuladoType;
    }
     ...
     */
    public readonly notificationHubName!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: AuthorizationRuleArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: AuthorizationRuleArgs | AuthorizationRuleState, opts?: kulado.CustomResourceOptions) {
        ...
        super(AuthorizationRule.__kuladoType, name, inputs, opts);
    }
}
...
export interface AuthorizationRuleState {
     ...
     * The name of the Notification Hub for which the Authorization Rule should be created. Changing this forces a new resource to be created.
     */
    readonly notificationHubName?: kulado.Input<string>;
    /**
     * The Primary Access Key associated with this Authorization Rule.
     */
