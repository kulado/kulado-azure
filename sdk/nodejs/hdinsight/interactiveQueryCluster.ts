 ...
 */
export class InteractiveQueryCluster extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: InteractiveQueryClusterState, opts?: kulado.CustomResourceOptions): InteractiveQueryCluster {
        return new InteractiveQueryCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:hdinsight/interactiveQueryCluster:InteractiveQueryCluster';
    ...
    public static isInstance(obj: any): obj is InteractiveQueryCluster {
        ...
        return obj['__kuladoType'] === InteractiveQueryCluster.__kuladoType;
    }
     ...
     */
    public readonly componentVersion!: kulado.Output<{ interactiveHive: string }>;
    /**
     ...
     */
    constructor(name: string, args: InteractiveQueryClusterArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: InteractiveQueryClusterArgs | InteractiveQueryClusterState, opts?: kulado.CustomResourceOptions) {
        ...
        super(InteractiveQueryCluster.__kuladoType, name, inputs, opts);
    }
}
...
export interface InteractiveQueryClusterState {
     ...
     * A `component_version` block as defined below.
     */
    readonly componentVersion?: kulado.Input<{ interactiveHive: kulado.Input<string> }>;
    /**
     * A `gateway` block as defined below.
     */
