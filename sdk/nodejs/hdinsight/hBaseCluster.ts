 ...
 */
export class HBaseCluster extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: HBaseClusterState, opts?: kulado.CustomResourceOptions): HBaseCluster {
        return new HBaseCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:hdinsight/hBaseCluster:HBaseCluster';
    ...
    public static isInstance(obj: any): obj is HBaseCluster {
        ...
        return obj['__kuladoType'] === HBaseCluster.__kuladoType;
    }
     ...
     */
    public readonly componentVersion!: kulado.Output<{ hbase: string }>;
    /**
     ...
     */
    constructor(name: string, args: HBaseClusterArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: HBaseClusterArgs | HBaseClusterState, opts?: kulado.CustomResourceOptions) {
        ...
        super(HBaseCluster.__kuladoType, name, inputs, opts);
    }
}
...
export interface HBaseClusterState {
     ...
     * A `component_version` block as defined below.
     */
    readonly componentVersion?: kulado.Input<{ hbase: kulado.Input<string> }>;
    /**
     * A `gateway` block as defined below.
     */
