 ...
 */
export class StormCluster extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: StormClusterState, opts?: kulado.CustomResourceOptions): StormCluster {
        return new StormCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:hdinsight/stormCluster:StormCluster';
    ...
    public static isInstance(obj: any): obj is StormCluster {
        ...
        return obj['__kuladoType'] === StormCluster.__kuladoType;
    }
     ...
     */
    public readonly componentVersion!: kulado.Output<{ storm: string }>;
    /**
     ...
     */
    constructor(name: string, args: StormClusterArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: StormClusterArgs | StormClusterState, opts?: kulado.CustomResourceOptions) {
        ...
        super(StormCluster.__kuladoType, name, inputs, opts);
    }
}
...
export interface StormClusterState {
     ...
     * A `component_version` block as defined below.
     */
    readonly componentVersion?: kulado.Input<{ storm: kulado.Input<string> }>;
    /**
     * A `gateway` block as defined below.
     */
