 ...
 */
export class SparkCluster extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: SparkClusterState, opts?: kulado.CustomResourceOptions): SparkCluster {
        return new SparkCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:hdinsight/sparkCluster:SparkCluster';
    ...
    public static isInstance(obj: any): obj is SparkCluster {
        ...
        return obj['__kuladoType'] === SparkCluster.__kuladoType;
    }
     ...
     */
    public readonly componentVersion!: kulado.Output<{ spark: string }>;
    /**
     ...
     */
    constructor(name: string, args: SparkClusterArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: SparkClusterArgs | SparkClusterState, opts?: kulado.CustomResourceOptions) {
        ...
        super(SparkCluster.__kuladoType, name, inputs, opts);
    }
}
...
export interface SparkClusterState {
     ...
     * A `component_version` block as defined below.
     */
    readonly componentVersion?: kulado.Input<{ spark: kulado.Input<string> }>;
    /**
     * A `gateway` block as defined below.
     */
