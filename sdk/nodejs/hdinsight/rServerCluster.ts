 ...
 */
export class RServerCluster extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: RServerClusterState, opts?: kulado.CustomResourceOptions): RServerCluster {
        return new RServerCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:hdinsight/rServerCluster:RServerCluster';
    ...
    public static isInstance(obj: any): obj is RServerCluster {
        ...
        return obj['__kuladoType'] === RServerCluster.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: RServerClusterArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: RServerClusterArgs | RServerClusterState, opts?: kulado.CustomResourceOptions) {
        ...
        super(RServerCluster.__kuladoType, name, inputs, opts);
    }
}
