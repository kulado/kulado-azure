 ...
 * 
 * const test = kulado.output(azure.apimanagement.getProduct({
 ...
 */
export function getProduct(args: GetProductArgs, opts?: kulado.InvokeOptions): Promise<GetProductResult> & GetProductResult {
    const promise: Promise<GetProductResult> = kulado.runtime.invoke("azure:apimanagement/getProduct:getProduct", {
