 ...
 * }));
 * const exampleGroup = kulado.all([exampleService, exampleService]).apply(([exampleService, exampleService1]) => azure.apimanagement.getGroup({
 ...
 * });
 * const exampleProduct = kulado.all([exampleService, exampleService]).apply(([exampleService, exampleService1]) => azure.apimanagement.getProduct({
 *     apiManagementName: exampleService.name,
 ...
 */
export class ProductGroup extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ProductGroupState, opts?: kulado.CustomResourceOptions): ProductGroup {
        return new ProductGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:apimanagement/productGroup:ProductGroup';
    ...
    public static isInstance(obj: any): obj is ProductGroup {
        ...
        return obj['__kuladoType'] === ProductGroup.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: ProductGroupArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProductGroupArgs | ProductGroupState, opts?: kulado.CustomResourceOptions) {
        ...
        super(ProductGroup.__kuladoType, name, inputs, opts);
    }
}
