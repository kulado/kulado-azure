 ...
 * 
 * const test = kulado.output(azure.apimanagement.getService({
 *     name: "search-api",
 ...
 */
export function getService(args: GetServiceArgs, opts?: kulado.InvokeOptions): Promise<GetServiceResult> & GetServiceResult {
    const promise: Promise<GetServiceResult> = kulado.runtime.invoke("azure:apimanagement/getService:getService", {
        "name": args.name,
