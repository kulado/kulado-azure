 ...
 * 
 * const test = kulado.output(azure.apimanagement.getUser({
 ...
 */
export function getUser(args: GetUserArgs, opts?: kulado.InvokeOptions): Promise<GetUserResult> & GetUserResult {
    const promise: Promise<GetUserResult> = kulado.runtime.invoke("azure:apimanagement/getUser:getUser", {
