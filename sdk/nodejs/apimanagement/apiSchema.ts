 ...
 */
export class ApiSchema extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ApiSchemaState, opts?: kulado.CustomResourceOptions): ApiSchema {
        return new ApiSchema(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:apimanagement/apiSchema:ApiSchema';
    ...
    public static isInstance(obj: any): obj is ApiSchema {
        ...
        return obj['__kuladoType'] === ApiSchema.__kuladoType;
    }
     ...
     */
    public readonly contentType!: kulado.Output<string>;
    /**
     ...
     */
    public readonly schemaId!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: ApiSchemaArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApiSchemaArgs | ApiSchemaState, opts?: kulado.CustomResourceOptions) {
        ...
        super(ApiSchema.__kuladoType, name, inputs, opts);
    }
}
...
export interface ApiSchemaState {
     ...
     * A unique identifier for this API Schema. Changing this forces a new resource to be created.
     */
    readonly schemaId?: kulado.Input<string>;
    /**
     * The JSON escaped string defining the document representing the Schema.
     */
