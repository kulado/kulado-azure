 ...
 * 
 * const exampleProduct = kulado.output(azure.apimanagement.getProduct({
 ...
 */
export class ProductPolicy extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ProductPolicyState, opts?: kulado.CustomResourceOptions): ProductPolicy {
        return new ProductPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:apimanagement/productPolicy:ProductPolicy';
    ...
    public static isInstance(obj: any): obj is ProductPolicy {
        ...
        return obj['__kuladoType'] === ProductPolicy.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: ProductPolicyArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ProductPolicyArgs | ProductPolicyState, opts?: kulado.CustomResourceOptions) {
        ...
        super(ProductPolicy.__kuladoType, name, inputs, opts);
    }
}
