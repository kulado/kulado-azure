 ...
 * 
 * const test = kulado.output(azure.apimanagement.getApi({
 ...
 */
export function getApi(args: GetApiArgs, opts?: kulado.InvokeOptions): Promise<GetApiResult> & GetApiResult {
    const promise: Promise<GetApiResult> = kulado.runtime.invoke("azure:apimanagement/getApi:getApi", {
