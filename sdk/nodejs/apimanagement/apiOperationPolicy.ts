 ...
 */
export class ApiOperationPolicy extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ApiOperationPolicyState, opts?: kulado.CustomResourceOptions): ApiOperationPolicy {
        return new ApiOperationPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:apimanagement/apiOperationPolicy:ApiOperationPolicy';
    ...
    public static isInstance(obj: any): obj is ApiOperationPolicy {
        ...
        return obj['__kuladoType'] === ApiOperationPolicy.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: ApiOperationPolicyArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApiOperationPolicyArgs | ApiOperationPolicyState, opts?: kulado.CustomResourceOptions) {
        ...
        super(ApiOperationPolicy.__kuladoType, name, inputs, opts);
    }
}
