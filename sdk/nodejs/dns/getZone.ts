 ...
 * 
 * const test = kulado.output(azure.dns.getZone({
 ...
 */
export function getZone(args: GetZoneArgs, opts?: kulado.InvokeOptions): Promise<GetZoneResult> & GetZoneResult {
    const promise: Promise<GetZoneResult> = kulado.runtime.invoke("azure:dns/getZone:getZone", {
        "name": args.name,
