 ...
 */
export class Job extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: JobState, opts?: kulado.CustomResourceOptions): Job {
        return new Job(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:scheduler/job:Job';
    ...
    public static isInstance(obj: any): obj is Job {
        ...
        return obj['__kuladoType'] === Job.__kuladoType;
    }
     ...
     */
    public readonly errorActionStorageQueue!: kulado.Output<{ message: string, sasToken: string, storageAccountName: string, storageQueueName: string } | undefined>;
    /**
     ...
     */
    public readonly errorActionWeb!: kulado.Output<{ authenticationActiveDirectory?: { audience: string, clientId: string, secret: string, tenantId: string }, authenticationBasic?: { password: string, username: string }, authenticationCertificate?: { expiration: string, password: string, pfx: string, subjectName: string, thumbprint: string }, body?: string, headers?: {[key: string]: any}, method: string, url: string } | undefined>;
    /**
     ...
     */
    public readonly jobCollectionName!: kulado.Output<string>;
    /**
     ...
     */
    public readonly recurrence!: kulado.Output<{ count?: number, endTime: string, frequency: string, hours?: number[], interval?: number, minutes?: number[], monthDays?: number[], monthlyOccurrences?: { day: string, occurrence: number }[], weekDays?: string[] } | undefined>;
    /**
     ...
     */
    public readonly retry!: kulado.Output<{ count?: number, interval?: string } | undefined>;
    /**
     ...
     */
    constructor(name: string, args: JobArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: JobArgs | JobState, opts?: kulado.CustomResourceOptions) {
        ...
        super(Job.__kuladoType, name, inputs, opts);
    }
}
...
export interface JobState {
     ...
     * A `action_storage_queue` block defining a storage queue job action as described below. Note this is identical to an `error_action_storage_queue` block.
     */
    readonly actionStorageQueue?: kulado.Input<{ message: kulado.Input<string>, sasToken: kulado.Input<string>, storageAccountName: kulado.Input<string>, storageQueueName: kulado.Input<string> }>;
    /**
     * A `action_web` block defining the job action as described below. Note this is identical to an `error_action_web` block.
     */
    readonly actionWeb?: kulado.Input<{ authenticationActiveDirectory?: kulado.Input<{ audience?: kulado.Input<string>, clientId: kulado.Input<string>, secret: kulado.Input<string>, tenantId: kulado.Input<string> }>, authenticationBasic?: kulado.Input<{ password: kulado.Input<string>, username: kulado.Input<string> }>, authenticationCertificate?: kulado.Input<{ expiration?: kulado.Input<string>, password: kulado.Input<string>, pfx: kulado.Input<string>, subjectName?: kulado.Input<string>, thumbprint?: kulado.Input<string> }>, body?: kulado.Input<string>, headers?: kulado.Input<{[key: string]: any}>, method: kulado.Input<string>, url: kulado.Input<string> }>;
    /**
     * A `error_action_storage_queue` block defining the a web action to take on an error as described below. Note this is identical to an `action_storage_queue` block.
     */
    readonly errorActionStorageQueue?: kulado.Input<{ message: kulado.Input<string>, sasToken: kulado.Input<string>, storageAccountName: kulado.Input<string>, storageQueueName: kulado.Input<string> }>;
    /**
     * A `error_action_web` block defining the action to take on an error as described below. Note this is identical to an `action_web` block.
     */
    readonly errorActionWeb?: kulado.Input<{ authenticationActiveDirectory?: kulado.Input<{ audience?: kulado.Input<string>, clientId: kulado.Input<string>, secret: kulado.Input<string>, tenantId: kulado.Input<string> }>, authenticationBasic?: kulado.Input<{ password: kulado.Input<string>, username: kulado.Input<string> }>, authenticationCertificate?: kulado.Input<{ expiration?: kulado.Input<string>, password: kulado.Input<string>, pfx: kulado.Input<string>, subjectName?: kulado.Input<string>, thumbprint?: kulado.Input<string> }>, body?: kulado.Input<string>, headers?: kulado.Input<{[key: string]: any}>, method: kulado.Input<string>, url: kulado.Input<string> }>;
    /**
     * Specifies the name of the Scheduler Job Collection in which the Job should exist. Changing this forces a new resource to be created.
     */
    readonly jobCollectionName?: kulado.Input<string>;
    /**
     * The name of the Scheduler Job. Changing this forces a new resource to be created.
     */
     ...
     * A `recurrence` block defining a job occurrence schedule.
     */
    readonly recurrence?: kulado.Input<{ count?: kulado.Input<number>, endTime?: kulado.Input<string>, frequency: kulado.Input<string>, hours?: kulado.Input<kulado.Input<number>[]>, interval?: kulado.Input<number>, minutes?: kulado.Input<kulado.Input<number>[]>, monthDays?: kulado.Input<kulado.Input<number>[]>, monthlyOccurrences?: kulado.Input<kulado.Input<{ day: kulado.Input<string>, occurrence: kulado.Input<number> }>[]>, weekDays?: kulado.Input<kulado.Input<string>[]> }>;
    /**
     * The name of the resource group in which to create the Scheduler Job. Changing this forces a new resource to be created.
     */
     ...
     * A `retry` block defining how to retry as described below.
     */
    readonly retry?: kulado.Input<{ count?: kulado.Input<number>, interval?: kulado.Input<string> }>;
    /**
     * The time the first instance of the job is to start running at.
     */
