 ...
 */
export class SqlServer extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: SqlServerState, opts?: kulado.CustomResourceOptions): SqlServer {
        return new SqlServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:sql/sqlServer:SqlServer';
    ...
    public static isInstance(obj: any): obj is SqlServer {
        ...
        return obj['__kuladoType'] === SqlServer.__kuladoType;
    }
     ...
     */
    public /*out*/ readonly fullyQualifiedDomainName!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: SqlServerArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: SqlServerArgs | SqlServerState, opts?: kulado.CustomResourceOptions) {
        ...
        super(SqlServer.__kuladoType, name, inputs, opts);
    }
}
...
export interface SqlServerState {
     ...
     * The fully qualified domain name of the Azure SQL Server (e.g. myServerName.database.windows.net)
     */
    readonly fullyQualifiedDomainName?: kulado.Input<string>;
    /**
     * Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
     */
