 ...
 */
export class WindowsVirtualMachine extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: WindowsVirtualMachineState, opts?: kulado.CustomResourceOptions): WindowsVirtualMachine {
        return new WindowsVirtualMachine(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:devtest/windowsVirtualMachine:WindowsVirtualMachine';
    ...
    public static isInstance(obj: any): obj is WindowsVirtualMachine {
        ...
        return obj['__kuladoType'] === WindowsVirtualMachine.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: WindowsVirtualMachineArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: WindowsVirtualMachineArgs | WindowsVirtualMachineState, opts?: kulado.CustomResourceOptions) {
        ...
        super(WindowsVirtualMachine.__kuladoType, name, inputs, opts);
    }
}
