 ...
 * 
 * const test = kulado.output(azure.devtest.getLab({
 *     name: "example-lab",
 ...
 */
export function getLab(args: GetLabArgs, opts?: kulado.InvokeOptions): Promise<GetLabResult> & GetLabResult {
    const promise: Promise<GetLabResult> = kulado.runtime.invoke("azure:devtest/getLab:getLab", {
        "name": args.name,
