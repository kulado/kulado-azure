 ...
 */
export class Store extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: StoreState, opts?: kulado.CustomResourceOptions): Store {
        return new Store(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:datalake/store:Store';
     ...
     */
    public readonly encryptionType!: kulado.Output<string>;
    /**
     ...
     */
    public readonly firewallAllowAzureIps!: kulado.Output<string | undefined>;
    /**
     * the state of the Firewall. Possible values are `Enabled` and `Disabled`. Defaults to `Enabled.`
     */
    public readonly firewallState!: kulado.Output<string | undefined>;
    /**
     ...
     */
    constructor(name: string, args: StoreArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: StoreArgs | StoreState, opts?: kulado.CustomResourceOptions) {
        ...
        super(Store.__kuladoType, name, inputs, opts);
    }
}
...
export interface StoreState {
     ...
     * Is Encryption enabled on this Data Lake Store Account? Possible values are `Enabled` or `Disabled`. Defaults to `Enabled`.
     */
    readonly encryptionState?: kulado.Input<string>;
    /**
     * The Encryption Type used for this Data Lake Store Account. Currently can be set to `ServiceManaged` when `encryption_state` is `Enabled` - and must be a blank string when it's Disabled.
     */
    readonly encryptionType?: kulado.Input<string>;
    /**
     * The Endpoint for the Data Lake Store.
     */
     ...
     * are Azure Service IP's allowed through the firewall? Possible values are `Enabled` and `Disabled`. Defaults to `Enabled.`
     */
    readonly firewallAllowAzureIps?: kulado.Input<string>;
    /**
     * the state of the Firewall. Possible values are `Enabled` and `Disabled`. Defaults to `Enabled.`
     */
    readonly firewallState?: kulado.Input<string>;
    /**
     * Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
     */
