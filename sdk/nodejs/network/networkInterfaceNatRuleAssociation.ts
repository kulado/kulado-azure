 ...
 */
export class NetworkInterfaceNatRuleAssociation extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: NetworkInterfaceNatRuleAssociationState, opts?: kulado.CustomResourceOptions): NetworkInterfaceNatRuleAssociation {
        return new NetworkInterfaceNatRuleAssociation(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:network/networkInterfaceNatRuleAssociation:NetworkInterfaceNatRuleAssociation';
    ...
    public static isInstance(obj: any): obj is NetworkInterfaceNatRuleAssociation {
        ...
        return obj['__kuladoType'] === NetworkInterfaceNatRuleAssociation.__kuladoType;
    }
     ...
     */
    public readonly natRuleId!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: NetworkInterfaceNatRuleAssociationArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkInterfaceNatRuleAssociationArgs | NetworkInterfaceNatRuleAssociationState, opts?: kulado.CustomResourceOptions) {
        ...
        super(NetworkInterfaceNatRuleAssociation.__kuladoType, name, inputs, opts);
    }
}
...
export interface NetworkInterfaceNatRuleAssociationState {
     ...
     * The ID of the Load Balancer NAT Rule which this Network Interface which should be connected to. Changing this forces a new resource to be created.
     */
    readonly natRuleId?: kulado.Input<string>;
    /**
     * The ID of the Network Interface. Changing this forces a new resource to be created.
     */
