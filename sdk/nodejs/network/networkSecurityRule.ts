 ...
 */
export class NetworkSecurityRule extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: NetworkSecurityRuleState, opts?: kulado.CustomResourceOptions): NetworkSecurityRule {
        return new NetworkSecurityRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:network/networkSecurityRule:NetworkSecurityRule';
    ...
    public static isInstance(obj: any): obj is NetworkSecurityRule {
        ...
        return obj['__kuladoType'] === NetworkSecurityRule.__kuladoType;
    }

    /**
     * Specifies whether network traffic is allowed or denied. Possible values are `Allow` and `Deny`.
     */
    public readonly access!: kulado.Output<string>;
    /**
     ...
     */
    public readonly destinationAddressPrefix!: kulado.Output<string | undefined>;
    /**
     * List of destination address prefixes. Tags may not be used. This is required if `destination_address_prefix` is not specified.
     */
    public readonly destinationAddressPrefixes!: kulado.Output<string[] | undefined>;
    /**
     * A List of destination Application Security Group ID's
     */
    public readonly destinationApplicationSecurityGroupIds!: kulado.Output<string | undefined>;
    /**
     * Destination Port or Range. Integer or range between `0` and `65535` or `*` to match any. This is required if `destination_port_ranges` is not specified.
     */
    public readonly destinationPortRange!: kulado.Output<string | undefined>;
    /**
     * List of destination ports or port ranges. This is required if `destination_port_range` is not specified.
     */
    public readonly destinationPortRanges!: kulado.Output<string[] | undefined>;
    /**
     * The direction specifies if rule will be evaluated on incoming or outgoing traffic. Possible values are `Inbound` and `Outbound`.
     */
    public readonly direction!: kulado.Output<string>;
    /**
     ...
     */
    public readonly networkSecurityGroupName!: kulado.Output<string>;
    /**
     ...
     */
    public readonly sourceAddressPrefix!: kulado.Output<string | undefined>;
    /**
     * List of source address prefixes. Tags may not be used. This is required if `source_address_prefix` is not specified.
     */
    public readonly sourceAddressPrefixes!: kulado.Output<string[] | undefined>;
    /**
     * A List of source Application Security Group ID's
     */
    public readonly sourceApplicationSecurityGroupIds!: kulado.Output<string | undefined>;
    /**
     * Source Port or Range. Integer or range between `0` and `65535` or `*` to match any. This is required if `source_port_ranges` is not specified.
     */
    public readonly sourcePortRange!: kulado.Output<string | undefined>;
    /**
     * List of source ports or port ranges. This is required if `source_port_range` is not specified.
     */
    public readonly sourcePortRanges!: kulado.Output<string[] | undefined>;
     ...
     */
    constructor(name: string, args: NetworkSecurityRuleArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkSecurityRuleArgs | NetworkSecurityRuleState, opts?: kulado.CustomResourceOptions) {
        ...
        super(NetworkSecurityRule.__kuladoType, name, inputs, opts);
    }
}
...
export interface NetworkSecurityRuleState {
     ...
     * Specifies whether network traffic is allowed or denied. Possible values are `Allow` and `Deny`.
     */
    readonly access?: kulado.Input<string>;
    /**
     * A description for this rule. Restricted to 140 characters.
     */
     ...
     * CIDR or destination IP range or * to match any IP. Tags such as ‘VirtualNetwork’, ‘AzureLoadBalancer’ and ‘Internet’ can also be used. This is required if `destination_address_prefixes` is not specified.
     */
    readonly destinationAddressPrefix?: kulado.Input<string>;
    /**
     * List of destination address prefixes. Tags may not be used. This is required if `destination_address_prefix` is not specified.
     */
    readonly destinationAddressPrefixes?: kulado.Input<kulado.Input<string>[]>;
    /**
     * A List of destination Application Security Group ID's
     */
    readonly destinationApplicationSecurityGroupIds?: kulado.Input<string>;
    /**
     * Destination Port or Range. Integer or range between `0` and `65535` or `*` to match any. This is required if `destination_port_ranges` is not specified.
     */
    readonly destinationPortRange?: kulado.Input<string>;
    /**
     * List of destination ports or port ranges. This is required if `destination_port_range` is not specified.
     */
    readonly destinationPortRanges?: kulado.Input<kulado.Input<string>[]>;
    /**
     * The direction specifies if rule will be evaluated on incoming or outgoing traffic. Possible values are `Inbound` and `Outbound`.
     */
    readonly direction?: kulado.Input<string>;
    /**
     * The name of the security rule. This needs to be unique across all Rules in the Network Security Group. Changing this forces a new resource to be created.
     */
     ...
     * The name of the Network Security Group that we want to attach the rule to. Changing this forces a new resource to be created.
     */
    readonly networkSecurityGroupName?: kulado.Input<string>;
    /**
     * Specifies the priority of the rule. The value can be between 100 and 4096. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule.
     */
     ...
     * CIDR or source IP range or * to match any IP. Tags such as ‘VirtualNetwork’, ‘AzureLoadBalancer’ and ‘Internet’ can also be used. This is required if `source_address_prefixes` is not specified.
     */
    readonly sourceAddressPrefix?: kulado.Input<string>;
    /**
     * List of source address prefixes. Tags may not be used. This is required if `source_address_prefix` is not specified.
     */
    readonly sourceAddressPrefixes?: kulado.Input<kulado.Input<string>[]>;
    /**
     * A List of source Application Security Group ID's
     */
    readonly sourceApplicationSecurityGroupIds?: kulado.Input<string>;
    /**
     * Source Port or Range. Integer or range between `0` and `65535` or `*` to match any. This is required if `source_port_ranges` is not specified.
     */
    readonly sourcePortRange?: kulado.Input<string>;
    /**
     * List of source ports or port ranges. This is required if `source_port_range` is not specified.
     */
    readonly sourcePortRanges?: kulado.Input<kulado.Input<string>[]>;
}
