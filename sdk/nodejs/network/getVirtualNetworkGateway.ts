 ...
 * 
 * const test = kulado.output(azure.network.getVirtualNetworkGateway({
 *     name: "production",
 ...
 */
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: kulado.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> & GetVirtualNetworkGatewayResult {
    const promise: Promise<GetVirtualNetworkGatewayResult> = kulado.runtime.invoke("azure:network/getVirtualNetworkGateway:getVirtualNetworkGateway", {
        "name": args.name,
