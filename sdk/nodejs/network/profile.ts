...
export class Profile extends kulado.CustomResource {
    ...
    /** @internal */
    public static readonly __kuladoType = 'azure:network/profile:Profile';
    ...
    public readonly containerNetworkInterface!: kulado.Output<{ ipConfigurations: { name: string, subnetId: string }[], name: string }>;
    /**
     * One or more Resource IDs of Azure Container Network Interfaces.
     */
    public /*out*/ readonly containerNetworkInterfaceIds!: kulado.Output<string[]>;
    /**
...
export interface ProfileState {
    readonly containerNetworkInterface?: kulado.Input<{ ipConfigurations: kulado.Input<kulado.Input<{ name: kulado.Input<string>, subnetId: kulado.Input<string> }>[]>, name: kulado.Input<string> }>;
    /**
     * One or more Resource IDs of Azure Container Network Interfaces.
     */
    readonly containerNetworkInterfaceIds?: kulado.Input<kulado.Input<string>[]>;
    /**
     * Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
     */
