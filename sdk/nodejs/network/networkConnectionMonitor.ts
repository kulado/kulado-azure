 ...
 */
export class NetworkConnectionMonitor extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: NetworkConnectionMonitorState, opts?: kulado.CustomResourceOptions): NetworkConnectionMonitor {
        return new NetworkConnectionMonitor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:network/networkConnectionMonitor:NetworkConnectionMonitor';
    ...
    public static isInstance(obj: any): obj is NetworkConnectionMonitor {
        ...
        return obj['__kuladoType'] === NetworkConnectionMonitor.__kuladoType;
    }
     ...
     */
    public readonly autoStart!: kulado.Output<boolean | undefined>;
    /**
     * A `destination` block as defined below.
     */
    public readonly destination!: kulado.Output<{ address?: string, port: number, virtualMachineId?: string }>;
    /**
     ...
     */
    public readonly source!: kulado.Output<{ port?: number, virtualMachineId: string }>;
    /**
     ...
     */
    constructor(name: string, args: NetworkConnectionMonitorArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkConnectionMonitorArgs | NetworkConnectionMonitorState, opts?: kulado.CustomResourceOptions) {
        ...
        super(NetworkConnectionMonitor.__kuladoType, name, inputs, opts);
    }
}
...
export interface NetworkConnectionMonitorState {
     ...
     * Specifies whether the connection monitor will start automatically once created. Defaults to `true`. Changing this forces a new resource to be created.
     */
    readonly autoStart?: kulado.Input<boolean>;
    /**
     * A `destination` block as defined below.
     */
    readonly destination?: kulado.Input<{ address?: kulado.Input<string>, port: kulado.Input<number>, virtualMachineId?: kulado.Input<string> }>;
    /**
     * Monitoring interval in seconds. Defaults to `60`.
     */
     ...
     * A `source` block as defined below.
     */
    readonly source?: kulado.Input<{ port?: kulado.Input<number>, virtualMachineId: kulado.Input<string> }>;
    /**
     * A mapping of tags to assign to the resource.
     */
