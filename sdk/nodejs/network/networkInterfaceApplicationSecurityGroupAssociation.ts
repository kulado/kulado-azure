 ...
 */
export class NetworkInterfaceApplicationSecurityGroupAssociation extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: NetworkInterfaceApplicationSecurityGroupAssociationState, opts?: kulado.CustomResourceOptions): NetworkInterfaceApplicationSecurityGroupAssociation {
        return new NetworkInterfaceApplicationSecurityGroupAssociation(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:network/networkInterfaceApplicationSecurityGroupAssociation:NetworkInterfaceApplicationSecurityGroupAssociation';
    ...
    public static isInstance(obj: any): obj is NetworkInterfaceApplicationSecurityGroupAssociation {
        ...
        return obj['__kuladoType'] === NetworkInterfaceApplicationSecurityGroupAssociation.__kuladoType;
    }
     ...
     */
    public readonly applicationSecurityGroupId!: kulado.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: NetworkInterfaceApplicationSecurityGroupAssociationArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkInterfaceApplicationSecurityGroupAssociationArgs | NetworkInterfaceApplicationSecurityGroupAssociationState, opts?: kulado.CustomResourceOptions) {
        ...
        super(NetworkInterfaceApplicationSecurityGroupAssociation.__kuladoType, name, inputs, opts);
    }
}
...
export interface NetworkInterfaceApplicationSecurityGroupAssociationState {
     ...
     * The ID of the Application Security Group which this Network Interface which should be connected to. Changing this forces a new resource to be created.
     */
    readonly applicationSecurityGroupId?: kulado.Input<string>;
    /**
     * The Name of the IP Configuration within the Network Interface which should be connected to the Application Security Group. Changing this forces a new resource to be created.
     */
