 ...
 */
export class ExpressRouteCircuitPeering extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ExpressRouteCircuitPeeringState, opts?: kulado.CustomResourceOptions): ExpressRouteCircuitPeering {
        return new ExpressRouteCircuitPeering(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:network/expressRouteCircuitPeering:ExpressRouteCircuitPeering';
    ...
    public static isInstance(obj: any): obj is ExpressRouteCircuitPeering {
        ...
        return obj['__kuladoType'] === ExpressRouteCircuitPeering.__kuladoType;
    }

    /**
     * The ASN used by Azure.
     */
    public /*out*/ readonly azureAsn!: kulado.Output<number>;
    /**
     * The name of the ExpressRoute Circuit in which to create the Peering.
     */
    public readonly expressRouteCircuitName!: kulado.Output<string>;
    /**
     * A `microsoft_peering_config` block as defined below. Required when `peering_type` is set to `MicrosoftPeering`.
     */
    public readonly microsoftPeeringConfig!: kulado.Output<{ advertisedPublicPrefixes: string[] } | undefined>;
    /**
     * The Either a 16-bit or a 32-bit ASN. Can either be public or private..
     */
    public readonly peerAsn!: kulado.Output<number>;
    /**
     * The type of the ExpressRoute Circuit Peering. Acceptable values include `AzurePrivatePeering`, `AzurePublicPeering` and `MicrosoftPeering`. Changing this forces a new resource to be created.
     */
    public readonly peeringType!: kulado.Output<string>;
    /**
     * The Primary Port used by Azure for this Peering.
     */
    public /*out*/ readonly primaryAzurePort!: kulado.Output<string>;
    /**
     * A `/30` subnet for the primary link.
     */
    public readonly primaryPeerAddressPrefix!: kulado.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly secondaryAzurePort!: kulado.Output<string>;
    /**
     * A `/30` subnet for the secondary link.
     */
    public readonly secondaryPeerAddressPrefix!: kulado.Output<string>;
    /**
     ...
     */
    public readonly vlanId!: kulado.Output<number>;
     ...
     */
    constructor(name: string, args: ExpressRouteCircuitPeeringArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ExpressRouteCircuitPeeringArgs | ExpressRouteCircuitPeeringState, opts?: kulado.CustomResourceOptions) {
        ...
        super(ExpressRouteCircuitPeering.__kuladoType, name, inputs, opts);
    }
}
...
export interface ExpressRouteCircuitPeeringState {
     ...
     * The ASN used by Azure.
     */
    readonly azureAsn?: kulado.Input<number>;
    /**
     * The name of the ExpressRoute Circuit in which to create the Peering.
     */
    readonly expressRouteCircuitName?: kulado.Input<string>;
    /**
     * A `microsoft_peering_config` block as defined below. Required when `peering_type` is set to `MicrosoftPeering`.
     */
    readonly microsoftPeeringConfig?: kulado.Input<{ advertisedPublicPrefixes: kulado.Input<kulado.Input<string>[]> }>;
    /**
     * The Either a 16-bit or a 32-bit ASN. Can either be public or private..
     */
    readonly peerAsn?: kulado.Input<number>;
    /**
     * The type of the ExpressRoute Circuit Peering. Acceptable values include `AzurePrivatePeering`, `AzurePublicPeering` and `MicrosoftPeering`. Changing this forces a new resource to be created.
     */
    readonly peeringType?: kulado.Input<string>;
    /**
     * The Primary Port used by Azure for this Peering.
     */
    readonly primaryAzurePort?: kulado.Input<string>;
    /**
     * A `/30` subnet for the primary link.
     */
    readonly primaryPeerAddressPrefix?: kulado.Input<string>;
    /**
     * The name of the resource group in which to
     * create the Express Route Circuit Peering. Changing this forces a new resource to be created.
     */
     ...
     * The Secondary Port used by Azure for this Peering.
     */
    readonly secondaryAzurePort?: kulado.Input<string>;
    /**
     * A `/30` subnet for the secondary link.
     */
    readonly secondaryPeerAddressPrefix?: kulado.Input<string>;
    /**
     * The shared key. Can be a maximum of 25 characters.
     */
     ...
     * A valid VLAN ID to establish this peering on.
     */
    readonly vlanId?: kulado.Input<number>;
}
