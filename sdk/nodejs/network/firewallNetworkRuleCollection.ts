 ...
 */
export class FirewallNetworkRuleCollection extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: FirewallNetworkRuleCollectionState, opts?: kulado.CustomResourceOptions): FirewallNetworkRuleCollection {
        return new FirewallNetworkRuleCollection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:network/firewallNetworkRuleCollection:FirewallNetworkRuleCollection';
    ...
    public static isInstance(obj: any): obj is FirewallNetworkRuleCollection {
        ...
        return obj['__kuladoType'] === FirewallNetworkRuleCollection.__kuladoType;
    }
     ...
     */
    public readonly rules!: kulado.Output<{ description?: string, destinationAddresses: string[], destinationPorts: string[], name: string, protocols: string[], sourceAddresses: string[] }[]>;
     ...
     */
    constructor(name: string, args: FirewallNetworkRuleCollectionArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: FirewallNetworkRuleCollectionArgs | FirewallNetworkRuleCollectionState, opts?: kulado.CustomResourceOptions) {
        ...
        super(FirewallNetworkRuleCollection.__kuladoType, name, inputs, opts);
    }
}
...
export interface FirewallNetworkRuleCollectionState {
     ...
     * One or more `rule` blocks as defined below.
     */
    readonly rules?: kulado.Input<kulado.Input<{ description?: kulado.Input<string>, destinationAddresses: kulado.Input<kulado.Input<string>[]>, destinationPorts: kulado.Input<kulado.Input<string>[]>, name: kulado.Input<string>, protocols: kulado.Input<kulado.Input<string>[]>, sourceAddresses: kulado.Input<kulado.Input<string>[]> }>[]>;
}
