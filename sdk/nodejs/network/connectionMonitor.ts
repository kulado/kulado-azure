 ...
 */
export class ConnectionMonitor extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ConnectionMonitorState, opts?: kulado.CustomResourceOptions): ConnectionMonitor {
        return new ConnectionMonitor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:network/connectionMonitor:ConnectionMonitor';
    ...
    public static isInstance(obj: any): obj is ConnectionMonitor {
        ...
        return obj['__kuladoType'] === ConnectionMonitor.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: ConnectionMonitorArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ConnectionMonitorArgs | ConnectionMonitorState, opts?: kulado.CustomResourceOptions) {
        ...
        super(ConnectionMonitor.__kuladoType, name, inputs, opts);
    }
}
