 ...
 */
export class PublicIpPrefix extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: PublicIpPrefixState, opts?: kulado.CustomResourceOptions): PublicIpPrefix {
        return new PublicIpPrefix(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:network/publicIpPrefix:PublicIpPrefix';
    ...
    public static isInstance(obj: any): obj is PublicIpPrefix {
        ...
        return obj['__kuladoType'] === PublicIpPrefix.__kuladoType;
    }

    /**
     * The IP address prefix value that was allocated.
     */
    public /*out*/ readonly ipPrefix!: kulado.Output<string>;
    /**
     ...
     */
    public readonly prefixLength!: kulado.Output<number | undefined>;
    /**
     ...
     */
    constructor(name: string, args: PublicIpPrefixArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: PublicIpPrefixArgs | PublicIpPrefixState, opts?: kulado.CustomResourceOptions) {
        ...
        super(PublicIpPrefix.__kuladoType, name, inputs, opts);
    }
}
...
export interface PublicIpPrefixState {
     ...
     * The IP address prefix value that was allocated.
     */
    readonly ipPrefix?: kulado.Input<string>;
    /**
     * Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
     */
     ...
     * Specifies the number of bits of the prefix. The value can be set between 24 (256 addresses) and 31 (2 addresses). Changing this forces a new resource to be created.
     */
    readonly prefixLength?: kulado.Input<number>;
    /**
     * The name of the resource group in which to create the public IP.
     */
