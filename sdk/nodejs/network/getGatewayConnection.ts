 ...
 * 
 * const test = kulado.output(azure.network.getGatewayConnection({
 *     name: "production",
 ...
 */
export function getGatewayConnection(args: GetGatewayConnectionArgs, opts?: kulado.InvokeOptions): Promise<GetGatewayConnectionResult> & GetGatewayConnectionResult {
    const promise: Promise<GetGatewayConnectionResult> = kulado.runtime.invoke("azure:network/getGatewayConnection:getGatewayConnection", {
        "name": args.name,
