 ...
 */
export class ApplicationSecurityGroup extends kulado.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: kulado.Input<kulado.ID>, state?: ApplicationSecurityGroupState, opts?: kulado.CustomResourceOptions): ApplicationSecurityGroup {
        return new ApplicationSecurityGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __kuladoType = 'azure:network/applicationSecurityGroup:ApplicationSecurityGroup';
    ...
    public static isInstance(obj: any): obj is ApplicationSecurityGroup {
        ...
        return obj['__kuladoType'] === ApplicationSecurityGroup.__kuladoType;
    }
     ...
     */
    constructor(name: string, args: ApplicationSecurityGroupArgs, opts?: kulado.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApplicationSecurityGroupArgs | ApplicationSecurityGroupState, opts?: kulado.CustomResourceOptions) {
        ...
        super(ApplicationSecurityGroup.__kuladoType, name, inputs, opts);
    }
}
