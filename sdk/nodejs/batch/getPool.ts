 ...
 * 
 * const test = kulado.output(azure.batch.getPool({
 ...
 */
export function getPool(args: GetPoolArgs, opts?: kulado.InvokeOptions): Promise<GetPoolResult> & GetPoolResult {
    const promise: Promise<GetPoolResult> = kulado.runtime.invoke("azure:batch/getPool:getPool", {
