...
class Account(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, location=None, name=None, resource_group_name=None, storage_accounts=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] name: Specifies the name of the Media Services Account. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the Media Services Account. Changing this forces a new resource to be created.
        :param kulado.Input[list] storage_accounts: One or more `storage_account` blocks as defined below.
