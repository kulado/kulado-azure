...
class Factory(kulado.CustomResource):
    github_configuration: kulado.Output[dict]
    """
    ...
    """
    vsts_configuration: kulado.Output[dict]
    """
    ...
    def __init__(__self__, resource_name, opts=None, github_configuration=None, identity=None, location=None, name=None, resource_group_name=None, tags=None, vsts_configuration=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[dict] github_configuration: A `github_configuration` block as defined below.
        ...
        :param kulado.Input[str] name: Specifies the name of the Data Factory. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the Data Factory.
        :param kulado.Input[dict] tags: A mapping of tags to assign to the resource.
        :param kulado.Input[dict] vsts_configuration: A `vsts_configuration` block as defined below.
