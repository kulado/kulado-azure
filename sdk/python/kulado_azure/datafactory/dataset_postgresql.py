...
class DatasetPostgresql(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, additional_properties=None, annotations=None, data_factory_name=None, description=None, folder=None, linked_service_name=None, name=None, parameters=None, resource_group_name=None, schema_columns=None, table_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[dict] additional_properties: A map of additional properties to associate with the Data Factory Dataset PostgreSQL.
        :param kulado.Input[list] annotations: List of tags that can be used for describing the Data Factory Dataset PostgreSQL.
        ...
        :param kulado.Input[str] description: The description for the Data Factory Dataset PostgreSQL.
        ...
        :param kulado.Input[str] name: Specifies the name of the Data Factory Dataset PostgreSQL. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
        :param kulado.Input[dict] parameters: A map of parameters to associate with the Data Factory Dataset PostgreSQL.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the Data Factory Dataset PostgreSQL. Changing this forces a new resource
        :param kulado.Input[list] schema_columns: A `schema_column` block as defined below.
        :param kulado.Input[str] table_name: The table name of the Data Factory Dataset PostgreSQL.
