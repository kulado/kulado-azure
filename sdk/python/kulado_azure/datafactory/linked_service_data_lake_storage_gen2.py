...
class LinkedServiceDataLakeStorageGen2(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, additional_properties=None, annotations=None, data_factory_name=None, description=None, integration_runtime_name=None, name=None, parameters=None, resource_group_name=None, service_principal_id=None, service_principal_key=None, tenant=None, url=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] service_principal_id: The service principal id in which to authenticate against the Azure Data Lake Storage Gen2 account.
        :param kulado.Input[str] service_principal_key: The service principal key in which to authenticate against the Azure Data Lake Storage Gen2 account.
        :param kulado.Input[str] tenant: The tenant id or name in which to authenticate against the Azure Data Lake Storage Gen2 account.
        :param kulado.Input[str] url: The endpoint for the Azure Data Lake Storage Gen2 service.
