...
class Pipeline(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, annotations=None, data_factory_name=None, description=None, name=None, parameters=None, resource_group_name=None, variables=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[list] annotations: List of tags that can be used for describing the Data Factory Pipeline.
        :param kulado.Input[str] data_factory_name: The Data Factory name in which to associate the Pipeline with. Changing this forces a new resource.
        :param kulado.Input[str] description: The description for the Data Factory Pipeline.
        :param kulado.Input[str] name: Specifies the name of the Data Factory Pipeline. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
        :param kulado.Input[dict] parameters: A map of parameters to associate with the Data Factory Pipeline.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the Data Factory Pipeline. Changing this forces a new resource
        :param kulado.Input[dict] variables: A map of variables to associate with the Data Factory Pipeline.
