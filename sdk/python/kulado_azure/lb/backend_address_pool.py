...
class BackendAddressPool(kulado.CustomResource):
    backend_ip_configurations: kulado.Output[list]
    """
    The Backend IP Configurations associated with this Backend Address Pool.
    """
    load_balancing_rules: kulado.Output[list]
    """
    ...
    def __init__(__self__, resource_name, opts=None, loadbalancer_id=None, location=None, name=None, resource_group_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] loadbalancer_id: The ID of the Load Balancer in which to create the Backend Address Pool.
        :param kulado.Input[str] name: Specifies the name of the Backend Address Pool.
