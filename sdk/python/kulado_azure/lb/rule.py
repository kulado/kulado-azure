...
class Rule(kulado.CustomResource):
    backend_address_pool_id: kulado.Output[str]
    """
    ...
    """
    disable_outbound_snat: kulado.Output[bool]
    """
    Indicates whether outbound snat is disabled or enabled. Default false.
    """
    enable_floating_ip: kulado.Output[bool]
    """
    ...
    """
    frontend_port: kulado.Output[float]
    """
    The port for the external endpoint. Port numbers for each Rule must be unique within the Load Balancer. Possible values range between 0 and 65534, inclusive.
    """
    idle_timeout_in_minutes: kulado.Output[float]
    """
    ...
    """
    load_distribution: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, backend_address_pool_id=None, backend_port=None, disable_outbound_snat=None, enable_floating_ip=None, frontend_ip_configuration_name=None, frontend_port=None, idle_timeout_in_minutes=None, load_distribution=None, loadbalancer_id=None, location=None, name=None, probe_id=None, protocol=None, resource_group_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] backend_address_pool_id: A reference to a Backend Address Pool over which this Load Balancing Rule operates.
        :param kulado.Input[float] backend_port: The port used for internal connections on the endpoint. Possible values range between 0 and 65535, inclusive.
        :param kulado.Input[bool] disable_outbound_snat: Indicates whether outbound snat is disabled or enabled. Default false.
        :param kulado.Input[bool] enable_floating_ip: Floating IP is pertinent to failover scenarios: a "floating” IP is reassigned to a secondary server in case the primary server fails. Floating IP is required for SQL AlwaysOn.
        :param kulado.Input[str] frontend_ip_configuration_name: The name of the frontend IP configuration to which the rule is associated.
        :param kulado.Input[float] frontend_port: The port for the external endpoint. Port numbers for each Rule must be unique within the Load Balancer. Possible values range between 0 and 65534, inclusive.
        :param kulado.Input[float] idle_timeout_in_minutes: Specifies the timeout for the Tcp idle connection. The value can be set between 4 and 30 minutes. The default value is 4 minutes. This element is only used when the protocol is set to Tcp.
        :param kulado.Input[str] load_distribution: Specifies the load balancing distribution type to be used by the Load Balancer. Possible values are: `Default` – The load balancer is configured to use a 5 tuple hash to map traffic to available servers. `SourceIP` – The load balancer is configured to use a 2 tuple hash to map traffic to available servers. `SourceIPProtocol` – The load balancer is configured to use a 3 tuple hash to map traffic to available servers. Also known as Session Persistence, where  the options are called `None`, `Client IP` and `Client IP and Protocol` respectively.
        :param kulado.Input[str] loadbalancer_id: The ID of the Load Balancer in which to create the Rule.
        :param kulado.Input[str] name: Specifies the name of the LB Rule.
        :param kulado.Input[str] probe_id: A reference to a Probe used by this Load Balancing Rule.
        :param kulado.Input[str] protocol: The transport protocol for the external endpoint. Possible values are `Tcp`, `Udp` or `All`.
