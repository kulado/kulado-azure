...
class NatRule(kulado.CustomResource):
    backend_ip_configuration_id: kulado.Output[str]
    ...
    def __init__(__self__, resource_name, opts=None, backend_port=None, enable_floating_ip=None, frontend_ip_configuration_name=None, frontend_port=None, loadbalancer_id=None, location=None, name=None, protocol=None, resource_group_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[float] backend_port: The port used for internal connections on the endpoint. Possible values range between 1 and 65535, inclusive.
        :param kulado.Input[bool] enable_floating_ip: Enables the Floating IP Capacity, required to configure a SQL AlwaysOn Availability Group.
        :param kulado.Input[str] frontend_ip_configuration_name: The name of the frontend IP configuration exposing this rule.
        :param kulado.Input[float] frontend_port: The port for the external endpoint. Port numbers for each Rule must be unique within the Load Balancer. Possible values range between 1 and 65534, inclusive.
        :param kulado.Input[str] loadbalancer_id: The ID of the Load Balancer in which to create the NAT Rule.
        :param kulado.Input[str] name: Specifies the name of the NAT Rule.
