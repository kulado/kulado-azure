...
class LoadBalancer(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, frontend_ip_configurations=None, location=None, name=None, resource_group_name=None, sku=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[list] frontend_ip_configurations: One or multiple `frontend_ip_configuration` blocks as documented below.
        :param kulado.Input[str] location: Specifies the supported Azure Region where the Load Balancer should be created.
        :param kulado.Input[str] name: Specifies the name of the frontend ip configuration.
        :param kulado.Input[str] resource_group_name: The name of the Resource Group in which to create the Load Balancer.
        :param kulado.Input[str] sku: The SKU of the Azure Load Balancer. Accepted values are `Basic` and `Standard`. Defaults to `Basic`.
