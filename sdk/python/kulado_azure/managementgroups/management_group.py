...
class ManagementGroup(kulado.CustomResource):
    ...
    """
    parent_management_group_id: kulado.Output[str]
    """
    The ID of the Parent Management Group. Changing this forces a new resource to be created.
    """
    subscription_ids: kulado.Output[list]
    """
    ...
    def __init__(__self__, resource_name, opts=None, display_name=None, group_id=None, parent_management_group_id=None, subscription_ids=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] display_name: A friendly name for this Management Group. If not specified, this'll be the same as the `group_id`.
        :param kulado.Input[str] group_id: The UUID for this Management Group, which needs to be unique across your tenant - which will be generated if not provided. Changing this forces a new resource to be created.
        :param kulado.Input[str] parent_management_group_id: The ID of the Parent Management Group. Changing this forces a new resource to be created.
        :param kulado.Input[list] subscription_ids: A list of Subscription GUIDs which should be assigned to the Management Group.
