...
class PtrRecord(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, records=None, resource_group_name=None, tags=None, ttl=None, zone_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] name: The name of the DNS PTR Record.
        :param kulado.Input[list] records: List of Fully Qualified Domain Names.
