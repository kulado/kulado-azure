...
class StreamInputIotHub(kulado.CustomResource):
    endpoint: kulado.Output[str]
    """
    The IoT Hub endpoint to connect to (ie. messages/events, messages/operationsMonitoringEvents, etc.).
    """
    eventhub_consumer_group_name: kulado.Output[str]
    """
    The name of an Event Hub Consumer Group that should be used to read events from the Event Hub. Specifying distinct consumer group names for multiple inputs allows each of those inputs to receive the same events from the Event Hub.
    """
    iothub_namespace: kulado.Output[str]
    """
    ...
    """
    shared_access_policy_key: kulado.Output[str]
    """
    The shared access policy key for the specified shared access policy.
    """
    shared_access_policy_name: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, endpoint=None, eventhub_consumer_group_name=None, iothub_namespace=None, name=None, resource_group_name=None, serialization=None, shared_access_policy_key=None, shared_access_policy_name=None, stream_analytics_job_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] endpoint: The IoT Hub endpoint to connect to (ie. messages/events, messages/operationsMonitoringEvents, etc.).
        :param kulado.Input[str] eventhub_consumer_group_name: The name of an Event Hub Consumer Group that should be used to read events from the Event Hub. Specifying distinct consumer group names for multiple inputs allows each of those inputs to receive the same events from the Event Hub.
        :param kulado.Input[str] iothub_namespace: The name or the URI of the IoT Hub.
        :param kulado.Input[str] name: The name of the Stream Input IoTHub. Changing this forces a new resource to be created.
        ...
        :param kulado.Input[str] shared_access_policy_key: The shared access policy key for the specified shared access policy.
        :param kulado.Input[str] shared_access_policy_name: The shared access policy name for the Event Hub, Service Bus Queue, Service Bus Topic, etc.
