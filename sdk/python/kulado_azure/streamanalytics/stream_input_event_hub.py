...
class StreamInputEventHub(kulado.CustomResource):
    ...
    """
    servicebus_namespace: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, eventhub_consumer_group_name=None, eventhub_name=None, name=None, resource_group_name=None, serialization=None, servicebus_namespace=None, shared_access_policy_key=None, shared_access_policy_name=None, stream_analytics_job_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] eventhub_name: The name of the Event Hub.
        :param kulado.Input[str] name: The name of the Stream Input EventHub. Changing this forces a new resource to be created.
        ...
        :param kulado.Input[str] servicebus_namespace: The namespace that is associated with the desired Event Hub, Service Bus Queue, Service Bus Topic, etc.
