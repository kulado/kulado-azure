...
class EventHub(kulado.CustomResource):
    capture_description: kulado.Output[dict]
    """
    A `capture_description` block as defined below.
    """
    location: kulado.Output[str]
    message_retention: kulado.Output[float]
    """
    ...
    def __init__(__self__, resource_name, opts=None, capture_description=None, location=None, message_retention=None, name=None, namespace_name=None, partition_count=None, resource_group_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[dict] capture_description: A `capture_description` block as defined below.
        :param kulado.Input[float] message_retention: Specifies the number of days to retain the events for this Event Hub. Needs to be between 1 and 7 days; or 1 day when using a Basic SKU for the parent EventHub Namespace.
        ...
        :param kulado.Input[str] namespace_name: Specifies the name of the EventHub Namespace. Changing this forces a new resource to be created.
        :param kulado.Input[float] partition_count: Specifies the current number of shards on the Event Hub. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which the EventHub's parent Namespace exists. Changing this forces a new resource to be created.
