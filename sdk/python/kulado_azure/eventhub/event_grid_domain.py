...
class EventGridDomain(kulado.CustomResource):
    endpoint: kulado.Output[str]
    """
    The Endpoint associated with the EventGrid Domain.
    """
    input_mapping_default_values: kulado.Output[dict]
    """
    A `input_mapping_default_values` block as defined below.
    """
    input_mapping_fields: kulado.Output[dict]
    """
    A `input_mapping_fields` block as defined below.
    """
    input_schema: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, input_mapping_default_values=None, input_mapping_fields=None, input_schema=None, location=None, name=None, resource_group_name=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[dict] input_mapping_default_values: A `input_mapping_default_values` block as defined below.
        :param kulado.Input[dict] input_mapping_fields: A `input_mapping_fields` block as defined below.
        :param kulado.Input[str] input_schema: Specifies the schema in which incoming events will be published to this domain. Allowed values are `cloudeventv01schema`, `customeventschema`, or `eventgridschema`. Defaults to `eventgridschema`. Changing this forces a new resource to be created.
        ...
        :param kulado.Input[str] name: Specifies the name of the EventGrid Domain resource. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which the EventGrid Domain exists. Changing this forces a new resource to be created.
