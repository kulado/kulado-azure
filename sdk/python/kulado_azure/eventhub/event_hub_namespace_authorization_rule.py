...
class EventHubNamespaceAuthorizationRule(kulado.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, listen=None, location=None, manage=None, name=None, namespace_name=None, resource_group_name=None, send=None, __name__=None, __opts__=None):
        """
