...
class CustomHostnameBinding(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, app_service_name=None, hostname=None, resource_group_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] app_service_name: The name of the App Service in which to add the Custom Hostname Binding. Changing this forces a new resource to be created.
        :param kulado.Input[str] hostname: Specifies the Custom Hostname to use for the App Service, example `www.example.com`. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which the App Service exists. Changing this forces a new resource to be created.
