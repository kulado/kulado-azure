...
class Zone(kulado.CustomResource):
    ...
    """
    max_number_of_virtual_network_links: kulado.Output[float]
    """
    The maximum number of virtual networks that can be linked to this Private DNS zone.
    """
    max_number_of_virtual_network_links_with_registration: kulado.Output[float]
    """
    ...
    def __init__(__self__, resource_name, opts=None, name=None, resource_group_name=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] name: The name of the Private DNS Zone. Must be a valid domain name.
