...
class Provider(kulado.ProviderResource):
    def __init__(__self__, resource_name, opts=None, client_certificate_password=None, client_certificate_path=None, client_id=None, client_secret=None, environment=None, msi_endpoint=None, partner_id=None, skip_credentials_validation=None, skip_provider_registration=None, subscription_id=None, tenant_id=None, use_msi=None, __name__=None, __opts__=None):
        ...
        __props__['skip_credentials_validation'] = kulado.Output.from_input(skip_credentials_validation).apply(json.dumps) if skip_credentials_validation is not None else None
        ...
        __props__['skip_provider_registration'] = kulado.Output.from_input(skip_provider_registration).apply(json.dumps) if skip_provider_registration is not None else None
        ...
        __props__['use_msi'] = kulado.Output.from_input(use_msi).apply(json.dumps) if use_msi is not None else None
