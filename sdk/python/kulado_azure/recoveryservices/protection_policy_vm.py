...
class ProtectionPolicyVM(kulado.CustomResource):
    backup: kulado.Output[dict]
    """
    ...
    """
    retention_daily: kulado.Output[dict]
    """
    Configures the policy daily retention as documented in the `retention_daily` block below. Required when backup frequency is `Daily`.
    """
    retention_monthly: kulado.Output[dict]
    """
    Configures the policy monthly retention as documented in the `retention_monthly` block below.
    """
    retention_weekly: kulado.Output[dict]
    """
    Configures the policy weekly retention as documented in the `retention_weekly` block below. Required when backup frequency is `Weekly`.
    """
    retention_yearly: kulado.Output[dict]
    """
    ...
    def __init__(__self__, resource_name, opts=None, backup=None, name=None, recovery_vault_name=None, resource_group_name=None, retention_daily=None, retention_monthly=None, retention_weekly=None, retention_yearly=None, tags=None, timezone=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[dict] backup: Configures the Policy backup frequecent, times & days as documented in the `backup` block below. 
        :param kulado.Input[str] name: Specifies the name of the Recovery Services Vault Policy. Changing this forces a new resource to be created.
        ...
        :param kulado.Input[dict] retention_daily: Configures the policy daily retention as documented in the `retention_daily` block below. Required when backup frequency is `Daily`.
        :param kulado.Input[dict] retention_monthly: Configures the policy monthly retention as documented in the `retention_monthly` block below.
        :param kulado.Input[dict] retention_weekly: Configures the policy weekly retention as documented in the `retention_weekly` block below. Required when backup frequency is `Weekly`.
        :param kulado.Input[dict] retention_yearly: Configures the policy yearly retention as documented in the `retention_yearly` block below.
        :param kulado.Input[dict] tags: A mapping of tags to assign to the resource.
        :param kulado.Input[str] timezone: Specifies the timezone. Defaults to `UTC`
