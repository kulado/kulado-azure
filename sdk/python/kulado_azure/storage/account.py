...
class Account(kulado.CustomResource):
    ...
    """
    account_kind: kulado.Output[str]
    """
    ...
    """
    account_type: kulado.Output[str]
    custom_domain: kulado.Output[dict]
    """
    A `custom_domain` block as documented below.
    """
    enable_blob_encryption: kulado.Output[bool]
    """
    ...
    """
    enable_file_encryption: kulado.Output[bool]
    """
    ...
    """
    enable_https_traffic_only: kulado.Output[bool]
    """
    ...
    """
    is_hns_enabled: kulado.Output[bool]
    """
    ...
    """
    network_rules: kulado.Output[dict]
    """
    ...
    """
    primary_blob_connection_string: kulado.Output[str]
    """
    The connection string associated with the primary blob location.
    """
    primary_blob_endpoint: kulado.Output[str]
    """
    The endpoint URL for blob storage in the primary location.
    """
    primary_blob_host: kulado.Output[str]
    """
    ...
    """
    primary_dfs_endpoint: kulado.Output[str]
    """
    The endpoint URL for DFS storage in the primary location.
    """
    primary_dfs_host: kulado.Output[str]
    """
    The hostname with port if applicable for DFS storage in the primary location.
    """
    primary_file_endpoint: kulado.Output[str]
    """
    The endpoint URL for file storage in the primary location.
    """
    primary_file_host: kulado.Output[str]
    """
    The hostname with port if applicable for file storage in the primary location.
    """
    primary_location: kulado.Output[str]
    """
    The primary location of the storage account.
    """
    primary_queue_endpoint: kulado.Output[str]
    """
    The endpoint URL for queue storage in the primary location.
    """
    primary_queue_host: kulado.Output[str]
    """
    The hostname with port if applicable for queue storage in the primary location.
    """
    primary_table_endpoint: kulado.Output[str]
    """
    The endpoint URL for table storage in the primary location.
    """
    primary_table_host: kulado.Output[str]
    """
    The hostname with port if applicable for table storage in the primary location.
    """
    primary_web_endpoint: kulado.Output[str]
    """
    The endpoint URL for web storage in the primary location.
    """
    primary_web_host: kulado.Output[str]
    """
    ...
    """
    secondary_blob_connection_string: kulado.Output[str]
    """
    The connection string associated with the secondary blob location.
    """
    secondary_blob_endpoint: kulado.Output[str]
    """
    The endpoint URL for blob storage in the secondary location.
    """
    secondary_blob_host: kulado.Output[str]
    """
    ...
    """
    secondary_dfs_endpoint: kulado.Output[str]
    """
    The endpoint URL for DFS storage in the secondary location.
    """
    secondary_dfs_host: kulado.Output[str]
    """
    The hostname with port if applicable for DFS storage in the secondary location.
    """
    secondary_file_endpoint: kulado.Output[str]
    """
    The endpoint URL for file storage in the secondary location.
    """
    secondary_file_host: kulado.Output[str]
    """
    The hostname with port if applicable for file storage in the secondary location.
    """
    secondary_location: kulado.Output[str]
    """
    The secondary location of the storage account.
    """
    secondary_queue_endpoint: kulado.Output[str]
    """
    The endpoint URL for queue storage in the secondary location.
    """
    secondary_queue_host: kulado.Output[str]
    """
    The hostname with port if applicable for queue storage in the secondary location.
    """
    secondary_table_endpoint: kulado.Output[str]
    """
    The endpoint URL for table storage in the secondary location.
    """
    secondary_table_host: kulado.Output[str]
    """
    The hostname with port if applicable for table storage in the secondary location.
    """
    secondary_web_endpoint: kulado.Output[str]
    """
    The endpoint URL for web storage in the secondary location.
    """
    secondary_web_host: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, access_tier=None, account_encryption_source=None, account_kind=None, account_replication_type=None, account_tier=None, account_type=None, custom_domain=None, enable_blob_encryption=None, enable_file_encryption=None, enable_https_traffic_only=None, identity=None, is_hns_enabled=None, location=None, name=None, network_rules=None, resource_group_name=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] access_tier: Defines the access tier for `BlobStorage` and `StorageV2` accounts. Valid options are `Hot` and `Cool`, defaults to `Hot`.
        :param kulado.Input[str] account_encryption_source: The Encryption Source for this Storage Account. Possible values are `Microsoft.Keyvault` and `Microsoft.Storage`. Defaults to `Microsoft.Storage`.
        :param kulado.Input[str] account_kind: Defines the Kind of account. Valid options are `Storage`,
               `StorageV2` and `BlobStorage`. Changing this forces a new resource to be created.
               Defaults to `Storage`.
        :param kulado.Input[str] account_replication_type: Defines the type of replication to use for this storage account. Valid options are `LRS`, `GRS`, `RAGRS` and `ZRS`.
        :param kulado.Input[str] account_tier: Defines the Tier to use for this storage account. Valid options are `Standard` and `Premium`. Changing this forces a new resource to be created
        :param kulado.Input[dict] custom_domain: A `custom_domain` block as documented below.
        :param kulado.Input[bool] enable_blob_encryption: Boolean flag which controls if Encryption Services are enabled for Blob storage, see [here](https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/) for more information. Defaults to `true`.
        :param kulado.Input[bool] enable_file_encryption: Boolean flag which controls if Encryption Services are enabled for File storage, see [here](https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/) for more information. Defaults to `true`.
        :param kulado.Input[bool] enable_https_traffic_only: Boolean flag which forces HTTPS if enabled, see [here](https://docs.microsoft.com/en-us/azure/storage/storage-require-secure-transfer/)
               for more information.
        :param kulado.Input[dict] identity: A Managed Service Identity block as defined below.
        :param kulado.Input[bool] is_hns_enabled: Is Hierarchical Namespace enabled? This can be used with Azure Data Lake Storage Gen 2 ([see here for more information](https://docs.microsoft.com/en-us/azure/storage/blobs/data-lake-storage-quickstart-create-account/)). Changing this forces a new resource to be created.
        :param kulado.Input[str] location: Specifies the supported Azure location where the
               resource exists. Changing this forces a new resource to be created.
        :param kulado.Input[str] name: The Custom Domain Name to use for the Storage Account, which will be validated by Azure.
        :param kulado.Input[dict] network_rules: A `network_rules` block as documented below.
