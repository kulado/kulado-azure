...
class Container(kulado.CustomResource):
    container_access_type: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, container_access_type=None, name=None, resource_group_name=None, storage_account_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] container_access_type: The 'interface' for access the container provides. Can be either `blob`, `container` or `private`. Defaults to `private`.
        :param kulado.Input[str] name: The name of the storage container. Must be unique within the storage service the container is located.
