...
class Share(kulado.CustomResource):
    name: kulado.Output[str]
    """
    The name of the share. Must be unique within the storage account where the share is located.
    """
    quota: kulado.Output[float]
    """
    ...
    def __init__(__self__, resource_name, opts=None, name=None, quota=None, resource_group_name=None, storage_account_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] name: The name of the share. Must be unique within the storage account where the share is located.
        :param kulado.Input[float] quota: The maximum size of the share, in gigabytes. Must be greater than 0, and less than or equal to 5 TB (5120 GB). Default is 5120.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to
               create the share. Changing this forces a new resource to be created.
        :param kulado.Input[str] storage_account_name: Specifies the storage account in which to create the share.
               Changing this forces a new resource to be created.
