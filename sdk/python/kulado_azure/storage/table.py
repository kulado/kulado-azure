...
class Table(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, resource_group_name=None, storage_account_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] name: The name of the storage table. Must be unique within the storage account the table is located.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to
               create the storage table. Changing this forces a new resource to be created.
        :param kulado.Input[str] storage_account_name: Specifies the storage account in which to create the storage table.
               Changing this forces a new resource to be created.
