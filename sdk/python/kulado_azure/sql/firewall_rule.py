...
class FirewallRule(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, end_ip_address=None, name=None, resource_group_name=None, server_name=None, start_ip_address=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] end_ip_address: The ending IP address to allow through the firewall for this rule.
        :param kulado.Input[str] name: The name of the firewall rule.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to
               create the sql server.
        :param kulado.Input[str] server_name: The name of the SQL Server on which to create the Firewall Rule.
        :param kulado.Input[str] start_ip_address: The starting IP address to allow through the firewall for this rule.
