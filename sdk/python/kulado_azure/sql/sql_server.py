...
class SqlServer(kulado.CustomResource):
    ...
    """
    fully_qualified_domain_name: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, administrator_login=None, administrator_login_password=None, location=None, name=None, resource_group_name=None, tags=None, version=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] administrator_login: The administrator login name for the new server. Changing this forces a new resource to be created.
        :param kulado.Input[str] administrator_login_password: The password associated with the `administrator_login` user. Needs to comply with Azure's [Password Policy](https://msdn.microsoft.com/library/ms161959.aspx)
        ...
        :param kulado.Input[str] name: The name of the SQL Server. This needs to be globally unique within Azure.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the SQL Server.
        :param kulado.Input[dict] tags: A mapping of tags to assign to the resource.
        :param kulado.Input[str] version: The version for the new server. Valid values are: 2.0 (for v11 server) and 12.0 (for v12 server).
