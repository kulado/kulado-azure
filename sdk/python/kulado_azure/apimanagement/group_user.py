...
class GroupUser(kulado.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, api_management_name=None, group_name=None, resource_group_name=None, user_id=None, __name__=None, __opts__=None):
        """
        ...
        :param kulado.Input[str] user_id: The ID of the API Management User which should be assigned to this API Management Group. Changing this forces a new resource to be created.
