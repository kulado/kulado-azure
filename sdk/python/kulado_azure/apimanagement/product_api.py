...
class ProductApi(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, api_management_name=None, api_name=None, product_id=None, resource_group_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] api_name: The Name of the API Management API within the API Management Service. Changing this forces a new resource to be created.
