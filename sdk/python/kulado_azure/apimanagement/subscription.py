...
class Subscription(kulado.CustomResource):
    ...
    """
    subscription_id: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, api_management_name=None, display_name=None, primary_key=None, product_id=None, resource_group_name=None, secondary_key=None, state=None, subscription_id=None, user_id=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] api_management_name: The name of the API Management Service where this Subscription should be created. Changing this forces a new resource to be created.
        :param kulado.Input[str] display_name: The display name of this Subscription.
        :param kulado.Input[str] product_id: The ID of the Product which should be assigned to this Subscription. Changing this forces a new resource to be created.
        ...
        :param kulado.Input[str] state: The state of this Subscription. Possible values are `Active`, `Cancelled`, `Expired`, `Rejected`, `Submitted` and `Suspended`. Defaults to `Submitted`.
        :param kulado.Input[str] subscription_id: An Identifier which should used as the ID of this Subscription. If not specified a new Subscription ID will be generated. Changing this forces a new resource to be created.
        :param kulado.Input[str] user_id: The ID of the User which should be assigned to this Subscription. Changing this forces a new resource to be created.
