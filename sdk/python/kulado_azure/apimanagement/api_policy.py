...
class ApiPolicy(kulado.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, api_management_name=None, api_name=None, resource_group_name=None, xml_content=None, xml_link=None, __name__=None, __opts__=None):
        """
        ...
        :param kulado.Input[str] api_name: The ID of the API Management API within the API Management Service. Changing this forces a new resource to be created.
