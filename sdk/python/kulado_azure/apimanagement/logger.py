...
class Logger(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, api_management_name=None, application_insights=None, buffered=None, description=None, eventhub=None, name=None, resource_group_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[dict] application_insights: An `application_insights` block as documented below.
        :param kulado.Input[bool] buffered: Specifies whether records should be buffered in the Logger prior to publishing. Defaults to `true`.
        :param kulado.Input[str] description: A description of this Logger.
        :param kulado.Input[dict] eventhub: An `eventhub` block as documented below.
        :param kulado.Input[str] name: The name of this Logger, which must be unique within the API Management Service. Changing this forces a new resource to be created.
