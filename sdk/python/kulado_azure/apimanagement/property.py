...
class Property(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, api_management_name=None, display_name=None, name=None, resource_group_name=None, secret=None, tags=None, value=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] api_management_name: The name of the API Management Service in which the API Management Property should exist. Changing this forces a new resource to be created.
        :param kulado.Input[str] display_name: The display name of this API Management Property.
        :param kulado.Input[str] name: The name of the API Management Property. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the Resource Group in which the API Management Property should exist. Changing this forces a new resource to be created.
        :param kulado.Input[bool] secret: Specifies whether the API Management Property is secret. Valid values are `true` or `false`. The default value is `false`.
        :param kulado.Input[list] tags: A list of tags to be applied to the API Management Property.
        :param kulado.Input[str] value: The value of this API Management Property.
