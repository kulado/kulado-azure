...
class Configuration(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, resource_group_name=None, server_name=None, value=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] name: Specifies the name of the MySQL Configuration, which needs [to be a valid MySQL configuration name](https://dev.mysql.com/doc/refman/5.7/en/server-configuration.html). Changing this forces a new resource to be created.
        ...
        :param kulado.Input[str] value: Specifies the value of the MySQL Configuration. See the MySQL documentation for valid values.
