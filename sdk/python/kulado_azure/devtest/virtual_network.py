...
class VirtualNetwork(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, description=None, lab_name=None, name=None, resource_group_name=None, subnet=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] description: A description for the Virtual Network.
        :param kulado.Input[str] lab_name: Specifies the name of the Dev Test Lab in which the Virtual Network should be created. Changing this forces a new resource to be created.
        :param kulado.Input[str] name: Specifies the name of the Dev Test Virtual Network. Changing this forces a new resource to be created.
        ...
        :param kulado.Input[dict] subnet: A `subnet` block as defined below.
