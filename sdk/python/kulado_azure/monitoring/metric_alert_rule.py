...
class MetricAlertRule(kulado.CustomResource):
    aggregation: kulado.Output[str]
    """
    ...
    """
    email_action: kulado.Output[dict]
    """
    ...
    """
    threshold: kulado.Output[float]
    """
    The threshold value that activates the alert.
    """
    webhook_action: kulado.Output[dict]
    """
    ...
    def __init__(__self__, resource_name, opts=None, aggregation=None, description=None, email_action=None, enabled=None, location=None, metric_name=None, name=None, operator=None, period=None, resource_group_name=None, resource_id=None, tags=None, threshold=None, webhook_action=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] aggregation: Defines how the metric data is combined over time. Possible values are `Average`, `Minimum`, `Maximum`, `Total`, and `Last`.
        :param kulado.Input[str] description: A verbose description of the alert rule that will be included in the alert email.
        :param kulado.Input[dict] email_action: A `email_action` block as defined below.
        :param kulado.Input[bool] enabled: If `true`, the alert rule is enabled. Defaults to `true`.
        ...
        :param kulado.Input[str] metric_name: The metric that defines what the rule monitors.
        :param kulado.Input[str] name: Specifies the name of the alert rule. Changing this forces a new resource to be created.
        :param kulado.Input[str] operator: The operator used to compare the metric data and the threshold. Possible values are `GreaterThan`, `GreaterThanOrEqual`, `LessThan`, and `LessThanOrEqual`.
        :param kulado.Input[str] period: The period of time formatted in [ISO 8601 duration format](https://en.wikipedia.org/wiki/ISO_8601#Durations) that is used to monitor the alert activity based on the threshold. The period must be between 5 minutes and 1 day.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the alert rule. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_id: The ID of the resource monitored by the alert rule.
        ...
        :param kulado.Input[float] threshold: The threshold value that activates the alert.
        :param kulado.Input[dict] webhook_action: A `webhook_action` block as defined below.
