...
class LogProfile(kulado.CustomResource):
    categories: kulado.Output[list]
    """
    List of categories of the logs.
    """
    locations: kulado.Output[list]
    """
    ...
    """
    retention_policy: kulado.Output[dict]
    """
    ...
    """
    servicebus_rule_id: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, categories=None, locations=None, name=None, retention_policy=None, servicebus_rule_id=None, storage_account_id=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[list] categories: List of categories of the logs.
        :param kulado.Input[list] locations: List of regions for which Activity Log events are stored or streamed.
        :param kulado.Input[str] name: The name of the Log Profile. Changing this forces a
               new resource to be created.
        :param kulado.Input[dict] retention_policy: A `retention_policy` block as documented below. A retention policy for how long Activity Logs are retained in the storage account.
        :param kulado.Input[str] servicebus_rule_id: The service bus (or event hub) rule ID of the service bus (or event hub) namespace in which the Activity Log is streamed to. At least one of `storage_account_id` or `servicebus_rule_id` must be set.
        :param kulado.Input[str] storage_account_id: The resource ID of the storage account in which the Activity Log is stored. At least one of `storage_account_id` or `servicebus_rule_id` must be set.
