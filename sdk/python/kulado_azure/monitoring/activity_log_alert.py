...
class ActivityLogAlert(kulado.CustomResource):
    actions: kulado.Output[list]
    """
    One or more `action` blocks as defined below.
    """
    criteria: kulado.Output[dict]
    """
    ...
    def __init__(__self__, resource_name, opts=None, actions=None, criteria=None, description=None, enabled=None, name=None, resource_group_name=None, scopes=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[dict] criteria: A `criteria` block as defined below.
        :param kulado.Input[str] description: The description of this activity log alert.
        :param kulado.Input[bool] enabled: Should this Activity Log Alert be enabled? Defaults to `true`.
        :param kulado.Input[str] name: The name of the activity log alert. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the activity log alert instance.
        :param kulado.Input[list] scopes: The Scope at which the Activity Log should be applied, for example a the Resource ID of a Subscription or a Resource (such as a Storage Account).
