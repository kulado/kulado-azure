...
class Registry(kulado.CustomResource):
    admin_enabled: kulado.Output[bool]
    """
    Specifies whether the admin user is enabled. Defaults to `false`.
    """
    admin_password: kulado.Output[str]
    """
    The Password associated with the Container Registry Admin account - if the admin account is enabled.
    """
    admin_username: kulado.Output[str]
    """
    The Username associated with the Container Registry Admin account - if the admin account is enabled.
    """
    georeplication_locations: kulado.Output[list]
    """
    ...
    """
    login_server: kulado.Output[str]
    """
    ...
    """
    storage_account: kulado.Output[dict]
    ...
    def __init__(__self__, resource_name, opts=None, admin_enabled=None, georeplication_locations=None, location=None, name=None, resource_group_name=None, sku=None, storage_account=None, storage_account_id=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[bool] admin_enabled: Specifies whether the admin user is enabled. Defaults to `false`.
        :param kulado.Input[list] georeplication_locations: A list of Azure locations where the container registry should be geo-replicated.
        ...
        :param kulado.Input[str] name: Specifies the name of the Container Registry. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the Container Registry. Changing this forces a new resource to be created.
        :param kulado.Input[str] sku: The SKU name of the the container registry. Possible values are `Classic` (which was previously `Basic`), `Basic`, `Standard` and `Premium`.
        :param kulado.Input[str] storage_account_id: The ID of a Storage Account which must be located in the same Azure Region as the Container Registry.
