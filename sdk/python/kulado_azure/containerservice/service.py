...
class Service(kulado.CustomResource):
    agent_pool_profile: kulado.Output[dict]
    """
    A Agent Pool Profile's block as documented below.
    """
    diagnostics_profile: kulado.Output[dict]
    """
    ...
    """
    master_profile: kulado.Output[dict]
    """
    ...
    """
    orchestration_platform: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, agent_pool_profile=None, diagnostics_profile=None, linux_profile=None, location=None, master_profile=None, name=None, orchestration_platform=None, resource_group_name=None, service_principal=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[dict] agent_pool_profile: A Agent Pool Profile's block as documented below.
        :param kulado.Input[dict] diagnostics_profile: A VM Diagnostics Profile block as documented below.
        :param kulado.Input[dict] linux_profile: A Linux Profile block as documented below.
        :param kulado.Input[str] location: The location where the Container Service instance should be created. Changing this forces a new resource to be created.
        :param kulado.Input[dict] master_profile: A Master Profile block as documented below.
        :param kulado.Input[str] name: Unique name of the agent pool profile in the context of the subscription and resource group.
        :param kulado.Input[str] orchestration_platform: Specifies the Container Orchestration Platform to use. Currently can be either `DCOS`, `Kubernetes` or `Swarm`. Changing this forces a new resource to be created.
        ...
        :param kulado.Input[dict] service_principal: A Service Principal block as documented below.
