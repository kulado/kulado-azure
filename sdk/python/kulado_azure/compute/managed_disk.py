...
class ManagedDisk(kulado.CustomResource):
    ...
    """
    image_reference_id: kulado.Output[str]
    """
    ...
    """
    storage_account_type: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, create_option=None, disk_size_gb=None, encryption_settings=None, image_reference_id=None, location=None, name=None, os_type=None, resource_group_name=None, source_resource_id=None, source_uri=None, storage_account_type=None, tags=None, zones=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] create_option: The method to use when creating the managed disk. Possible values include:
        :param kulado.Input[float] disk_size_gb: Specifies the size of the managed disk to create in gigabytes.
               If `create_option` is `Copy` or `FromImage`, then the value must be equal to or greater than the source's size.
        :param kulado.Input[dict] encryption_settings: an `encryption_settings` block as defined below.
        :param kulado.Input[str] image_reference_id: ID of an existing platform/marketplace disk image to copy when `create_option` is `FromImage`.
        :param kulado.Input[str] location: Specified the supported Azure location where the resource exists.
               Changing this forces a new resource to be created.
        :param kulado.Input[str] name: Specifies the name of the managed disk. Changing this forces a
               new resource to be created.
        :param kulado.Input[str] os_type: Specify a value when the source of an `Import` or `Copy`
               operation targets a source that contains an operating system. Valid values are `Linux` or `Windows`
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create
               the managed disk.
        :param kulado.Input[str] source_resource_id: ID of an existing managed disk to copy `create_option` is `Copy`
               or the recovery point to restore when `create_option` is `Restore`
        :param kulado.Input[str] source_uri: URI to a valid VHD file to be used when `create_option` is `Import`.
        :param kulado.Input[str] storage_account_type: The type of storage to use for the managed disk.
               Allowable values are `Standard_LRS`, `Premium_LRS`, `StandardSSD_LRS` or `UltraSSD_LRS`.
        :param kulado.Input[dict] tags: A mapping of tags to assign to the resource.
        :param kulado.Input[str] zones: A collection containing the availability zone to allocate the Managed Disk in.
