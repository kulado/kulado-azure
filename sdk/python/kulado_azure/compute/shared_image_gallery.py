...
class SharedImageGallery(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, description=None, location=None, name=None, resource_group_name=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] description: A description for this Shared Image Gallery.
        ...
        :param kulado.Input[str] name: Specifies the name of the Shared Image Gallery. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the Shared Image Gallery. Changing this forces a new resource to be created.
        :param kulado.Input[dict] tags: A mapping of tags to assign to the Shared Image Gallery.
