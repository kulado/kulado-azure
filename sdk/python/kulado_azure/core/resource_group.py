...
class ResourceGroup(kulado.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, location=None, name=None, tags=None, __name__=None, __opts__=None):
        """
        Manages a resource group on Azure.
        
        :param str resource_name: The name of the resource.
        :param kulado.ResourceOptions opts: Options for the resource.
        :param kulado.Input[str] location: The location where the resource group should be created.
               For a list of all Azure locations, please consult [this link](http://azure.microsoft.com/en-us/regions/) or run `az account list-locations --output table`.
        :param kulado.Input[str] name: The name of the resource group. Must be unique on your
               Azure subscription.
