...
class UserAssignedIdentity(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, location=None, name=None, resource_group_name=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] location: The location/region where the user assigned identity is
               created.
        :param kulado.Input[str] name: The name of the user assigned identity. Changing this forces a
               new identity to be created.
