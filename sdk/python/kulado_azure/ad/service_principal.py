...
class ServicePrincipal(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, application_id=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] application_id: The ID of the Azure AD Application for which to create a Service Principal.
