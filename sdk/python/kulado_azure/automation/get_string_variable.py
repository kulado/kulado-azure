...
async def get_string_variable(automation_account_name=None,name=None,resource_group_name=None,opts=None):
    """
    ...
    __ret__ = await kulado.runtime.invoke('azure:automation/getStringVariable:getStringVariable', __args__, opts=opts)
