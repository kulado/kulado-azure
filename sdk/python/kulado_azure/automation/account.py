...
class Account(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, location=None, name=None, resource_group_name=None, sku=None, sku_name=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] name: Specifies the name of the Automation Account. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which the Automation Account is created. Changing this forces a new resource to be created.
        :param kulado.Input[dict] sku: ) A `sku` block as described below.
        :param kulado.Input[str] sku_name: The SKU name of the account - only `Basic` is supported at this time.
