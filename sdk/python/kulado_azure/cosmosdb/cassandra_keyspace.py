...
class CassandraKeyspace(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, name=None, resource_group_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] account_name: The name of the Cosmos DB Cassandra KeySpace to create the table within. Changing this forces a new resource to be created.
        :param kulado.Input[str] name: Specifies the name of the Cosmos DB Cassandra KeySpace. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which the Cosmos DB Cassandra KeySpace is created. Changing this forces a new resource to be created.
