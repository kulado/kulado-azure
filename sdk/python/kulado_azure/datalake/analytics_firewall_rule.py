...
class AnalyticsFirewallRule(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, end_ip_address=None, name=None, resource_group_name=None, start_ip_address=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] account_name: Specifies the name of the Data Lake Analytics for which the Firewall Rule should take effect.
        :param kulado.Input[str] end_ip_address: The End IP Address for the firewall rule.
        :param kulado.Input[str] name: Specifies the name of the Data Lake Analytics. Changing this forces a new resource to be created. Has to be between 3 to 24 characters.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the Data Lake Analytics.
        :param kulado.Input[str] start_ip_address: The Start IP address for the firewall rule.
