...
class AnalyticsAccount(kulado.CustomResource):
    default_store_account_name: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, default_store_account_name=None, location=None, name=None, resource_group_name=None, tags=None, tier=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] default_store_account_name: Specifies the data lake store to use by default. Changing this forces a new resource to be created.
