...
class StoreFirewallRule(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, end_ip_address=None, name=None, resource_group_name=None, start_ip_address=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] account_name: Specifies the name of the Data Lake Store for which the Firewall Rule should take effect.
