...
class StoreFile(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, account_name=None, local_file_path=None, remote_file_path=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] account_name: Specifies the name of the Data Lake Store for which the File should created.
        :param kulado.Input[str] local_file_path: The path to the local file to be added to the Data Lake Store.
        :param kulado.Input[str] remote_file_path: The path created for the file on the Data Lake Store.
