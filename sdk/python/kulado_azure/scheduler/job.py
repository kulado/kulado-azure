...
class Job(kulado.CustomResource):
    action_storage_queue: kulado.Output[dict]
    """
    ...
    """
    error_action_web: kulado.Output[dict]
    """
    ...
    """
    job_collection_name: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, action_storage_queue=None, action_web=None, error_action_storage_queue=None, error_action_web=None, job_collection_name=None, name=None, recurrence=None, resource_group_name=None, retry=None, start_time=None, state=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[dict] action_storage_queue: A `action_storage_queue` block defining a storage queue job action as described below. Note this is identical to an `error_action_storage_queue` block.
        :param kulado.Input[dict] action_web: A `action_web` block defining the job action as described below. Note this is identical to an `error_action_web` block.
        :param kulado.Input[dict] error_action_storage_queue: A `error_action_storage_queue` block defining the a web action to take on an error as described below. Note this is identical to an `action_storage_queue` block.
        :param kulado.Input[dict] error_action_web: A `error_action_web` block defining the action to take on an error as described below. Note this is identical to an `action_web` block.
        :param kulado.Input[str] job_collection_name: Specifies the name of the Scheduler Job Collection in which the Job should exist. Changing this forces a new resource to be created.
        :param kulado.Input[str] name: The name of the Scheduler Job. Changing this forces a new resource to be created.
        :param kulado.Input[dict] recurrence: A `recurrence` block defining a job occurrence schedule.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the Scheduler Job. Changing this forces a new resource to be created.
        :param kulado.Input[dict] retry: A `retry` block defining how to retry as described below.
        :param kulado.Input[str] start_time: The time the first instance of the job is to start running at.
        :param kulado.Input[str] state: The sets or gets the current state of the job. Can be set to either `Enabled` or `Completed`
