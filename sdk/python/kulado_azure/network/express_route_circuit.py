...
class ExpressRouteCircuit(kulado.CustomResource):
    allow_classic_operations: kulado.Output[bool]
    """
    Allow the circuit to interact with classic (RDFE) resources. The default value is `false`.
    """
    bandwidth_in_mbps: kulado.Output[float]
    """
    ...
    """
    peering_location: kulado.Output[str]
    """
    ...
    """
    service_key: kulado.Output[str]
    """
    The string needed by the service provider to provision the ExpressRoute circuit.
    """
    service_provider_name: kulado.Output[str]
    """
    The name of the ExpressRoute Service Provider.
    """
    service_provider_provisioning_state: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, allow_classic_operations=None, bandwidth_in_mbps=None, location=None, name=None, peering_location=None, resource_group_name=None, service_provider_name=None, sku=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[bool] allow_classic_operations: Allow the circuit to interact with classic (RDFE) resources. The default value is `false`.
        :param kulado.Input[float] bandwidth_in_mbps: The bandwidth in Mbps of the circuit being created.
        ...
        :param kulado.Input[str] name: The name of the ExpressRoute circuit. Changing this forces a new resource to be created.
        :param kulado.Input[str] peering_location: The name of the peering location and **not** the Azure resource location.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the ExpressRoute circuit. Changing this forces a new resource to be created.
        :param kulado.Input[str] service_provider_name: The name of the ExpressRoute Service Provider.
        :param kulado.Input[dict] sku: A `sku` block for the ExpressRoute circuit as documented below.
