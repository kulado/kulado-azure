...
class NetworkInterfaceApplicationSecurityGroupAssociation(kulado.CustomResource):
    application_security_group_id: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, application_security_group_id=None, ip_configuration_name=None, network_interface_id=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] application_security_group_id: The ID of the Application Security Group which this Network Interface which should be connected to. Changing this forces a new resource to be created.
        :param kulado.Input[str] ip_configuration_name: The Name of the IP Configuration within the Network Interface which should be connected to the Application Security Group. Changing this forces a new resource to be created.
