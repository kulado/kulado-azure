...
class Profile(kulado.CustomResource):
    container_network_interface: kulado.Output[dict]
    container_network_interface_ids: kulado.Output[list]
    """
    ...
    def __init__(__self__, resource_name, opts=None, container_network_interface=None, location=None, name=None, resource_group_name=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] name: Specifies the name of the Network Profile. Changing this forces a new resource to be created.
