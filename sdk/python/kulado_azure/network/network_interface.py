...
class NetworkInterface(kulado.CustomResource):
    applied_dns_servers: kulado.Output[list]
    """
    ...
    """
    enable_accelerated_networking: kulado.Output[bool]
    """
    ...
    """
    network_security_group_id: kulado.Output[str]
    """
    The ID of the Network Security Group to associate with the network interface.
    """
    private_ip_address: kulado.Output[str]
    """
    The first private IP address of the network interface.
    """
    private_ip_addresses: kulado.Output[list]
    """
    ...
    """
    virtual_machine_id: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, applied_dns_servers=None, dns_servers=None, enable_accelerated_networking=None, enable_ip_forwarding=None, internal_dns_name_label=None, internal_fqdn=None, ip_configurations=None, location=None, mac_address=None, name=None, network_security_group_id=None, resource_group_name=None, tags=None, virtual_machine_id=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[list] applied_dns_servers: If the VM that uses this NIC is part of an Availability Set, then this list will have the union of all DNS servers from all NICs that are part of the Availability Set
        :param kulado.Input[list] dns_servers: List of DNS servers IP addresses to use for this NIC, overrides the VNet-level server list
        ...
        :param kulado.Input[bool] enable_ip_forwarding: Enables IP Forwarding on the NIC. Defaults to `false`.
        :param kulado.Input[str] internal_dns_name_label: Relative DNS name for this NIC used for internal communications between VMs in the same VNet
        :param kulado.Input[list] ip_configurations: One or more `ip_configuration` associated with this NIC as documented below.
        :param kulado.Input[str] location: The location/region where the network interface is created. Changing this forces a new resource to be created.
        :param kulado.Input[str] mac_address: The media access control (MAC) address of the network interface.
        :param kulado.Input[str] name: The name of the network interface. Changing this forces a new resource to be created.
        :param kulado.Input[str] network_security_group_id: The ID of the Network Security Group to associate with the network interface.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the network interface. Changing this forces a new resource to be created.
        :param kulado.Input[dict] tags: A mapping of tags to assign to the resource.
        :param kulado.Input[str] virtual_machine_id: Reference to a VM with which this NIC has been associated.
