...
class ExpressRouteCircuitAuthorization(kulado.CustomResource):
    authorization_key: kulado.Output[str]
    """
    The Authorization Key.
    """
    authorization_use_status: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, express_route_circuit_name=None, name=None, resource_group_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] express_route_circuit_name: The name of the Express Route Circuit in which to create the Authorization.
        :param kulado.Input[str] name: The name of the ExpressRoute circuit. Changing this forces a
               new resource to be created.
