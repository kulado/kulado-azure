...
class PublicIp(kulado.CustomResource):
    allocation_method: kulado.Output[str]
    """
    Defines the allocation method for this IP address. Possible values are `Static` or `Dynamic`.
    """
    domain_name_label: kulado.Output[str]
    """
    ...
    """
    public_ip_address_allocation: kulado.Output[str]
    public_ip_prefix_id: kulado.Output[str]
    """
    ...
    """
    reverse_fqdn: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, allocation_method=None, domain_name_label=None, idle_timeout_in_minutes=None, ip_version=None, location=None, name=None, public_ip_address_allocation=None, public_ip_prefix_id=None, resource_group_name=None, reverse_fqdn=None, sku=None, tags=None, zones=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] allocation_method: Defines the allocation method for this IP address. Possible values are `Static` or `Dynamic`.
        :param kulado.Input[str] domain_name_label: Label for the Domain Name. Will be used to make up the FQDN.  If a domain name label is specified, an A DNS record is created for the public IP in the Microsoft Azure DNS system.
        :param kulado.Input[float] idle_timeout_in_minutes: Specifies the timeout for the TCP idle connection. The value can be set between 4 and 30 minutes.
        :param kulado.Input[str] ip_version: The IP Version to use, IPv6 or IPv4.
        ...
        :param kulado.Input[str] name: Specifies the name of the Public IP resource . Changing this forces a
               new resource to be created.
        :param kulado.Input[str] public_ip_prefix_id: If specified then public IP address allocated will be provided from the public IP prefix resource.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to
               create the public ip.
        :param kulado.Input[str] reverse_fqdn: A fully qualified domain name that resolves to this public IP address. If the reverseFqdn is specified, then a PTR DNS record is created pointing from the IP address in the in-addr.arpa domain to the reverse FQDN.
        :param kulado.Input[str] sku: The SKU of the Public IP. Accepted values are `Basic` and `Standard`. Defaults to `Basic`.
