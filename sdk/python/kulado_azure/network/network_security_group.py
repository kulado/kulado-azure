...
class NetworkSecurityGroup(kulado.CustomResource):
    ...
    """
    security_rules: kulado.Output[list]
    """
    ...
    def __init__(__self__, resource_name, opts=None, location=None, name=None, resource_group_name=None, security_rules=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] name: The name of the security rule.
        :param kulado.Input[str] resource_group_name: The name of the resource group in which to create the network security group. Changing this forces a new resource to be created.
        :param kulado.Input[list] security_rules: [List of objects](https://www.terraform.io/docs/configuration/attr-as-blocks.html) representing security rules, as defined below.
