...
class SubnetNetworkSecurityGroupAssociation(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, network_security_group_id=None, subnet_id=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] network_security_group_id: The ID of the Network Security Group which should be associated with the Subnet. Changing this forces a new resource to be created.
        :param kulado.Input[str] subnet_id: The ID of the Subnet. Changing this forces a new resource to be created.
