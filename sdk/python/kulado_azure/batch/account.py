...
class Account(kulado.CustomResource):
    account_endpoint: kulado.Output[str]
    """
    ...
    """
    pool_allocation_mode: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, location=None, name=None, pool_allocation_mode=None, resource_group_name=None, storage_account_id=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] name: Specifies the name of the Batch account. Changing this forces a new resource to be created.
        :param kulado.Input[str] pool_allocation_mode: Specifies the mode to use for pool allocation. Possible values are `BatchService` or `UserSubscription`. Defaults to `BatchService`.
        ...
        :param kulado.Input[str] storage_account_id: Specifies the storage account to use for the Batch account. If not specified, Azure Batch will manage the storage.
