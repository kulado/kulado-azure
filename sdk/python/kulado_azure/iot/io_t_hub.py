...
class IoTHub(kulado.CustomResource):
    endpoints: kulado.Output[list]
    """
    An `endpoint` block as defined below.
    """
    event_hub_events_endpoint: kulado.Output[str]
    """
    The EventHub compatible endpoint for events data
    """
    event_hub_events_path: kulado.Output[str]
    """
    The EventHub compatible path for events data
    """
    event_hub_operations_endpoint: kulado.Output[str]
    """
    The EventHub compatible endpoint for operational data
    """
    event_hub_operations_path: kulado.Output[str]
    """
    The EventHub compatible path for operational data
    """
    fallback_route: kulado.Output[dict]
    """
    ...
    """
    ip_filter_rules: kulado.Output[list]
    """
    ...
    """
    shared_access_policies: kulado.Output[list]
    """
    ...
    def __init__(__self__, resource_name, opts=None, endpoints=None, fallback_route=None, ip_filter_rules=None, location=None, name=None, resource_group_name=None, routes=None, sku=None, tags=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[list] endpoints: An `endpoint` block as defined below.
        :param kulado.Input[dict] fallback_route: A `fallback_route` block as defined below. If the fallback route is enabled, messages that don't match any of the supplied routes are automatically sent to this route. Defaults to messages/events.
        :param kulado.Input[list] ip_filter_rules: One or more `ip_filter_rule` blocks as defined below.
        ...
        :param kulado.Input[str] name: Specifies the name of the IotHub resource. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group under which the IotHub resource has to be created. Changing this forces a new resource to be created.
        :param kulado.Input[list] routes: A `route` block as defined below.
