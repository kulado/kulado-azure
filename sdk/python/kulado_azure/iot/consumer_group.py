...
class ConsumerGroup(kulado.CustomResource):
    eventhub_endpoint_name: kulado.Output[str]
    """
    ...
    def __init__(__self__, resource_name, opts=None, eventhub_endpoint_name=None, iothub_name=None, name=None, resource_group_name=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] eventhub_endpoint_name: The name of the Event Hub-compatible endpoint in the IoT hub. Changing this forces a new resource to be created.
        :param kulado.Input[str] iothub_name: The name of the IoT Hub. Changing this forces a new resource to be created.
        :param kulado.Input[str] name: The name of this Consumer Group. Changing this forces a new resource to be created.
        :param kulado.Input[str] resource_group_name: The name of the resource group that contains the IoT hub. Changing this forces a new resource to be created.
