...
class Workspace(kulado.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, scope=None, workspace_id=None, __name__=None, __opts__=None):
        ...
        :param kulado.Input[str] scope: The scope of VMs to send their security data to the desired workspace, unless overridden by a setting with more specific scope.
        :param kulado.Input[str] workspace_id: The ID of the Log Analytics Workspace to save the data in.
